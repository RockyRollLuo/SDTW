...
public class StringUtils {
    ...
    public static final String stringFromCh(String string) {
        ...
        if (string!=null) {
            try {
                ...
                String tmpstr = new String(tmpbyte, "utf-8");
                return tmpstr.replaceAll("\"", " ").replaceAll("\r", " ").replaceAll("\n", " ");
    ...
    public static final String stringToCh(String string) {
        ...
        if (string!=null) {
            try {
                tmpbyte = string.getBytes("utf-8");
                String tmpstr = new String(tmpbyte, "ISO-8859-1");
                return tmpstr.replaceAll("\"", " ").replaceAll("\r", " ").replaceAll("\n", " ");
            } catch (UnsupportedEncodingException ex) {
                return "";
            }
	...
	public static String substring(String origin, int len,String end) {
		if (origin == null || origin.equals("") || len < 1)
			return "";
		...
		return new String(strByte, 0, len)+end;
	}
}
