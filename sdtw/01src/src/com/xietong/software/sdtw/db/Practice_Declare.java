...
public class Practice_Declare implements DaoBase {
    /**
     * 所有私有变量
    */
    // 日志
    private static Log log = LogFactory.getLog(Practice_Declare.class);
    ...
    private String DBNAME = "practicedeclare";
    ...
    // 所属学院
    protected String declare3 = "";
    public String getDeclare3() {  return SqlTool.getDbString(declare3);  }
    public String getDeclare3(int size) { return SqlTool.subString(getDeclare3(), size); }
    public void setDeclare3(String aDeclare3) { declare3 = aDeclare3; modifiedFields.add("Declare3"); }
    public void assignDeclare3(String aDeclare3) { declare3 = aDeclare3; }
    public void paramDeclare3(HttpServletRequest request) { paramDeclare3(request, "Declare3"); }
    public void paramDeclare3(HttpServletRequest request, String name) { String tmp = ParamUtils.getParameter(request, name, getDeclare3()); if (!tmp.equals(getDeclare3())) { setDeclare3(tmp); } }
    // 团队类别
    protected String declare4 = "";
    public String getDeclare4() {  return SqlTool.getDbString(declare4);  }
    public String getDeclare4(int size) { return SqlTool.subString(getDeclare4(), size); }
    public void setDeclare4(String aDeclare4) { declare4 = aDeclare4; modifiedFields.add("Declare4"); }
    public void assignDeclare4(String aDeclare4) { declare4 = aDeclare4; }
    public void paramDeclare4(HttpServletRequest request) { paramDeclare4(request, "Declare4"); }
    public void paramDeclare4(HttpServletRequest request, String name) { String tmp = ParamUtils.getParameter(request, name, getDeclare4()); if (!tmp.equals(getDeclare4())) { setDeclare4(tmp); } }
    // 实践主题
    ...
    public Practice_Declare (String db) {
        DBNAME = db;
    }
    public Practice_Declare (String db, String tname) {
        if (db != null) {
            DBNAME = db;
        }
        if (tname != null) {
    ...
    public Practice_Declare (HttpServletRequest request) {
    ...
    public Practice_Declare () {
    }
    /**
     * 提交的form中的输入域名符合bean属性名，将被赋值给对应的bean属性。
     * @param request包含从http请求提交过来的form信息
     * @return Practice_Declare类的实例，包含了从http请求获得信息放到各个对应属性中
    */
    public Practice_Declare getByParameter(HttpServletRequest request) {
        Practice_Declare v = new Practice_Declare(DBNAME, TNAME);
    ...
    public void assignParameter(HttpServletRequest request) {
        ...
        paramDeclare3(request);
        paramDeclare4(request);
    ...
    */
    public void clone(Practice_Declare bean) {
        ...
        if (!ncl.contains("declare3")) { setDeclare3(bean.getDeclare3()); }
        if (!ncl.contains("declare4")) { setDeclare4(bean.getDeclare4()); }
    ...
    public Practice_Declare getById(int aId) {
        List cdt = new ArrayList();
        cdt.add("id=" + aId);
        Practice_Declare[] rslt= queryByCondition(cdt);
        if (rslt.length == 1) {
            return rslt[0];
        }
        else {
    ...
    */
    ...
    public List query(Connection con, List cdt) {
        ...
        try {
            ...
            java.sql.Timestamp tmpDate = null;
            while (rs.next()) {
                Practice_Declare ve = new Practice_Declare(DBNAME, TNAME);
                ve.assignId(rs.getInt(1));
                ve.assignDeclareId(rs.getInt(2));
                ve.assignAcademy(fromDbCh(rs.getString(3)));
                ve.assignSubmitflag(rs.getInt(4));
                ve.assignAddaccount(fromDbCh(rs.getString(5)));
                ve.assignAddtime(fromDbCh(rs.getString(6)));
                ve.assignDeclare1(fromDbCh(rs.getString(7)));
                ve.assignDeclare2(fromDbCh(rs.getString(8)));
                ve.assignDeclare3(fromDbCh(rs.getString(9)));
                ve.assignDeclare4(fromDbCh(rs.getString(10)));
                ve.assignDeclare5(fromDbCh(rs.getString(11)));
                ve.assignDeclare6(fromDbCh(rs.getString(12)));
                ve.assignDeclare7(fromDbCh(rs.getString(13)));
                ve.assignDeclare8(fromDbCh(rs.getString(14)));
                ve.assignDeclare9(fromDbCh(rs.getString(15)));
                ve.assignDeclare10(fromDbCh(rs.getString(16)));
                ve.assignDeclare11(fromDbCh(rs.getString(17)));
                ve.assignDeclare12(fromDbCh(rs.getString(18)));
                ve.assignDeclare13(fromDbCh(rs.getString(19)));
                ve.assignDeclare14(fromDbCh(rs.getString(20)));
                ve.assignDeclare15(fromDbCh(rs.getString(21)));
                ve.assignDeclare16(fromDbCh(rs.getString(22)));
                ve.assignDeclare17(fromDbCh(rs.getString(23)));
                ve.assignDeclare18(fromDbCh(rs.getString(24)));
                ve.assignDeclare19(fromDbCh(rs.getString(25)));
                ve.assignDeclare20(fromDbCh(rs.getString(26)));
                ve.assignDeclare21(fromDbCh(rs.getString(27)));
                ve.assignDeclare22(fromDbCh(rs.getString(28)));
                ve.assignDeclare23(fromDbCh(rs.getString(29)));
                ve.assignDeclare24(fromDbCh(rs.getString(30)));
                ve.assignDeclare25(fromDbCh(rs.getString(31)));
                ve.assignDeclare26(fromDbCh(rs.getString(32)));
                ve.assignDeclare27(fromDbCh(rs.getString(33)));
                ve.assignDeclare28(fromDbCh(rs.getString(34)));
                ve.assignDeclare29(fromDbCh(rs.getString(35)));
                ve.assignDeclare30(fromDbCh(rs.getString(36)));
                ve.assignDeclare31(fromDbCh(rs.getString(37)));
                ve.assignDeclare32(fromDbCh(rs.getString(38)));
                ve.assignDeclare33(fromDbCh(rs.getString(39)));
                ve.assignDeclare34(fromDbCh(rs.getString(40)));
                ve.assignDeclare35(fromDbCh(rs.getString(41)));
                ve.assignDeclare36(fromDbCh(rs.getString(42)));
                ve.assignDeclare37(fromDbCh(rs.getString(43)));
                ve.assignDeclare38(fromDbCh(rs.getString(44)));
                ve.assignDeclare39(fromDbCh(rs.getString(45)));
                ve.assignDeclare40(fromDbCh(rs.getString(46)));
                ve.assignDeclare41(fromDbCh(rs.getString(47)));
                ve.assignDeclare42(fromDbCh(rs.getString(48)));
                ve.assignDeclare43(fromDbCh(rs.getString(49)));
                ve.assignDeclare44(fromDbCh(rs.getString(50)));
                ve.assignDeclare45(fromDbCh(rs.getString(51)));
                ve.assignDeclare46(fromDbCh(rs.getString(52)));
                ve.assignDeclare47(fromDbCh(rs.getString(53)));
                ve.assignDeclare48(fromDbCh(rs.getString(54)));
                ve.assignDeclare49(fromDbCh(rs.getString(55)));
                ve.assignDeclare50(fromDbCh(rs.getString(56)));
                ve.assignDeclare51(fromDbCh(rs.getString(57)));
                ve.assignDeclare52(fromDbCh(rs.getString(58)));
                ve.assignDeclare53(fromDbCh(rs.getString(59)));
                ve.assignDeclare54(fromDbCh(rs.getString(60)));
                ve.assignDeclare55(fromDbCh(rs.getString(61)));
                ve.assignDeclare56(fromDbCh(rs.getString(62)));
                ve.assignDeclare57(fromDbCh(rs.getString(63)));
                ve.assignDeclare58(fromDbCh(rs.getString(64)));
                ve.assignDeclare59(fromDbCh(rs.getString(65)));
                ve.assignDeclare60(fromDbCh(rs.getString(66)));
                ve.assignDeclare61(fromDbCh(rs.getString(67)));
                ve.assignDeclare62(fromDbCh(rs.getString(68)));
                ve.assignDeclare63(fromDbCh(rs.getString(69)));
                ve.assignDeclare64(fromDbCh(rs.getString(70)));
                vrs.add(ve);
            }
        }
        catch( SQLException sqle ) {
    ...
    public Practice_Declare[] queryByCondition(List cdt) {
        List vrs = query(cdt);
        return (Practice_Declare[])vrs.toArray(new Practice_Declare[vrs.size()]);
    }
    public Practice_Declare[] queryByCondition(Connection con, List cdt) {
    ...
    */
    ...
    public int insert(Connection con) {
        String INSERT = "INSERT INTO " + getDBNAME() + " (declareid,academy,submitflag,addaccount,addtime,declare1,declare2,declare3,declare4,declare5,declare6,declare7,declare8,declare9,declare10,declare11,declare12,declare13,declare14,declare15,declare16,declare17,declare18,declare19,declare20,declare21,declare22,declare23,declare24,declare25,declare26,declare27,declare28,declare29,declare30,declare31,declare32,declare33,declare34,declare35,declare36,declare37,declare38,declare39,declare40,declare41,declare42,declare43,declare44,declare45,declare46,declare47,declare48,declare49,declare50,declare51,declare52,declare53,declare54,declare55,declare56,declare57,declare58,declare59,declare60,declare61,declare62,declare63,declare64) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            pstmt.setString(6, toDbCh(declare1));
            pstmt.setString(7, toDbCh(declare2));
            pstmt.setString(8, toDbCh(declare3));
            pstmt.setString(9, toDbCh(declare4));
            pstmt.setString(10, toDbCh(declare5));
            pstmt.setString(11, toDbCh(declare6));
            pstmt.setString(12, toDbCh(declare7));
            pstmt.setString(13, toDbCh(declare8));
            pstmt.setString(14, toDbCh(declare9));
            pstmt.setString(15, toDbCh(declare10));
            pstmt.setString(16, toDbCh(declare11));
            pstmt.setString(17, toDbCh(declare12));
            pstmt.setString(18, toDbCh(declare13));
            pstmt.setString(19, toDbCh(declare14));
            pstmt.setString(20, toDbCh(declare15));
            pstmt.setString(21, toDbCh(declare16));
            pstmt.setString(22, toDbCh(declare17));
            pstmt.setString(23, toDbCh(declare18));
            pstmt.setString(24, toDbCh(declare19));
            pstmt.setString(25, toDbCh(declare20));
            pstmt.setString(26, toDbCh(declare21));
            pstmt.setString(27, toDbCh(declare22));
            pstmt.setString(28, toDbCh(declare23));
            pstmt.setString(29, toDbCh(declare24));
            pstmt.setString(30, toDbCh(declare25));
            pstmt.setString(31, toDbCh(declare26));
            pstmt.setString(32, toDbCh(declare27));
            pstmt.setString(33, toDbCh(declare28));
            pstmt.setString(34, toDbCh(declare29));
            pstmt.setString(35, toDbCh(declare30));
            pstmt.setString(36, toDbCh(declare31));
            pstmt.setString(37, toDbCh(declare32));
            pstmt.setString(38, toDbCh(declare33));
            pstmt.setString(39, toDbCh(declare34));
            pstmt.setString(40, toDbCh(declare35));
            pstmt.setString(41, toDbCh(declare36));
            pstmt.setString(42, toDbCh(declare37));
            pstmt.setString(43, toDbCh(declare38));
            pstmt.setString(44, toDbCh(declare39));
            pstmt.setString(45, toDbCh(declare40));
            pstmt.setString(46, toDbCh(declare41));
            pstmt.setString(47, toDbCh(declare42));
            pstmt.setString(48, toDbCh(declare43));
            pstmt.setString(49, toDbCh(declare44));
            pstmt.setString(50, toDbCh(declare45));
            pstmt.setString(51, toDbCh(declare46));
            pstmt.setString(52, toDbCh(declare47));
            pstmt.setString(53, toDbCh(declare48));
            pstmt.setString(54, toDbCh(declare49));
            pstmt.setString(55, toDbCh(declare50));
            pstmt.setString(56, toDbCh(declare51));
            pstmt.setString(57, toDbCh(declare52));
            pstmt.setString(58, toDbCh(declare53));
            pstmt.setString(59, toDbCh(declare54));
            pstmt.setString(60, toDbCh(declare55));
            pstmt.setString(61, toDbCh(declare56));
            pstmt.setString(62, toDbCh(declare57));
            pstmt.setString(63, toDbCh(declare58));
            pstmt.setString(64, toDbCh(declare59));
            pstmt.setString(65, toDbCh(declare60));
            pstmt.setString(66, toDbCh(declare61));
            pstmt.setString(67, toDbCh(declare62));
            pstmt.setString(68, toDbCh(declare63));
            pstmt.setString(69, toDbCh(declare64));
    ...
    */
    ...
    public int insertByKey(Connection con) {
        String INSERT = "INSERT INTO " + getDBNAME() + " (id,declareid,academy,submitflag,addaccount,addtime,declare1,declare2,declare3,declare4,declare5,declare6,declare7,declare8,declare9,declare10,declare11,declare12,declare13,declare14,declare15,declare16,declare17,declare18,declare19,declare20,declare21,declare22,declare23,declare24,declare25,declare26,declare27,declare28,declare29,declare30,declare31,declare32,declare33,declare34,declare35,declare36,declare37,declare38,declare39,declare40,declare41,declare42,declare43,declare44,declare45,declare46,declare47,declare48,declare49,declare50,declare51,declare52,declare53,declare54,declare55,declare56,declare57,declare58,declare59,declare60,declare61,declare62,declare63,declare64) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        int iResult = -1;
        PreparedStatement pstmt = null;
        Statement stmt = null;
        ResultSet rs = null;
        try {
            ...
            pstmt.setString(7, toDbCh(declare1));
            pstmt.setString(8, toDbCh(declare2));
            pstmt.setString(9, toDbCh(declare3));
            pstmt.setString(10, toDbCh(declare4));
            pstmt.setString(11, toDbCh(declare5));
            pstmt.setString(12, toDbCh(declare6));
            pstmt.setString(13, toDbCh(declare7));
            pstmt.setString(14, toDbCh(declare8));
            pstmt.setString(15, toDbCh(declare9));
            pstmt.setString(16, toDbCh(declare10));
            pstmt.setString(17, toDbCh(declare11));
            pstmt.setString(18, toDbCh(declare12));
            pstmt.setString(19, toDbCh(declare13));
            pstmt.setString(20, toDbCh(declare14));
            pstmt.setString(21, toDbCh(declare15));
            pstmt.setString(22, toDbCh(declare16));
            pstmt.setString(23, toDbCh(declare17));
            pstmt.setString(24, toDbCh(declare18));
            pstmt.setString(25, toDbCh(declare19));
            pstmt.setString(26, toDbCh(declare20));
            pstmt.setString(27, toDbCh(declare21));
            pstmt.setString(28, toDbCh(declare22));
            pstmt.setString(29, toDbCh(declare23));
            pstmt.setString(30, toDbCh(declare24));
            pstmt.setString(31, toDbCh(declare25));
            pstmt.setString(32, toDbCh(declare26));
            pstmt.setString(33, toDbCh(declare27));
            pstmt.setString(34, toDbCh(declare28));
            pstmt.setString(35, toDbCh(declare29));
            pstmt.setString(36, toDbCh(declare30));
            pstmt.setString(37, toDbCh(declare31));
            pstmt.setString(38, toDbCh(declare32));
            pstmt.setString(39, toDbCh(declare33));
            pstmt.setString(40, toDbCh(declare34));
            pstmt.setString(41, toDbCh(declare35));
            pstmt.setString(42, toDbCh(declare36));
            pstmt.setString(43, toDbCh(declare37));
            pstmt.setString(44, toDbCh(declare38));
            pstmt.setString(45, toDbCh(declare39));
            pstmt.setString(46, toDbCh(declare40));
            pstmt.setString(47, toDbCh(declare41));
            pstmt.setString(48, toDbCh(declare42));
            pstmt.setString(49, toDbCh(declare43));
            pstmt.setString(50, toDbCh(declare44));
            pstmt.setString(51, toDbCh(declare45));
            pstmt.setString(52, toDbCh(declare46));
            pstmt.setString(53, toDbCh(declare47));
            pstmt.setString(54, toDbCh(declare48));
            pstmt.setString(55, toDbCh(declare49));
            pstmt.setString(56, toDbCh(declare50));
            pstmt.setString(57, toDbCh(declare51));
            pstmt.setString(58, toDbCh(declare52));
            pstmt.setString(59, toDbCh(declare53));
            pstmt.setString(60, toDbCh(declare54));
            pstmt.setString(61, toDbCh(declare55));
            pstmt.setString(62, toDbCh(declare56));
            pstmt.setString(63, toDbCh(declare57));
            pstmt.setString(64, toDbCh(declare58));
            pstmt.setString(65, toDbCh(declare59));
            pstmt.setString(66, toDbCh(declare60));
            pstmt.setString(67, toDbCh(declare61));
            pstmt.setString(68, toDbCh(declare62));
            pstmt.setString(69, toDbCh(declare63));
            pstmt.setString(70, toDbCh(declare64));
            iResult = pstmt.executeUpdate();
        }
        catch( SQLException sqle ) {
            sqle.printStackTrace();
    ...
    */
    ...
    public boolean batchInsertByKey(List list, String dbname) {
        ...
        for (Iterator it = list.iterator(); it.hasNext();) {
            Practice_Declare item = (Practice_Declare)it.next();
            Practice_Declare v = new Practice_Declare(dbname);
    ...
    public int update(Connection con) {
        ...
        if (updateFields.size() > 0) {
            ...
            try {
                ...
                if (modifiedFields.contains("Declare3")) { pstmt.setString(pi ++, toDbCh(declare3)); }
                if (modifiedFields.contains("Declare4")) { pstmt.setString(pi ++, toDbCh(declare4)); }
    ...
    */
    ...
    public Map toMap() {
        ...
        map.put("Declare3", getDeclare3());
        map.put("Declare4", getDeclare4());
    ...
    public String toJsMap() {
        ...
        row.add("Declare3:\"" + Tool.jsSpecialChars(getDeclare3()) + "\"");
        row.add("Declare4:\"" + Tool.jsSpecialChars(getDeclare4()) + "\"");
    ...
    public int init() {
        ...
        sqlList.add(new String[]{"create", "create table :DBNAME:.:TNAME: (id number(*,0) not null,declareid number(*,0),academy varchar2(45),submitflag number(*,0),addaccount varchar2(45),addtime varchar2(45),declare1 varchar2(45),declare2 varchar2(45),declare3 varchar2(45),declare4 varchar2(45),declare5 varchar2(45),declare6 varchar2(45),declare7 varchar2(45),declare8 varchar2(45),declare9 varchar2(45),declare10 varchar2(255),declare11 varchar2(255),declare12 varchar2(255),declare13 varchar2(255),declare14 varchar2(255),declare15 varchar2(255),declare16 varchar2(45),declare17 varchar2(45),declare18 varchar2(45),declare19 varchar2(45),declare20 varchar2(45),declare21 varchar2(45),declare22 varchar2(45),declare23 varchar2(45),declare24 varchar2(45),declare25 varchar2(45),declare26 varchar2(45),declare27 varchar2(255),declare28 varchar2(255),declare29 varchar2(255),declare30 varchar2(255),declare31 varchar2(45),declare32 varchar2(45),declare33 varchar2(45),declare34 varchar2(45),declare35 varchar2(45),declare36 varchar2(45),declare37 varchar2(45),declare38 varchar2(45),declare39 varchar2(45),declare40 varchar2(45),declare41 varchar2(45),declare42 varchar2(45),declare43 varchar2(45),declare44 varchar2(45),declare45 varchar2(45),declare46 varchar2(45),declare47 varchar2(45),declare48 varchar2(45),declare49 varchar2(45),declare50 varchar2(45),declare51 varchar2(45),declare52 varchar2(45),declare53 varchar2(45),declare54 varchar2(45),declare55 varchar2(45),declare56 varchar2(45),declare57 varchar2(45),declare58 varchar2(45),declare59 varchar2(255),declare60 varchar2(45),declare61 varchar2(45),declare62 varchar2(45),declare63 varchar2(45),declare64 varchar2(45))"});
    ...
    public void duplicate(String sourceDb, String sourceTb, List cdt) {
        Practice_Declare v = new Practice_Declare(sourceDb, sourceTb);
    ...
    public void duplicate(String sourceDb, List cdt) {
        Practice_Declare v = new Practice_Declare(sourceDb);
        int num = v.getCount(cdt);
        for (int i = 0; i < num; i += 100) {
            cdt.clear();
            cdt.add("order by id asc");
    ...
    public int compareTo(Practice_Declare obj) {
        int rtn = 0;
        ...
        rtn = getDeclare3().compareTo(obj.getDeclare3()); if (rtn != 0) return rtn;
        rtn = getDeclare4().compareTo(obj.getDeclare4()); if (rtn != 0) return rtn;
