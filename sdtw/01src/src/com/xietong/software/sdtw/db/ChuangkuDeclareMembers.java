...
@Description("山大创库创业团队人员名称")
public class ChuangkuDeclareMembers implements DaoBase {
    /**
     * 所有私有变量
    */
    // 日志
    ...
    // 保存当前连接的数据表名
    public static final String DbTableName = "chuangku_declare_members";
    private String TNAME = "chuangku_declare_members";
    ...
    // 包含所有bean属性名数组
    private static final String[] _allProperties = {"id","chuangkuDeclareId","sno","name","tel","academy","duty"};
    public String[] getAllProperties() { return _allProperties; }
    private static final String[] _allFields = {"id","chuangkudeclareid","sno","name","tel","academy","duty"};
    public String[] getAllFields() {return _allFields;}
    private static final String[][] _arrayPF = {{"Id","id","int"},{"ChuangkuDeclareId","chuangkudeclareid","int"},{"Sno","sno","String"},{"Name","name","String"},{"Tel","tel","String"},{"Academy","academy","String"},{"Duty","duty","String"}};
    private static final String[][] _allPropertiesAndFields = {{"id","id"},{"chuangkuDeclareId","chuangkudeclareid"},{"sno","sno"},{"name","name"},{"tel","tel"},{"academy","academy"},{"duty","duty"}};
    ...
    // 参加山大创库作品表id
    protected int chuangkuDeclareId = -1;
    public int getChuangkuDeclareId() { return chuangkuDeclareId; }
    public void setChuangkuDeclareId(int aChuangkuDeclareId) { chuangkuDeclareId = aChuangkuDeclareId; modifiedFields.add("ChuangkuDeclareId"); }
    public void assignChuangkuDeclareId(int aChuangkuDeclareId) { chuangkuDeclareId = aChuangkuDeclareId; }
    public void paramChuangkuDeclareId(HttpServletRequest request) { paramChuangkuDeclareId(request, "ChuangkuDeclareId"); }
    public void paramChuangkuDeclareId(HttpServletRequest request, String name) { int tmp = ParamUtils.getIntParameter(request, name, getChuangkuDeclareId()); if (tmp != getChuangkuDeclareId()) { setChuangkuDeclareId(tmp); } }
    // 学号
    ...
    public ChuangkuDeclareMembers (String db) {
        DBNAME = db;
    }
    public ChuangkuDeclareMembers (String db, String tname) {
        if (db != null) {
            DBNAME = db;
        }
        if (tname != null) {
    ...
    public ChuangkuDeclareMembers (HttpServletRequest request) {
    ...
    public ChuangkuDeclareMembers () {
    }
    /**
     * 提交的form中的输入域名符合bean属性名，将被赋值给对应的bean属性。
     * @param request包含从http请求提交过来的form信息
     * @return ChuangkuDeclareMembers类的实例，包含了从http请求获得信息放到各个对应属性中
    */
    public ChuangkuDeclareMembers getByParameter(HttpServletRequest request) {
        ChuangkuDeclareMembers v = new ChuangkuDeclareMembers(DBNAME, TNAME);
        v.assignParameter(request);
        return v;
    }
    public void assignParameter(HttpServletRequest request) {
        paramId(request);
        paramChuangkuDeclareId(request);
        paramSno(request);
        paramName(request);
        paramTel(request);
    ...
    */
    public void clone(ChuangkuDeclareMembers bean) {
        List ncl = Arrays.asList(noChangeList);
        if (!ncl.contains("id")) { setId(bean.getId()); }
        if (!ncl.contains("chuangkuDeclareId")) { setChuangkuDeclareId(bean.getChuangkuDeclareId()); }
    ...
    public ChuangkuDeclareMembers getById(int aId) {
        List cdt = new ArrayList();
        cdt.add("id=" + aId);
        ChuangkuDeclareMembers[] rslt= queryByCondition(cdt);
        if (rslt.length == 1) {
            return rslt[0];
        }
        else {
    ...
    */
     ...
     * @return ChuangkuDeclareMembers类的实例列表。
    */
    ...
    public List query(Connection con, List cdt) {
        ...
        try {
            ...
            java.sql.Timestamp tmpDate = null;
            while (rs.next()) {
                ChuangkuDeclareMembers ve = new ChuangkuDeclareMembers(DBNAME, TNAME);
                ve.assignId(rs.getInt(1));
                ve.assignChuangkuDeclareId(rs.getInt(2));
    ...
    public ChuangkuDeclareMembers[] queryByCondition(List cdt) {
        List vrs = query(cdt);
        return (ChuangkuDeclareMembers[])vrs.toArray(new ChuangkuDeclareMembers[vrs.size()]);
    }
    public ChuangkuDeclareMembers[] queryByCondition(Connection con, List cdt) {
    ...
    */
    ...
    public int insert(Connection con) {
        String INSERT = "INSERT INTO " + getDBNAME() + " (chuangkudeclareid,sno,name,tel,academy,duty) VALUES (?,?,?,?,?,?)";
        ...
        try {
            ...
            pstmt.setInt(1, chuangkuDeclareId);
    ...
    */
    ...
    public int insertByKey(Connection con) {
        String INSERT = "INSERT INTO " + getDBNAME() + " (id,chuangkudeclareid,sno,name,tel,academy,duty) VALUES (?,?,?,?,?,?,?)";
        int iResult = -1;
        PreparedStatement pstmt = null;
        Statement stmt = null;
        ResultSet rs = null;
        try {
            ...
            stmt = con.createStatement();
            pstmt.setInt(1, id);
            pstmt.setInt(2, chuangkuDeclareId);
    ...
    */
    ...
    public boolean batchInsertByKey(List list, String dbname) {
        ...
        for (Iterator it = list.iterator(); it.hasNext();) {
            ChuangkuDeclareMembers item = (ChuangkuDeclareMembers)it.next();
            ChuangkuDeclareMembers v = new ChuangkuDeclareMembers(dbname);
    ...
    public int update(Connection con) {
        ...
        if (updateFields.size() > 0) {
            ...
            try {
                ...
                int pi = 1;
                if (modifiedFields.contains("ChuangkuDeclareId")) { pstmt.setInt(pi ++, chuangkuDeclareId); }
    ...
    */
    ...
    public Map toMap() {
        Map map = new HashMap();
        map.put("Id", getId() + "");
        map.put("ChuangkuDeclareId", getChuangkuDeclareId() + "");
        map.put("Sno", getSno());
    ...
    public String toJsMap() {
        ...
        row.add("Id:\"" + getId() + "\"");
        row.add("ChuangkuDeclareId:\"" + getChuangkuDeclareId() + "\"");
    ...
    public int init() {
        ...
        sqlList.add(new String[]{"create", "create table :DBNAME:.:TNAME: (id number(*,0) not null,chuangkudeclareid number(*,0),sno varchar2(45),name varchar2(45),tel varchar2(45),academy varchar2(45),duty varchar2(45))"});
    ...
    public void duplicate(String sourceDb, String sourceTb, List cdt) {
        ChuangkuDeclareMembers v = new ChuangkuDeclareMembers(sourceDb, sourceTb);
    ...
    public void duplicate(String sourceDb, List cdt) {
        ChuangkuDeclareMembers v = new ChuangkuDeclareMembers(sourceDb);
        int num = v.getCount(cdt);
        for (int i = 0; i < num; i += 100) {
            cdt.clear();
            cdt.add("order by id asc");
    ...
    public int compareTo(ChuangkuDeclareMembers obj) {
        int rtn = 0;
        rtn = ("" + getId()).compareTo("" + obj.getId()); if (rtn != 0) return rtn;
        rtn = ("" + getChuangkuDeclareId()).compareTo("" + obj.getChuangkuDeclareId()); if (rtn != 0) return rtn;
