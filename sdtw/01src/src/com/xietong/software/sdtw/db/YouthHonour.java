...
@Description("五四评比表彰申请表")
public class YouthHonour implements DaoBase {
    /**
     * 所有私有变量
    */
    // 日志
    ...
    // 保存当前连接的数据表名
    public static final String DbTableName = "youthhonour";
    private String TNAME = "youthhonour";
    ...
    // 包含所有bean属性名数组
    private static final String[] _allProperties = {"id","noticeid","schoolYear","type","addaccount","addtime","ayCheckFlag","twCheckFlag","modifyFlag","xyReport","twReport","xyCheckDate","twCheckDate","belongAcademy","attachids","val1","val2","val3","val4","val5","val6","val7","val8","val9","val10","val11","val12","val13","val14","val15","val16","val17","val21","val18","val19","val20","val22","text1","text2","text3","text4","text5","text6"};
    public String[] getAllProperties() { return _allProperties; }
    private static final String[] _allFields = {"id","noticeid","schoolyear","type","addaccount","addtime","aycheckflag","twcheckflag","modifyflag","xyreport","twreport","xycheckdate","twcheckdate","belongacademy","attachids","val1","val2","val3","val4","val5","val6","val7","val8","val9","val10","val11","val12","val13","val14","val15","val16","val17","val21","val18","val19","val20","val22","text1","text2","text3","text4","text5","text6"};
    public String[] getAllFields() {return _allFields;}
    private static final String[][] _arrayPF = {{"Id","id","int"},{"Noticeid","noticeid","int"},{"SchoolYear","schoolyear","String"},{"Type","type","int"},{"Addaccount","addaccount","String"},{"Addtime","addtime","java.util.Date"},{"AyCheckFlag","aycheckflag","int"},{"TwCheckFlag","twcheckflag","int"},{"ModifyFlag","modifyflag","int"},{"XyReport","xyreport","int"},{"TwReport","twreport","int"},{"XyCheckDate","xycheckdate","java.util.Date"},{"TwCheckDate","twcheckdate","java.util.Date"},{"BelongAcademy","belongacademy","String"},{"Attachids","attachids","String"},{"Val1","val1","String"},{"Val2","val2","String"},{"Val3","val3","String"},{"Val4","val4","String"},{"Val5","val5","String"},{"Val6","val6","String"},{"Val7","val7","String"},{"Val8","val8","String"},{"Val9","val9","String"},{"Val10","val10","String"},{"Val11","val11","String"},{"Val12","val12","String"},{"Val13","val13","String"},{"Val14","val14","String"},{"Val15","val15","String"},{"Val16","val16","String"},{"Val17","val17","String"},{"Val21","val21","String"},{"Val18","val18","String"},{"Val19","val19","String"},{"Val20","val20","String"},{"Val22","val22","String"},{"Text1","text1","String"},{"Text2","text2","String"},{"Text3","text3","String"},{"Text4","text4","String"},{"Text5","text5","String"},{"Text6","text6","String"}};
    private static final String[][] _allPropertiesAndFields = {{"id","id"},{"noticeid","noticeid"},{"schoolYear","schoolyear"},{"type","type"},{"addaccount","addaccount"},{"addtime","addtime"},{"ayCheckFlag","aycheckflag"},{"twCheckFlag","twcheckflag"},{"modifyFlag","modifyflag"},{"xyReport","xyreport"},{"twReport","twreport"},{"xyCheckDate","xycheckdate"},{"twCheckDate","twcheckdate"},{"belongAcademy","belongacademy"},{"attachids","attachids"},{"val1","val1"},{"val2","val2"},{"val3","val3"},{"val4","val4"},{"val5","val5"},{"val6","val6"},{"val7","val7"},{"val8","val8"},{"val9","val9"},{"val10","val10"},{"val11","val11"},{"val12","val12"},{"val13","val13"},{"val14","val14"},{"val15","val15"},{"val16","val16"},{"val17","val17"},{"val21","val21"},{"val18","val18"},{"val19","val19"},{"val20","val20"},{"val22","val22"},{"text1","text1"},{"text2","text2"},{"text3","text3"},{"text4","text4"},{"text5","text5"},{"text6","text6"}};
    ...
    // 通知id
    protected int noticeid = -1;
    public int getNoticeid() { return noticeid; }
    public void setNoticeid(int aNoticeid) { noticeid = aNoticeid; modifiedFields.add("Noticeid"); }
    public void assignNoticeid(int aNoticeid) { noticeid = aNoticeid; }
    public void paramNoticeid(HttpServletRequest request) { paramNoticeid(request, "Noticeid"); }
    public void paramNoticeid(HttpServletRequest request, String name) { int tmp = ParamUtils.getIntParameter(request, name, getNoticeid()); if (tmp != getNoticeid()) { setNoticeid(tmp); } }
    // 学年
    ...
    // va21
    protected String val21 = "";
    public String getVal21() {  return SqlTool.getDbString(val21);  }
    public String getVal21(int size) { return SqlTool.subString(getVal21(), size); }
    public void setVal21(String aVal21) { val21 = aVal21; modifiedFields.add("Val21"); }
    public void assignVal21(String aVal21) { val21 = aVal21; }
    public void paramVal21(HttpServletRequest request) { paramVal21(request, "Val21"); }
    public void paramVal21(HttpServletRequest request, String name) { String tmp = ParamUtils.getParameter(request, name, getVal21()); if (!tmp.equals(getVal21())) { setVal21(tmp); } }
    // va18
    ...
    // va22
    protected String val22 = "";
    public String getVal22() {  return SqlTool.getDbString(val22);  }
    public String getVal22(int size) { return SqlTool.subString(getVal22(), size); }
    public void setVal22(String aVal22) { val22 = aVal22; modifiedFields.add("Val22"); }
    public void assignVal22(String aVal22) { val22 = aVal22; }
    public void paramVal22(HttpServletRequest request) { paramVal22(request, "Val22"); }
    public void paramVal22(HttpServletRequest request, String name) { String tmp = ParamUtils.getParameter(request, name, getVal22()); if (!tmp.equals(getVal22())) { setVal22(tmp); } }
    // text1
    ...
    public String getText5() {  return SqlTool.getDbString(text5);  }
    public String getText5(int size) { return SqlTool.subString(getText5(), size); }
    public void setText5(String aText5) { text5 = aText5; modifiedFields.add("Text5"); }
    public void assignText5(String aText5) { text5 = aText5; }
    public void paramText5(HttpServletRequest request) { paramText5(request, "Text5"); }
    public void paramText5(HttpServletRequest request, String name) { String tmp = ParamUtils.getParameter(request, name, getText5()); if (!tmp.equals(getText5())) { setText5(tmp); } }
    // text6
    protected String text6 = "";
    public String getText6() {  return SqlTool.getDbString(text6);  }
    public String getText6(int size) { return SqlTool.subString(getText6(), size); }
    public void setText6(String aText6) { text6 = aText6; modifiedFields.add("Text6"); }
    public void assignText6(String aText6) { text6 = aText6; }
    public void paramText6(HttpServletRequest request) { paramText6(request, "Text6"); }
    public void paramText6(HttpServletRequest request, String name) { String tmp = ParamUtils.getParameter(request, name, getText6()); if (!tmp.equals(getText6())) { setText6(tmp); } }
    ...
    public YouthHonour (String db) {
        DBNAME = db;
    }
    public YouthHonour (String db, String tname) {
        if (db != null) {
            DBNAME = db;
        }
        if (tname != null) {
    ...
    public YouthHonour (HttpServletRequest request) {
     ...
     * @return YouthHonour类的实例，包含了从http请求获得信息放到各个对应属性中
    */
    public YouthHonour getByParameter(HttpServletRequest request) {
        YouthHonour v = new YouthHonour(DBNAME, TNAME);
        v.assignParameter(request);
        return v;
    }
    public void assignParameter(HttpServletRequest request) {
        paramId(request);
        paramNoticeid(request);
    ...
    */
    public void clone(YouthHonour bean) {
        List ncl = Arrays.asList(noChangeList);
        if (!ncl.contains("id")) { setId(bean.getId()); }
        if (!ncl.contains("noticeid")) { setNoticeid(bean.getNoticeid()); }
        ...
        if (!ncl.contains("val21")) { setVal21(bean.getVal21()); }
        ...
        if (!ncl.contains("val22")) { setVal22(bean.getVal22()); }
        ...
        if (!ncl.contains("text5")) { setText5(bean.getText5()); }
        if (!ncl.contains("text6")) { setText6(bean.getText6()); }
    }
    public YouthHonour getById(int aId) {
        List cdt = new ArrayList();
        cdt.add("id=" + aId);
        YouthHonour[] rslt= queryByCondition(cdt);
        if (rslt.length == 1) {
            return rslt[0];
        }
        else {
    ...
    */
    ...
    public List query(Connection con, List cdt) {
        ...
        try {
            ...
            java.sql.Timestamp tmpDate = null;
            while (rs.next()) {
                YouthHonour ve = new YouthHonour(DBNAME, TNAME);
                ve.assignId(rs.getInt(1));
                ve.assignNoticeid(rs.getInt(2));
                ve.assignSchoolYear(fromDbCh(rs.getString(3)));
                ...
                ve.assignAyCheckFlag(rs.getInt(7));
                ve.assignTwCheckFlag(rs.getInt(8));
                ve.assignModifyFlag(rs.getInt(9));
                ve.assignXyReport(rs.getInt(10));
                ve.assignTwReport(rs.getInt(11));
                tmpDate = rs.getTimestamp(12); if (tmpDate != null) { ve.assignXyCheckDate(new java.util.Date(tmpDate.getTime())); }
                tmpDate = rs.getTimestamp(13); if (tmpDate != null) { ve.assignTwCheckDate(new java.util.Date(tmpDate.getTime())); }
                ve.assignBelongAcademy(fromDbCh(rs.getString(14)));
                ve.assignAttachids(fromDbCh(rs.getString(15)));
                ve.assignVal1(fromDbCh(rs.getString(16)));
                ve.assignVal2(fromDbCh(rs.getString(17)));
                ve.assignVal3(fromDbCh(rs.getString(18)));
                ve.assignVal4(fromDbCh(rs.getString(19)));
                ve.assignVal5(fromDbCh(rs.getString(20)));
                ve.assignVal6(fromDbCh(rs.getString(21)));
                ve.assignVal7(fromDbCh(rs.getString(22)));
                ve.assignVal8(fromDbCh(rs.getString(23)));
                ve.assignVal9(fromDbCh(rs.getString(24)));
                ve.assignVal10(fromDbCh(rs.getString(25)));
                ve.assignVal11(fromDbCh(rs.getString(26)));
                ve.assignVal12(fromDbCh(rs.getString(27)));
                ve.assignVal13(fromDbCh(rs.getString(28)));
                ve.assignVal14(fromDbCh(rs.getString(29)));
                ve.assignVal15(fromDbCh(rs.getString(30)));
                ve.assignVal16(fromDbCh(rs.getString(31)));
                ve.assignVal17(fromDbCh(rs.getString(32)));
                ve.assignVal21(fromDbCh(rs.getString(33)));
                ve.assignVal18(fromDbCh(rs.getString(34)));
                ve.assignVal19(fromDbCh(rs.getString(35)));
                ve.assignVal20(fromDbCh(rs.getString(36)));
                ve.assignVal22(fromDbCh(rs.getString(37)));
                ve.assignText1(fromDbCh(rs.getString(38)));
                ve.assignText2(fromDbCh(rs.getString(39)));
                ve.assignText3(fromDbCh(rs.getString(40)));
                ve.assignText4(fromDbCh(rs.getString(41)));
                ve.assignText5(fromDbCh(rs.getString(42)));
                ve.assignText6(fromDbCh(rs.getString(43)));
                vrs.add(ve);
            }
        }
        catch( SQLException sqle ) {
    ...
    public YouthHonour[] queryByCondition(List cdt) {
        List vrs = query(cdt);
        return (YouthHonour[])vrs.toArray(new YouthHonour[vrs.size()]);
    }
    public YouthHonour[] queryByCondition(Connection con, List cdt) {
    ...
    */
    ...
    public int insert(Connection con) {
        String INSERT = "INSERT INTO " + getDBNAME() + " (noticeid,schoolyear,type,addaccount,addtime,aycheckflag,twcheckflag,modifyflag,xyreport,twreport,xycheckdate,twcheckdate,belongacademy,attachids,val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,val14,val15,val16,val17,val21,val18,val19,val20,val22,text1,text2,text3,text4,text5,text6) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            pstmt.setString(14, toDbCh(attachids));
            pstmt.setString(15, toDbCh(val1));
            pstmt.setString(16, toDbCh(val2));
            pstmt.setString(17, toDbCh(val3));
            pstmt.setString(18, toDbCh(val4));
            pstmt.setString(19, toDbCh(val5));
            pstmt.setString(20, toDbCh(val6));
            pstmt.setString(21, toDbCh(val7));
            pstmt.setString(22, toDbCh(val8));
            pstmt.setString(23, toDbCh(val9));
            pstmt.setString(24, toDbCh(val10));
            pstmt.setString(25, toDbCh(val11));
            pstmt.setString(26, toDbCh(val12));
            pstmt.setString(27, toDbCh(val13));
            pstmt.setString(28, toDbCh(val14));
            pstmt.setString(29, toDbCh(val15));
            pstmt.setString(30, toDbCh(val16));
            pstmt.setString(31, toDbCh(val17));
            pstmt.setString(32, toDbCh(val21));
            pstmt.setString(33, toDbCh(val18));
            pstmt.setString(34, toDbCh(val19));
            pstmt.setString(35, toDbCh(val20));
            pstmt.setString(36, toDbCh(val22));
            pstmt.setString(37, toDbCh(text1));
            pstmt.setString(38, toDbCh(text2));
            pstmt.setString(39, toDbCh(text3));
            pstmt.setString(40, toDbCh(text4));
            pstmt.setString(41, toDbCh(text5));
            pstmt.setString(42, toDbCh(text6));
    ...
    */
    ...
    public int insertByKey(Connection con) {
        String INSERT = "INSERT INTO " + getDBNAME() + " (id,noticeid,schoolyear,type,addaccount,addtime,aycheckflag,twcheckflag,modifyflag,xyreport,twreport,xycheckdate,twcheckdate,belongacademy,attachids,val1,val2,val3,val4,val5,val6,val7,val8,val9,val10,val11,val12,val13,val14,val15,val16,val17,val21,val18,val19,val20,val22,text1,text2,text3,text4,text5,text6) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        int iResult = -1;
        PreparedStatement pstmt = null;
        Statement stmt = null;
        ResultSet rs = null;
        try {
            ...
            pstmt.setString(3, toDbCh(schoolYear));
            pstmt.setInt(4, type);
            pstmt.setString(5, toDbCh(addaccount));
            pstmt.setTimestamp(6, new java.sql.Timestamp(addtime.getTime()));
            pstmt.setInt(7, ayCheckFlag);
            pstmt.setInt(8, twCheckFlag);
            pstmt.setInt(9, modifyFlag);
            pstmt.setInt(10, xyReport);
            pstmt.setInt(11, twReport);
            pstmt.setTimestamp(12, new java.sql.Timestamp(xyCheckDate.getTime()));
            pstmt.setTimestamp(13, new java.sql.Timestamp(twCheckDate.getTime()));
            pstmt.setString(14, toDbCh(belongAcademy));
            pstmt.setString(15, toDbCh(attachids));
            pstmt.setString(16, toDbCh(val1));
            pstmt.setString(17, toDbCh(val2));
            pstmt.setString(18, toDbCh(val3));
            pstmt.setString(19, toDbCh(val4));
            pstmt.setString(20, toDbCh(val5));
            pstmt.setString(21, toDbCh(val6));
            pstmt.setString(22, toDbCh(val7));
            pstmt.setString(23, toDbCh(val8));
            pstmt.setString(24, toDbCh(val9));
            pstmt.setString(25, toDbCh(val10));
            pstmt.setString(26, toDbCh(val11));
            pstmt.setString(27, toDbCh(val12));
            pstmt.setString(28, toDbCh(val13));
            pstmt.setString(29, toDbCh(val14));
            pstmt.setString(30, toDbCh(val15));
            pstmt.setString(31, toDbCh(val16));
            pstmt.setString(32, toDbCh(val17));
            pstmt.setString(33, toDbCh(val21));
            pstmt.setString(34, toDbCh(val18));
            pstmt.setString(35, toDbCh(val19));
            pstmt.setString(36, toDbCh(val20));
            pstmt.setString(37, toDbCh(val22));
            pstmt.setString(38, toDbCh(text1));
            pstmt.setString(39, toDbCh(text2));
            pstmt.setString(40, toDbCh(text3));
            pstmt.setString(41, toDbCh(text4));
            pstmt.setString(42, toDbCh(text5));
            pstmt.setString(43, toDbCh(text6));
            iResult = pstmt.executeUpdate();
        }
        catch( SQLException sqle ) {
            sqle.printStackTrace();
    ...
    */
    ...
    public boolean batchInsertByKey(List list, String dbname) {
        ...
        for (Iterator it = list.iterator(); it.hasNext();) {
            YouthHonour item = (YouthHonour)it.next();
            YouthHonour v = new YouthHonour(dbname);
    ...
    public int update(Connection con) {
        ...
        if (updateFields.size() > 0) {
            ...
            try {
                ...
                int pi = 1;
                if (modifiedFields.contains("Noticeid")) { pstmt.setInt(pi ++, noticeid); }
                ...
                if (modifiedFields.contains("Val21")) { pstmt.setString(pi ++, toDbCh(val21)); }
                ...
                if (modifiedFields.contains("Val22")) { pstmt.setString(pi ++, toDbCh(val22)); }
                ...
                if (modifiedFields.contains("Text5")) { pstmt.setString(pi ++, toDbCh(text5)); }
                if (modifiedFields.contains("Text6")) { pstmt.setString(pi ++, toDbCh(text6)); }
                pstmt.setInt(pi, id);
                iResult = pstmt.executeUpdate();
            }
            catch( SQLException sqle ) {
    ...
    */
    ...
    public String toJsMap() {
        ...
        row.add("Val21:\"" + Tool.jsSpecialChars(getVal21()) + "\"");
        ...
        row.add("Val22:\"" + Tool.jsSpecialChars(getVal22()) + "\"");
        ...
        row.add("Text5:\"" + Tool.jsSpecialChars(getText5()) + "\"");
        row.add("Text6:\"" + Tool.jsSpecialChars(getText6()) + "\"");
        return "{" + Tool.join(",", row) + "}";
    }
    public int init() {
        List sqlList= new ArrayList();
        sqlList.add(new String[]{"create", "create table :DBNAME:.:TNAME: (id number(*,0) not null,noticeid number(*,0),schoolyear varchar2(45),type number(*,0),addaccount varchar2(45),addtime date,aycheckflag number(*,0),twcheckflag number(*,0),modifyflag number(*,0),xyreport number(*,0),twreport number(*,0),xycheckdate date,twcheckdate date,belongacademy varchar2(45),attachids varchar2(45),val1 varchar2(45),val2 varchar2(45),val3 varchar2(45),val4 varchar2(45),val5 varchar2(45),val6 varchar2(45),val7 varchar2(45),val8 varchar2(45),val9 varchar2(45),val10 varchar2(45),val11 varchar2(45),val12 varchar2(45),val13 varchar2(45),val14 varchar2(45),val15 varchar2(45),val16 varchar2(45),val17 varchar2(45),val21 varchar2(45),val18 varchar2(45),val19 varchar2(45),val20 varchar2(45),val22 varchar2(45),text1 varchar2(500),text2 varchar2(500),text3 varchar2(500),text4 varchar2(500),text5 varchar2(500),text6 varchar2(500))"});
    ...
    public void duplicate(String sourceDb, String sourceTb, List cdt) {
        YouthHonour v = new YouthHonour(sourceDb, sourceTb);
    ...
    public void duplicate(String sourceDb, List cdt) {
        YouthHonour v = new YouthHonour(sourceDb);
        int num = v.getCount(cdt);
        for (int i = 0; i < num; i += 100) {
            cdt.clear();
            cdt.add("order by id asc");
    ...
    public int compareTo(YouthHonour obj) {
        int rtn = 0;
        rtn = ("" + getId()).compareTo("" + obj.getId()); if (rtn != 0) return rtn;
        rtn = ("" + getNoticeid()).compareTo("" + obj.getNoticeid()); if (rtn != 0) return rtn;
        ...
        rtn = getVal21().compareTo(obj.getVal21()); if (rtn != 0) return rtn;
        ...
        rtn = getVal22().compareTo(obj.getVal22()); if (rtn != 0) return rtn;
        ...
        rtn = getText5().compareTo(obj.getText5()); if (rtn != 0) return rtn;
        rtn = getText6().compareTo(obj.getText6()); if (rtn != 0) return rtn;
        return rtn;
    }
}
