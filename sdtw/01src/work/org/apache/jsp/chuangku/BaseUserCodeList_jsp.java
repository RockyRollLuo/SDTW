 ...
 * Generated at: 2017-04-25 07:08:05 UTC
...
List sexoptions = (List)request.getAttribute("sexoptions");
	...
	List  xynameoptions=COptionConst.getAcademyNameOptions(userInfo,"",cdt);
      ...
      out.write("\t\t\t\t\t\t\treName += \"<tr id='deleteSponsor_\"+reIdtmp+\"'><td> \"+rows[rowIndex[i]][getCodeIndex('Name')]+\"</td><td>\"+rows[rowIndex[i]][getCodeIndex('CnName')]+\"</td><td> \"+rows[rowIndex[i]][getCodeIndex('DeptId')]+\"</td><td><input size='15' name='phone\"+i+\"'/></td>\"+\"</td><td><select name='duty\"+i+\"'><option value='成员'>成员</option> <option value='负责人'>负责人</option>  </select></td>\"+\"<td><img style=\\\"cursor:point;\\\" src='");
      out.print(HeadConst.apache_url);
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\telse{ \r\n");
      out.write("\t\t\t\t\t\t//\talert((\"(,\"+values+\",)\")+\"   \"+(\"(,\"+reIdtmp+\",)\")  +\"   \"+(\",\"+values+\",\").indexOf(\",\"+reIdtmp+\",\"))\r\n");
      out.write("\t\t\t\t\t\t\tif((\",\"+values+\",\").indexOf(\",\"+reIdtmp+\",\")==-1){\r\n");
      out.write("\t\t\t\t\t\t\t\t//alert(\"ok\")\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\treId += \",\"+rows[rowIndex[i]][getCodeIndex('Id')];\r\n");
      out.write("\t\t\t\t\t\t\t\treName += \"<tr id='deleteSponsor_\"+reIdtmp+\"'><td>\"+rows[rowIndex[i]][getCodeIndex('Name')]+\"</td><td>\"+rows[rowIndex[i]][getCodeIndex('CnName')]+\"</td><td> \"+rows[rowIndex[i]][getCodeIndex('DeptId')]+\"</td><td><input size=15' name='phone\"+slist+\"'/></td>\"+\"</td><td><select name='duty\"+slist+\"'><option value='成员'>成员</option> <option value='负责人'>负责人</option>  </select></td>\"+\"<td><img style=\\\"cursor:point;\\\" src='");
      out.print(HeadConst.apache_url);
      out.write("/main/images/delete.gif' onclick=javascript:deleteSponsor(\\'deleteSponsor_\"+reIdtmp+\"\\',\\'\"+reIdtmp+\"\\') alt='删除' title='删除' border=0 /></td></tr>\";\r\n");
      out.write("\t\t\t\t\t\t\t\tslist=slist+1;\r\n");
      out.write("\t\t\t\t\t\t\t}/* else{\r\n");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction selectRole2(){\r\n");
      out.write("\t\t\t\tvar values = '");
      out.print(values);
      out.write("';\r\n");
      out.write("\t\t\t\tvar chks = document.getElementsByName(\"chk1\");\r\n");
      ...
      out.write("\t\t\t    \r\n");
      out.write("\t\t\t   if (chkeds.length > 0) {\r\n");
      out.write("\t\t\t\t   if(chkeds.length>1){\r\n");
      out.write("\t\t\t\t\t   alert(\"请选择一条记录!\");\r\n");
      out.write("\t\t\t\t\t   return;\r\n");
      out.write("\t\t\t\t   }\r\n");
      out.write("\t\t\t\t   \tvar MemberSno = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberName = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberSex = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberBrith = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberPolitics = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberBirthplace = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberAcademy = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberMajor = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberGrade = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberPhone = \"\";\r\n");
      out.write("\t       \t\t\tvar Memberqq = \"\";\r\n");
      out.write("\t       \t\t\tvar MemberEmail = \"\";\r\n");
      out.write("\t       \t\t\tvar Memberwx = \"\";\r\n");
      out.write("\t\t\t    \tvar reId = rows[rowIndex[0]][getCodeIndex('Id')]+\"\";\r\n");
      out.write("\t\t\t    \t\r\n");
      out.write("\t\t\t    \t$.ajax({\r\n");
      out.write("                        type: \"get\",\r\n");
      out.write("                        url: \"BaseUserCodeAction.jsp\",\r\n");
      out.write("                        data: {Id:reId,cmd:'stuMsg'},\r\n");
      ...
      out.write("                        \t\t\tMemberSno = data.MemberSno;\r\n");
      out.write("                        \t\t\tMemberName = data.MemberName;\r\n");
      out.write("                        \t\t\tMemberSex = data.MemberSex;\r\n");
      out.write("                        \t\t\tMemberBrith = data.MemberBrith;\r\n");
      out.write("                        \t\t\tMemberPolitics = data.MemberPolitics;\r\n");
      out.write("                        \t\t\tMemberBirthplace = data.MemberBirthplace;\r\n");
      out.write("                        \t\t\tMemberAcademy = data.MemberAcademy;\r\n");
      out.write("                        \t\t\tMemberMajor = data.MemberMajor;\r\n");
      out.write("                        \t\t\tMemberGrade = data.MemberGrade;\r\n");
      out.write("                        \t\t\tMemberPhone = data.MemberPhone;\r\n");
      out.write("                        \t\t\tMemberqq = data.Memberqq;\r\n");
      out.write("                        \t\t\tMemberEmail = data.MemberEmail;\r\n");
      out.write("                        \t\t\tMemberwx = data.Memberwx;\r\n");
      out.write("                        \t\t\twindow.opener.setRole(reId,MemberSno,MemberName,MemberSex,MemberBrith,MemberPolitics\r\n");
      out.write("                        \t\t\t\t\t,MemberBirthplace,MemberAcademy,MemberGrade,MemberMajor,MemberPhone,Memberqq,MemberEmail,Memberwx);\r\n");
      out.write("                \t\t\t    \twindow.close();\r\n");
      out.write("                        \t\t}else{\r\n");
      out.write("                        \t\t\talert(\"选定失败！\")\r\n");
      out.write("                        \t\t}\r\n");
      out.write("                                   \r\n");
      out.write("                                 },\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction selectRole3(){\r\n");
      out.write("\t\t\t\tvar values = '");
      out.print(values);
      out.write("';\r\n");
      out.write("\t\t\t\tvar chks = document.getElementsByName(\"chk1\");\r\n");
      ...
      out.write("\t\t\t\t\t   return;\r\n");
      out.write("\t\t\t\t   }\r\n");
      out.write("\t       \t\t\t//var ClubName = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaName = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaSex = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaAge = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaNation = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaPolitics = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaBirthplace = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaDuty = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaAcademy = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaTel = \"\";\r\n");
      out.write("\t       \t\t\tvar TeaPhone = \"\";\t\r\n");
      out.write("\t       \t\t\tvar TeaEmail = \"\";\r\n");
      out.write("\t\t\t    \tvar reId = rows[rowIndex[0]][getCodeIndex('Id')]+\"\";\r\n");
      out.write("\t\t\t    \t\r\n");
      out.write("\t\t\t    \t$.ajax({\r\n");
      out.write("                        type: \"get\",\r\n");
      out.write("                        url: \"BaseUserCodeAction.jsp\",\r\n");
      out.write("                        data: {Id:reId,cmd:'teaMsg'},\r\n");
      out.write("                        dataType: \"json\",\r\n");
      out.write("                       // async:false,\r\n");
      out.write("                        cache: false,\r\n");
      out.write("                        success: function(data){\r\n");
      ...
      out.write("                        \t\tif(data.msg==\"ok\"){\r\n");
      out.write("                        \t\t\t\r\n");
      out.write("                        \t\t\t//ClubName = data.ClubName;\r\n");
      out.write("                \t       \t\t\tTeaName = data.TeaName;\r\n");
      out.write("                \t       \t\t\tTeaSex = data.TeaSex;\r\n");
      out.write("                \t       \t\t\tTeaAge = data.TeaAge;\r\n");
      out.write("                \t       \t\t\tTeaNation = data.TeaNation;\r\n");
      out.write("                \t       \t\t\tTeaPolitics = data.TeaPolitics;\r\n");
      out.write("                \t       \t\t\tTeaBirthplace = data.TeaBirthplace;\r\n");
      out.write("                \t       \t\t\tTeaDuty = data.TeaDuty;\r\n");
      out.write("                \t       \t\t\tTeaAcademy = data.TeaAcademy;\r\n");
      out.write("                \t       \t\t\tTeaTel = data.TeaTel;\r\n");
      out.write("                \t       \t\t\tTeaPhone = data.TeaPhone;\t\r\n");
      out.write("                \t       \t\t\tTeaEmail = data.TeaEmail;\r\n");
      out.write("                        \t\t\twindow.opener.setRole(reId,TeaName,TeaSex,TeaAge\r\n");
      out.write("                        \t\t\t\t\t,TeaNation,TeaPolitics,TeaBirthplace,TeaDuty,TeaAcademy,TeaTel,TeaPhone,TeaEmail);\r\n");
      out.write("                \t\t\t    \twindow.close();\r\n");
      out.write("                        \t\t}else{\r\n");
      out.write("                        \t\t\talert(\"选定失败！\")\r\n");
      out.write("                        \t\t}\r\n");
      ...
      out.write("\t\t\t    }    \r\n");
      out.write("\t\t\t    //str = str + \"<td bgcolor=\\\"#809091\\\" nowrap><div class=\\\"browsetable004\\\">编辑</div></td>\\n\";\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.print(HtmlTool.renderSelect(xynameoptions, ParamUtils.getParameter(request,"_DeptId_",""), "_DeptId_", ""));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div align=\"right\">学生姓名</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
