 ...
 * Generated at: 2017-04-10 05:58:58 UTC
...
List sexoptions = (List)request.getAttribute("sexoptions");
	...
	String values = ParamUtils.getParameter(request,"values","");
      ...
      out.write("\t\t\t\t\t\t\treName += \",\"+rows[rowIndex[i]][getCodeIndex('CnName')];\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t        str = str + \"<td bgcolor=\\\"#809091\\\"><div class=\\\"browsetable004\\\"><input type=\\\"checkbox\\\" onclick=\\\"selectAll(this);\\\" onchange=\\\"selectAll(this);\\\"></div></td>\\n\";\r\n");
      out.write("\t\t\t    }\r\n");
      ...
      out.write("\t\t\t        str = str + \"<td bgcolor=\\\"#809091\\\" onclick=\\\"javascript:setOrderBy('\" + fields[i] + \"', '\" + url_para + \"')\\\" nowrap><div class=\\\"browsetable004\\\">\" + title;\r\n");
