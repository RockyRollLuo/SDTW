...
public final class ClubActivityProjectList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo.hasFunPower(Power.STUSER)){
      ...
      out.write("\t\t\t    \tstr = str + \"<td bgcolor=\\\"#3992d0\\\" nowrap><div class=\\\"browsetable004\\\">查看项目</div></td><td bgcolor=\\\"#3992d0\\\" nowrap><div class=\\\"browsetable004\\\">参与立项</div></td>\\n\";\r\n");
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t    ");
}
      ...
      out.write("\r\n");
      out.write("\t\t\t    if(showEdit == \"1\"){\r\n");
      out.write("\t\t\t    \tstr = str + \"<td bgcolor=\\\"#3992d0\\\" nowrap><div class=\\\"browsetable004\\\">");
      out.print(desc);
      out.write("</div></td><td bgcolor=\\\"#3992d0\\\" nowrap><div class=\\\"browsetable004\\\">参看参与立项活动</div></td>\\n\";\r\n");
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t    ");
}
      ...
      out.write("\t\t\t        str = str + \"<tr><td colspan=\" + (showfields.length + 3) + \" bgcolor=\\\"#FFFFFF\\\" ><div class=\\\"browsetable006\\\">没有记录！</div></td></tr>\\n\";\r\n");
      out.write("\t\t\t    } \r\n");
      out.write("\t\t\t    else {\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t            \tif(rows[i][13]==='1'){\r\n");
      out.write("\t\t\t            \tstr = str + \"<td class=\\\"xxybgx2\\\"  onclick=\\\"javascript:modifyRecord1_show('\" + rows[i][1] + \"','\" + rows[i][keyindex] + \"')\\\">&nbsp;</td><td class=\\\"xxybgx2\\\" onclick=\\\"javascript:Apply('\" + rows[i][keyindex] + \"','\" + currpage + \"','\" + url_para + \"')\\\"></td>\";\r\n");
      out.write("\t\t\t            \t}else{\r\n");
      out.write("\t\t\t            \t\tstr = str + \"<td class=\\\"xxybgx2\\\"  onclick=\\\"javascript:modifyRecord1_show('\" + rows[i][1] + \"','\" + rows[i][keyindex] + \"')\\\">&nbsp;</td><td style=\\\"cursor: pointer;\\\"  onclick=\\\"javascript:Apply('\" + rows[i][keyindex] + \"','\" + currpage + \"','\" + url_para + \"')\\\">已结束，查看</td>\";\r\n");
      out.write("\t\t\t            \t}\r\n");
      out.write("\t\t\t            \t");
}
      ...
      out.write("\r\n");
      out.write("\t\t\t            \tstr = str + \"<td class=\\\"xxybgx2\\\"  onclick=\\\"javascript:modifyRecord1('\" + className + \"','\" + rows[i][keyindex] + \"','\" + currpage + \"','\" + url_para + \"','\" + cmd + \"')\\\">&nbsp;</td><td class=\\\"xxybgx2\\\" onclick=\\\"javascript:Apply('\" + rows[i][keyindex] + \"','\" + currpage + \"','\" + url_para + \"')\\\"></td>\";\r\n");
      out.write("\t\t\t            \t");
}
      out.write("\r\n");
      out.write("\t\t\t            }\r\n");
      ...
      out.write("\t\t\t                if(allfields[k]==\"Id\" ||allfields[k]==\"OrderNo\" ||allfields[k]==\"ProjectName\" || allfields[k]==\"Subject\" || allfields[k] == \"Email\"|| allfields[k] == \"Title\"){\r\n");
      ...
      out.write("\t\t\t                    }\r\n");
      out.write("\t\t\t                    if(j==0)\r\n");
      out.write("\t\t\t                \t\tstr = str + getRow1(\"<a class=visit style='cursor:hand' href=javascript:modifyRecord1('\" + rows[i][1] + \"','\" + rows[i][keyindex] + \"'); title='\" + atitle + \"'>\"+rows[i][k]+\"</a>\", fields[j]);\r\n");
      out.write("\t\t\t                \telse\r\n");
      out.write("\t\t\t                \t\tstr = str + getRow(\"<a class=visit style='cursor:hand' href=javascript:modifyRecord1('\" + rows[i][1] + \"'); title='\" + atitle + \"'>\"+rows[i][k]+\"</a>\", fields[j]);\r\n");
      out.write("\t\t\t                }else{\r\n");
      out.write("\t\t\t                \tif(j==0)\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction modifyRecord1_show(title,id){\r\n");
      out.write("\t\t\t\tparent.showDialog('");
      out.print(HeadConst.apache_url);
      out.write("/main/club/ClubActivityProject.jsp?id='+id,600,600,title\r\n");
      out.write("\t\t\t\t\t\t,{});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction Apply(id,currpage, url_para) {\r\n");
      out.write("\t\t\t\tvar className = \"ClubActivities\";\r\n");
      out.write("\t\t\t\tvar cmd = \"project\";//立项\r\n");
      ...
      out.write("\t\t\t    var new_url = url_para;\r\n");
      out.write("\t\t\t    var keyfield = \"ProjectId\";\r\n");
      out.write("\t\t\t    ");

			    //社团用户
			    if(userInfo.hasFunPower(Power.STUSER)){
      out.write("\r\n");
      out.write("\t\t\t   \t\twindow.location= \"ClubActivitiesAction.jsp?cmd=\"+cmd+\"&\" + keyfield + \"=\" + id;\r\n");
      out.write("\t\t\t    ");
}
      ...
      out.write("\r\n");
      out.write("\t\t\t    window.location= \"ClubActivitiesAction.jsp?_Module_=club-project&cmd=clubproject&\" + keyfield + \"=\" + id+\"&Ppage=\" + currpage + ((new_url.length == 0) ? \"\" : \"&\" + new_url);\r\n");
      out.write("\t\t\t    ");
}
