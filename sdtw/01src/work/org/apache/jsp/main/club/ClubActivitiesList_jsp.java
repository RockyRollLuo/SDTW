 ...
 * Generated at: 2017-04-19 01:54:21 UTC
...
public final class ClubActivitiesList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo.hasFunPower(Power.STUSER)){
      ...
      out.write("\t\t\t                }\r\n");
      out.write("\t\t\t            }\r\n");
      out.write("\t\t\t            var chelx = rows[i][54];//是否立项\r\n");
      out.write("\t\t\t            if(chelx==\"立项\"){\r\n");
      out.write("\t\t\t            \tcmd=\"project\";\r\n");
      out.write("\t\t\t            }else{\r\n");
      out.write("\t\t\t            \tcmd=\"modify\";\r\n");
      out.write("\t\t\t            }\r\n");
      out.write("\t\t\t            if(showEdit == \"1\"){\r\n");
      ...
      out.write("\t\t\t    var url = className + \"Action.jsp?cmd=\"+cmd+\"&\" + keyfield + \"=\" + id + \"&page=\" + currpage + ((new_url.length == 0) ? \"\" : \"&\" + new_url);\r\n");
      out.write("\t\t\t    if(cmd==\"project\"){\r\n");
      out.write("\t\t\t    \turl+=\"&activity=1\";//社团活动查看，区别立项和未立项活动\r\n");
      out.write("\t\t\t    }\r\n");
