...
public final class ClubTeacherList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	String _ClubName_ = ParamUtils.getParameter(request,"_ClubName_","-1");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">社团指导教师</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("社团指导教师"));
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input id=\"ClubName\" name=\"ClubName\" value=\"");
      out.print(ClubName);
      out.write("\" type=\"hidden\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input id=\"_ClubName_\" name=\"_ClubName_\" value=\"");
      out.print(_ClubName_);
      out.write("\" type=\"hidden\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(Tool.join("\n", forms));
      out.write("\r\n");
