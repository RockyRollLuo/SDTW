...
public final class ClubActivityParticipateList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	String CheckFlag = ParamUtils.getParameter(request,"CheckFlag","-1");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction check(className,flag,url_para){\r\n");
      out.write("\t\t\t\tvar page = '");
      out.print(currpage);
      out.write("';\r\n");
      ...
      out.write("\t\t\t\t    \t\tbs = \"审核未通过\";\r\n");
      out.write("\t\t\t\t    \t}\r\n");
      out.write("\t\t\t\t       if (confirm(\"确实要\"+bs+\"这些记录吗?\")) {\r\n");
      out.write("\t\t\t\t            location = className + \"Action.jsp?cmd=updatelist&_Checkflag_=\"+flag+\"&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t\t        } \r\n");
      out.write("\t\t\t\t    } else {\r\n");
      ...
      out.write("\t\t</script>\r\n");
      out.write("\t</head>\r\n");
      out.write("\t<body onload=\"init();\" style=\"background-color: #ffffff;\">\r\n");
      out.write("\t\t");
      ...
      out.write("                               <tr>\r\n");
      out.write("                                   <td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t            <div class=\"browsetitle title_css\" style=\"background-color: #ffffff\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t            <div class=\"browsetitleleft\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">社团活动报名</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("社团活动报名"));
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:check('");
      out.print(request.getAttribute("classname"));
      out.write("',2,url_para);\">审核未通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:check('");
      out.print(request.getAttribute("classname"));
      out.write("',1,url_para);\">审核通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            ");
}
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"_Activityid_\" name=\"_Activityid_\" value=\"");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(HtmlTool.renderSelect(getCheckFlagOptions,""+ParamUtils.getParameter(request,"_CheckFlag_",""),"_CheckFlag_","") );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("                               </div>\r\n");
