...
public final class ClubModifyTeacherList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo.hasFunPower(Power.STUSER)){
      ...
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction showwinside(uid,cid,checkflag,title){\r\n");
      out.write("\t\t\t\tvar clienth = 600;\r\n");
      out.write("\t\t\t\tvar clientw = 1366;\r\n");
      out.write("\t\t\t\tparent.showDialog('");
      out.print(HeadConst.apache_url);
      out.write("/main/club/EditClubModifyTeacher.jsp?uid='+uid+'&cid='+cid+'&checkflag='+checkflag,clientw,clienth,title\r\n");
      out.write("\t\t\t\t\t\t,{\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">社团变更指导教师</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("社团变更指导教师"));
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
