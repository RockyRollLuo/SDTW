 ...
 * Generated at: 2017-04-19 01:55:30 UTC
...
public final class ClubMembersList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	String _MemberClubname_ = ParamUtils.getParameter(request,"_MemberClubname_","");
      ...
      out.write(", url_para);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t//flag  0本科生  1研究生\r\n");
      out.write("\t\t\tfunction addNewWinOp(flag)\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\tvar url = \"\";\r\n");
      out.write("\t\t\t\tvar title = \"\";\r\n");
      out.write("\t\t\t\tif (flag==\"0\") {\r\n");
      ...
      out.write("\t\t\t\t\turl = \"");
      out.print(HeadConst.apache_url);
      out.write("/main/club/ClubMemberBk.jsp?Identity=0\";\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif (flag==\"1\") {\r\n");
      out.write("\t\t\t\t\ttitle = \"研究生\";\r\n");
      out.write("\t\t\t\t\turl = \"");
      out.print(HeadConst.apache_url);
      out.write("/main/club/ClubMemberYjs.jsp?Identity=1\";\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t   /*  if (!url_para)\r\n");
      out.write("\t\t\t        url_para = \"\";\r\n");
      out.write("\t\t\t    location = className + \"Action.jsp?flag=\"+flag+\"&cmd=\" + cmd + ((url_para.length == 0) ? \"\" : \"&\" + url_para); */\r\n");
      out.write("\t\t    \tparent.showDialog (url,1200,620,title\r\n");
      out.write("\t\t                ,{ '确定': function(){\r\n");
      out.write("\t\t                      parent.submitthis();\r\n");
      out.write("\t\t                }\r\n");
      out.write("\t\t      });\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t</script>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:addNewWinOp(1);\">研究生增加</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:addNewWinOp(0);\">本科生增加</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            ");
} 
      out.write("\r\n");
      ...
      out.write("    \t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"MemberClubname\" name=\"MemberClubname\" value=\"");
      out.print(MemberClubname);
      out.write("\"/>\r\n");
      out.write("    \t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"_MemberClubname_\" name=\"_MemberClubname_\" value=\"");
      out.print(_MemberClubname_);
      out.write("\"/>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(HtmlTool.renderSelect(AuditOptions,ParamUtils.getParameter(request,"_CheckFlag_","-1"),"_CheckFlag_","0") );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
