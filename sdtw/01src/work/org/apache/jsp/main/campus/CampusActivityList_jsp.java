 ...
 * Generated at: 2017-04-26 07:40:26 UTC
...
public final class CampusActivityList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	int _ActivitykindType_ = ParamUtils.getIntParameter(request,"_ActivitykindType_",-1);
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction checkbaoming(idlist){\r\n");
      out.write("\t\t\t\tvar msg = \"\";\r\n");
      out.write("\t\t\t\t$.ajax({\r\n");
      out.write("                    type: \"get\",\r\n");
      out.write("                    url: \"CampusActivityAction.jsp\",\r\n");
      out.write("                    data: {idlist:idlist,cmd:'checkbaoming'},\r\n");
...
if (userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.WHHD)) {
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<td><input id=\"_ActivityName_\" name=\"_ActivityName_\" value=\"");
      out.print(ParamUtils.getParameter(request,"_ActivityName_",""));
      out.write("\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("                               </div>\r\n");
