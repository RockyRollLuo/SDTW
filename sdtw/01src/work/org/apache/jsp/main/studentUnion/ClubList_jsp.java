 ...
 * Generated at: 2017-04-26 07:37:23 UTC
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo == null){
      ...
      out.write("\t\t\t\tvar clientw = 1100;\r\n");
      out.write("\t\t\t\tparent.showDialog('");
      out.print(HeadConst.apache_url);
      out.write("/main/studentUnion/EditClubModifySponsor.jsp?uid='+uid+'&cid='+cid+'&checkflag='+checkflag,clientw,clienth,title\r\n");
      out.write("\t\t\t\t\t\t,{\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">社团列表</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
