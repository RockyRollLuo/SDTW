 ...
 * Generated at: 2017-04-24 09:01:18 UTC
...
public final class StudentUnionMemberForm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(deptid.equals("-1")){
	shuchu="学生会主席团成员";
      ...
      out.write("\");\r\n");
      out.write("    \t\t\t\r\n");
      out.write("    \t\t\t$(\"#UnionorDept\").change(function(){\r\n");
      ...
      out.write("    \t\t\t\t\t\t$(\"#SNo\").val(data.name)\r\n");
      out.write("    \t\t\t\t\t\t\t\t$(\"#SNo\").val(data.name)     \r\n");
      out.write("    \t\t\t\t\t\t\t$(\"#ChargeDept\").val(data.deptid)\r\n");
      out.write("    \t\t\t\t\t\t\t\t$(\"#Campus\").val(data.opid)\r\n");
      out.write("    \t\t\t\t\t\t\t\t\t$(\"#Phone\").val(data.phone)\r\n");
      out.write("    \t\t\t\t\t\t\t\t\t\t$(\"#Remark\").val(data.email)\r\n");
      out.write("    \t\t\t\t\t\t\t\t\t\t$(\"#SchoolYear\").val(data.nianji)\r\n");
      out.write("    \t\t\t\t\t\t\t\t\t\r\n");
      out.write("    \t\t\t\t\t\t\t}\r\n");
      ...
      out.write("\t\t\t\topenWindow(\"BaseUserCodeAction2.jsp?values=\"+$('#UnionorDept').val()+\"&_DeptId_=\"+$('#ChargeDept').val(),\"713,430\")\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t    function setRole(name,id,sno){\r\n");
      out.write("\t        \t // var id1=$('#UnionorDept').val()+\"\"+id;\r\n");
      out.write("\t        \t  $('#UnionorDept').val(id);\r\n");
      ...
      out.write("\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"StudentUnionMemberAction.jsp?cmd=list&page=");
      out.print(currpage);
      ...
      out.print(v.getId());
      out.write("\">\r\n");
      out.write("<input  type=\"hidden\" id=\"UnionorDept\" name=\"UnionorDept\" value=\"");
      out.print(v.getUnionorDept());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t<tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">学院</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.print(HtmlTool.renderSelect(xynameoptions, v.getChargeDept(), "ChargeDept", ""));
      out.write("\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">校区</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.print(HtmlTool.renderSelect(OrgNameoptions, v.getCampus(), "Campus", ""));
      out.write("\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t<tr>\r\n");
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t");
      out.print(HtmlTool.renderSelect(nianjioptions, v.getSchoolYear(), "SchoolYear", ""));
      out.write("\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">职位</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\" colspan=\"3\">\r\n");
      out.print(HtmlTool.renderSelect(StuDutyoptions, v.getDuty(), "Duty", "-1"));
      out.write("\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input  name=\"xingming\" id=\"xingming\" size=\"0\" value=\"\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"javascript:tianjia();\">添加</a>\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">学号</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"SNo\" id=\"SNo\" size=\"0\" value=\"");
      out.print(v.getSNo());
      out.write("\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">校级院级学生会id</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"Unionid\" id=\"Unionid\" value=\"");
      out.print(UnionId);
      out.write("\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\" colspan=\"3\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"Phone\" id=\"Phone\" size=\"45\" maxsize=\"45\" value=\"");
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">说明</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\" colspan=\"3\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea cols=\"100\" rows=\"2\" id=\"Remark\" name=\"Remark\">");
