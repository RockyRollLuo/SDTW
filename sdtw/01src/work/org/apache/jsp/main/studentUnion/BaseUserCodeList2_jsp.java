 ...
 * Generated at: 2017-04-26 07:31:45 UTC
...
public final class BaseUserCodeList2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List sexoptions = (List)request.getAttribute("sexoptions");
	...
	List  xynameoptions=COptionConst.getAcademyNameOptions(userInfo,"",cdt);
      ...
      out.write("\t\t\t\t\t\tsno = rows[rowIndex[i]][getCodeIndex('Name')];\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t//reId = reId.substring(1,reId.length);\t\r\n");
      out.write("\t\t\t    \twindow.opener.setRole(reName,reId,sno);\r\n");
      ...
      out.write("\t\t\t                    }\r\n");
      out.write("\t\t\t                    if(j==0)\r\n");
      out.write("\t\t\t                \t\tstr = str + getRow1(\"<a class=visit style='cursor:hand'  title='\" + atitle + \"'>\"+rows[i][k]+\"</a>\", fields[j]);\r\n");
      out.write("\t\t\t                \telse\r\n");
      out.write("\t\t\t                \t\tstr = str + getRow(\"<a class=visit style='cursor:hand'  title='\" + atitle + \"'>\"+rows[i][k]+\"</a>\", fields[j]);\r\n");
      out.write("\t\t\t                }else{\r\n");
      out.write("\t\t\t                \tif(j==0)\r\n");
      ...
      out.print(request.getAttribute("classname"));
      out.write("Action2.jsp\" name=\"query\" id=\"postForm\" method=\"post\">\r\n");
      out.write("  \t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("    \t\t\t\t\t\t\t\t\t<td>\r\n");
