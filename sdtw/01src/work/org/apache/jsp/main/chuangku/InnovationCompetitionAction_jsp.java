...
public final class InnovationCompetitionAction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
private String[][] DicValues = {{"int", "id", "0", "hidden", ""}, {"string", "作品编码", "20", "text", ""}, {"string", "作品名称", "100", "text", ""}, {"string", "学院全称", "100", "AcademyName", ""}, {"string", "申报团队名称", "45", "text", ""}, {"string", "作品类别", "20", "ProductionType", ""}, {"string", "申报类别", "10", "DeclarerRoleType", ""}, {"string", "备注", "500", "hidden", ""}, {"string", "添加文件列表", "200", "hidden", ""}, {"date", "添加时间", "0", "hidden", ""}, {"string", "添加人", "45", "hidden", ""}, {"date", "修改时间", "0", "hidden", ""}, {"string", "修改人", "45", "hidden", ""}, {"string", "学院意见", "500", "hidden", ""}, {"string", "团委意见", "500", "hidden", ""}, {"string", "负责人", "45", "hidden", ""}, {"string", "负责人ID", "45", "hidden", ""}, {"string", "团队成员", "100", "hidden", ""}, {"int", "学院审核", "0", "Audit", ""}, {"string", "考核人", "45", "text", ""}, {"int", "团委审核", "0", "Audit", ""}, {"string", "考核人", "45", "text", ""}, {"string", "奖励荣誉", "45", "text", ""}, {"string", "所属项目", "45", "text", ""}};
