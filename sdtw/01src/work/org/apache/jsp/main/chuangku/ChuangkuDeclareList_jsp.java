 ...
 * Generated at: 2017-04-25 06:50:54 UTC
...
public final class ChuangkuDeclareList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	System.out.println(projectid);
      ...
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifylist&_ckid_=");
      out.print(projectid);
      ...
      out.write("\t\t\t         \r\n");
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifylist1&_ckid_=");
      out.print(projectid);
      out.write("&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      ...
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t    if (chkeds.length > 0) {\r\n");
      out.write("\t\t\t        if (confirm(\"只能导出审核通过的记录,确实要导出这些记录吗?\")) {\r\n");
      out.write("\t\t\t            var url= className + \"Action.jsp?cmd=excelselect&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t            location = url;\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      out.write("\t\t\t    \tif (confirm(\"只能导出审核通过的记录,确实要导出这些记录吗?\")) {\r\n");
      out.write("\t\t\t    \t//document.query.cmd.value = 'excel'; document.query.submit();\r\n");
      out.write("\t\t\t    \t\tvar url = className + \"Action.jsp?cmd=excel&_ckid_=");
      out.print(projectid);
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">山大创库报名列表</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("山大创库报名列表"));
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t           \t\t<li><a href=\"javascript:document.query.cmd.value = 'list';download('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para,1);\">导出信息</a></li>\r\n");
