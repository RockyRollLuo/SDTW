 ...
 * Generated at: 2017-04-07 08:54:10 UTC
...
public final class TrainingParticipateList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	List AuditList = util.getAuditList();
      ...
      out.write(", url_para);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction checkBaoming(className, url_para,flag) {\r\n");
      out.write("\t\t\t\t  var page = ");
      out.print(currpage);
      out.write(";\r\n");
      out.write("\t\t\t\t  var str = \"\";\r\n");
      ...
      out.write("\t\t\t\t        if (confirm(\"确实\"+str+\"这些记录吗?\")) {\r\n");
      out.write("\t\t\t\t            location = className + \"Action.jsp?cmd=baominglist&idlist=\" + chkeds.join(',') + \"&Audit=\"+flag+\"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t\t        }\r\n");
      out.write("\t\t\t\t    } else {\r\n");
      out.write("\t\t\t\t        alert(\"未选择记录！\");\r\n");
      out.write("\t\t\t\t    }\r\n");
      out.write("\t\t\t} \r\n");
      out.write("\t\t\tfunction chekzuoye(className, url_para) {\r\n");
      out.write("\t\t\t\tvar page = ");
      out.print(currpage);
      out.write(";\r\n");
      out.write("\t\t\t\tvar chks = document.getElementsByName(\"chk1\");\r\n");
      ...
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t    if (chkeds.length > 0) {\r\n");
      out.write("\t\t\t        if (confirm(\"确实审核这些记录吗?\")) {\r\n");
      out.write("\t\t\t        \t///sdtw/01src/web/main/train/zuoye.jsp\r\n");
      out.write("\t\t\t        \tvar url = \"");
      out.print(HeadConst.apache_url);
      out.write("/main/train/zuoye.jsp?idlist=\"+chkeds.join(',');\r\n");
      out.write("\t\t\t        \tparent.parent.showDialog (url,500,350,'审核作业'\r\n");
      out.write("                                ,{ '确定': function(){\r\n");
      out.write("                                \tparent.parent.submitthis();\r\n");
      out.write("                                \t//alert(\"TrainingParticipateAction.jsp?_Audit_=0&_ProjectId_=");
      out.print(ProjectId);
      out.write("\");\r\n");
      out.write("                                \tparent.$('#commentFrame0').attr(\"src\",\"TrainingParticipateAction.jsp?_Audit_=0&_ProjectId_=");
      out.print(ProjectId);
      out.write("\") \r\n");
      out.write("                                }\r\n");
      out.write("                      });\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\tfunction jieti(className, url_para) {\r\n");
      out.write("\t\t\t\tvar page = ");
      out.print(currpage);
      out.write(";\r\n");
      out.write("\t\t\t\tvar chks = document.getElementsByName(\"chk1\");\r\n");
      ...
      out.write("\t\t\t        \tvar url = \"");
      out.print(HeadConst.apache_url);
      out.write("/main/train/jieti.jsp?idlist=\"+chkeds.join(',');\r\n");
      out.write("\t\t\t        \tparent.parent.showDialog (url,500,300,'审核结题'\r\n");
      out.write("                                ,{ '确定': function(){\r\n");
      out.write("                                \tparent.parent.submitthis();\r\n");
      out.write("                                \t//alert(\"TrainingParticipateAction.jsp?_Audit_=0&_ProjectId_=");
      out.print(ProjectId);
      out.write("\");\r\n");
      out.write("                                \tparent.$('#commentFrame2').attr(\"src\",\"TrainingParticipateAction.jsp?_Audit_=2&_ProjectId_=");
      out.print(ProjectId);
      out.write("\") \r\n");
      out.write("                                }\r\n");
      out.write("                      });\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t        \t   <li class=\"browsetitle_lang\"><a href=\"javascript:checkBaoming('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para,1);\">审核不通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t           <li class=\"browsetitle_lang\"><a href=\"javascript:checkBaoming('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para,0);\">审核通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t           ");
}
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t           <li class=\"browsetitle_lang\"><a href=\"javascript:chekzuoye('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para);\">审核</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t           ");
}
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t           <li class=\"browsetitle_lang\"><a href=\"javascript:jieti('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para);\">审核</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t           ");
}
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"_All_\" name=\"_All_\" value=\"");
      out.print(all);
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"_ProjectId_\" name=\"_ProjectId_\" value=\"");
      out.print(ProjectId);
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>状态</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(HtmlTool.renderSelect(AuditList,""+audit,"_Audit_","") );
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
