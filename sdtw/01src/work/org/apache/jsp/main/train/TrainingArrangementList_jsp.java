...
public final class TrainingArrangementList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo == null){
      ...
      out.write(", url_para);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction deleteList(className, url_para)\r\n");
      out.write("\t\t\t{\r\n");
      ...
      out.write("\t\t\t           $.ajax({\r\n");
      out.write("                        type: \"post\",\r\n");
      out.write("                        url: className + \"Action.jsp\",\r\n");
      out.write("                        data: {idlist:chkeds.join(','),cmd:'checkdelete'},\r\n");
      ...
      out.write("                                   } else {\r\n");
      out.write("                                \t   alert(\"选择项目中，已有人报名，不可删除！\")\r\n");
      out.write("                                   }\r\n");
      out.write("                                 },\r\n");
