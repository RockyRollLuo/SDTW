 ...
 * Generated at: 2017-04-25 07:24:48 UTC
...
public final class StudentRzdList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
// 	String _type_=ParamUtils.getParameter(request, "_type_","");
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//批量审核\r\n");
      out.write("\t\t\tfunction checkList(className, url_para,checkflag){\r\n");
      out.write("\t\t\t\tcheckList1(className, url_para,checkflag, 1);\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction checkList1(className, url_para, checkflag,page)\r\n");
      out.write("\t\t\t{\r\n");
      ...
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=checklist&checkflag=\"+checkflag+\"&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
...
if(userInfo.hasFunPower(Power.UserAdminPower)){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:checkList('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para,'");
      out.print(SdtwConst.RZDCHECK_TG);
      out.write("');\">通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:checkList('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para,'");
      out.print(SdtwConst.RZDCHECK_WTG);
      out.write("') ;\">不通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t        ");
}
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t        \t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li class=\"browsetitle_lang\"><a href=\"StudentRzdStateAction.jsp\">学生打印记录</a></li>\r\n");
...
if(userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.ZZJS)){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t类型：");
      out.print(HtmlTool.renderSelect(rzdTypeOptions,ParamUtils.getParameter(request, "_type_",""), "_type_",""));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t学号：<input type=\"text\" name=\"_sno_\" value=\"");
