 ...
 * Generated at: 2017-04-25 02:47:13 UTC
...
public final class StudentRzdStudent_002dprint_jsp extends org.apache.jasper.runtime.HttpJspBase
...
Map rzdPrintMap=srUtil.getPrintRzdByType(idlist,stuid);
      ...
      out.write("\tvar printtime=getPrinttime();\r\n");
      out.write("\tvar printcode=getPrintcode();\r\n");
      out.write("\tdocument.getElementById(\"printtime\").innerHTML=printtime.substring(0,10);\r\n");
      out.write("\tdocument.getElementById(\"printcode\").innerHTML=printcode;\r\n");
      out.write("\tprintFunc2();\r\n");
      out.write("\tdocument.postForm.printtime.value=printtime;\r\n");
      out.write("\tdocument.postForm.printcode.value=printcode;\r\n");
      out.write("\tdocument.postForm.submit();\r\n");
      out.write("\t\t\r\n");
      out.write("}\r\n");
      out.write("function getPrinttime() {\r\n");
      out.write("    var date = new Date();\r\n");
      out.write("    var month = date.getMonth() + 1;\r\n");
      out.write("    var strDate = date.getDate();\r\n");
      out.write("    if (month >= 1 && month <= 9) month = \"0\" + month;\r\n");
      out.write("    if (strDate >= 0 && strDate <= 9) strDate=\"0\"+strDate;\r\n");
      out.write("    return date.getFullYear()+\"-\"+month+\"-\"+strDate+\" \"+date.getHours()+\":\"+date.getMinutes()+\":\"+date.getSeconds();\r\n");
      out.write("}\r\n");
      out.write("function getPrintcode(){\r\n");
      out.write("\tvar s= '';\r\n");
      out.write("\tvar randomchar=function(){\r\n");
      out.write("\t\tvar n= Math.floor(Math.random()*62);\r\n");
      out.write("\t\tif(n<10) return n; //1-10\r\n");
      out.write("\t\tif(n<36) return String.fromCharCode(n+55); //A-Z\r\n");
      out.write("\t\treturn String.fromCharCode(n+61); //a-z\r\n");
      out.write("\t};\r\n");
      out.write("\twhile(s.length< 10) s+= randomchar();\r\n");
      out.write("\treturn s;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
...
if("view".equals(cmd)){
      out.write("\r\n");
      out.write("\t<div align=\"center\"><button onclick=\"printFunc2()\">打印</button></div>\r\n");
}else{
      out.write("\r\n");
...
rzdPrintMap.clear();
      ...
      out.write("<tr>\r\n");
      out.write("\t<td width=\"50%\" align=\"center\">打印日期：<span id=\"printtime\">");
      out.print(printtime);
      out.write("</span></td>\r\n");
      out.write("\t<td width=\"50%\" align=\"center\">打印编号：<span id=\"printcode\">");
      out.print(printcode);
      out.write("</span></td>\r\n");
      out.write("</tr>\r\n");
      out.write("</table>\r\n");
      out.write("</div>\r\n");
      out.write("<form action=\"StudentRzdStudentAction.jsp\" name=\"postForm\" method=\"post\">\r\n");
      out.write("\t<input type=\"hidden\" name=\"cmd\" value=\"print\"/>\r\n");
      out.write("\t<input type=\"hidden\" name=\"idlist\" value=\"");
      out.print(idlist);
      out.write("\"/>\r\n");
      out.write("\t<input type=\"hidden\" name=\"printtime\" value=\"\"/>\r\n");
      out.write("\t<input type=\"hidden\" name=\"printcode\" value=\"\"/>\r\n");
      out.write("</form>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
