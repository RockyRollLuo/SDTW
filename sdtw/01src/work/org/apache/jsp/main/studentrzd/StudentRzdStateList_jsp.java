 ...
 * Generated at: 2017-04-25 07:57:43 UTC
...
public final class StudentRzdStateList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	List AcademyNameoptions=COptionConst.getAcademyNameOptions(userInfo,"",cdt);
      ...
      out.write("    \tstr = str + \"<td bgcolor=\\\"#3992d0\\\" nowrap><div class=\\\"browsetable004\\\">编辑</div></td>\\n\";\r\n");
      out.write("    }*/\r\n");
      out.write("    str = str + \"<td bgcolor=\\\"#3992d0\\\" nowrap><div class=\\\"browsetable004\\\">查看</div></td></tr>\\n\";\r\n");
      ...
      out.write("            }        \r\n");
      out.write("\r\n");
      out.write("            str = str + \"<td><a href=\\\"#\\\" onclick=\\\"viewFunc('\"+rows[i][keyindex]+\"')\\\">查看</a></td></tr>\\n\";\r\n");
      out.write("        }\r\n");
      out.write("    }\r\n");
      ...
      out.write("\t\twindow.open(\"StudentRzd-print.jsp?cmd=view&stateid=\"+stateid,\"_blank\",\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">学生素质拓展培养认证单打印记录表</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("学生素质拓展培养认证单打印记录表"));
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"StudentRzdAction.jsp\">返回</a></li>\r\n");
...
if(userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.RZD)){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t打印时间：<input type=\"text\" name=\"_printtime_\" value=\"");
      out.print(ParamUtils.getParameter(request, "_printtime_",""));
      out.write("\" placeholder=\"yyyy-mm-dd\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t学号：<input type=\"text\" name=\"_stuNo_\" value=\"");
      out.print(ParamUtils.getParameter(request, "_stuNo_",""));
      out.write("\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t");
      out.print(Tool.join("\n", forms));
      out.write("\r\n");
