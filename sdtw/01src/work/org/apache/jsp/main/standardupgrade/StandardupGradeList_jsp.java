 ...
 * Generated at: 2017-04-07 08:44:27 UTC
...
public final class StandardupGradeList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo == null){
      ...
      out.write("\r\n");
      out.write("\t\t\t    str = str+\"<td bgcolor=\\\"#3992d0\\\" nowrap><div class=\\\"browsetable004\\\">各学院上传资料</div></td>\";\r\n");
      out.write("\t\t\t    ");
} else {
      out.write("\r\n");
      out.write("\t\t\t    str = str+\"<td bgcolor=\\\"#3992d0\\\" nowrap><div class=\\\"browsetable004\\\">上传资料</div></td>\";\r\n");
      out.write("\t\t\t    ");
}
      out.write("\r\n");
      ...
      out.write("\t\t\t                \telse {\r\n");
      out.write("\t\t\t                \t\tstr = str + getRow(rows[i][k], fields[j])+\"<td onclick=inList(\"+rows[i][0]+\")>点击进入</td>\";\r\n");
      out.write("\t\t\t                \t}\r\n");
      out.write("\t\t\t                }                \r\n");
      out.write("\t\t\t            }        \r\n");
      out.write("\t\t\t            str = str + \"</tr>\\n\";\r\n");
      ...
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction inList(sid){\r\n");
      out.write("\t\t\t\t");

				if (userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.ZZJS)) {
      out.write("\r\n");
      out.write("\t\t\t\t\tlocation = \"AcademyList.jsp?sid=\"+sid;\r\n");
      out.write("\t\t\t\t");
}else{
      out.write("\r\n");
      out.write("\t\t\t\t    location = \"shangbaoList.jsp?sid=\"+sid+\"&aid=");
