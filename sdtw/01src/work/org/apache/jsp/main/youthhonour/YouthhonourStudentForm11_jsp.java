 ...
 * Generated at: 2017-04-25 06:01:13 UTC
...
public final class YouthhonourStudentForm11_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	String myacademyname=(String)academynamemap.get(userInfo.getDeptId()+"");
      ...
      out.write("\t\t\t\t\tif(!myreg.test(val6)){\r\n");
      out.write("\t\t\t\t\t\t$(\"#Val6\").focus();\r\n");
      out.write("\t\t\t\t\t\talert(\"联系方式格式有误，请输入正确格式！\");\r\n");
      out.write("\t\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t}\r\n");
	...
	String strhelpwords = "申请表。";
      ...
      out.write("\r\n");
      out.write("    <tr>\r\n");
      out.write("    \t<td align=\"right\" class=\"form_label\" width=\"30%\">所属单位</td>\r\n");
...
if(!"view".equals(cmd)){
      ...
      out.write("\r\n");
      out.write("\t\t        <input type=\"button\" class=\"button\" value=\"保存\" name=\"btn1\" onclick=\"formSubmit()\"/>&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t    ");
}
