 ...
 * Generated at: 2017-04-25 02:22:07 UTC
...
public final class YouthHonourList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
// 	List AcademyNameoptions =CEditConst.getAcademyNameOptions(userInfo,"");
	...
	if(userInfo.hasFunPower(Power.UserAdminPower)) academyid=userInfo.getDeptId();
      ...
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//审核\r\n");
      out.write("\t\t\tfunction modifyList(checkflag,url_para)\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t    var chks = document.getElementsByName(\"chk1\");\r\n");
      out.write("\t\t\t    if (!url_para) url_para = \"\";//不理解\r\n");
      out.write("\t\t\t    page=1;//不理解\r\n");
      ...
      out.write("\t\t\t        if (confirm(\"确实要通过这些项目的审核吗?\")) {\r\n");
      out.write("\t\t\t          location =\"YouthHonourAction.jsp?cmd=checkpass&checkflag=\"+checkflag+\"&noticeid=");
      out.print(noticeid);
...
if(userInfo.hasFunPower(Power.UserAdminPower)&&yhUtil.getOneXyReportFlag(noticeid,academyid)==SdtwConst.XYREPORT_WSB){
      ...
      out.print(SdtwConst.XYCHECK_TG);
      out.write(",url_para);\">通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:modifyList(");
      out.print(SdtwConst.XYCHECK_WTG);
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:modifyList(");
      out.print(SdtwConst.TWCHECK_TG);
      out.write(", url_para)\">通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:modifyList(");
      out.print(SdtwConst.TWCHECK_WTG);
      out.write(", url_para)\">不通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"javascript:deleteList('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para);\">删除</a></li>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"YouthhonourAllList.jsp?noticeid=");
      out.print(noticeid);
      out.write("\">返回</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li><a href=\"Youthhonour-summary.jsp?noticeid=");
      out.print(noticeid);
      out.write("\">汇总表</a></li>\r\n");
...
if(userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.ZZJS)){
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>学院</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(HtmlTool.renderSelect(AcademyNameoptions,"", "_belongacademy_",ParamUtils.getParameter(request, "_belongacademy_","")));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
}
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>五四表彰内容</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(HtmlTool.renderSelect(YouthhonourOptions, type+"", "type",type+""));
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>姓名/负责人/名称</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td><input name=\"_val1_\" value=\"");
      out.print(ParamUtils.getParameter(request, "_val1_",""));
      out.write("\"/></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t                            \t</div>\r\n");
