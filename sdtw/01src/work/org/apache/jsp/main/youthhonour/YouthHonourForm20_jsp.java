 ...
 * Generated at: 2017-04-07 07:19:44 UTC
...
public final class YouthHonourForm20_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.ZZJS)){
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">参加校级及以上文艺活动、文艺竞赛、体育活动、体育竞赛及其它文体活动情况</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"Text1\" id=\"Text1\" cols=\"80\" rows=\"6\" placeholder=\"格式（活动名称，主办单位，获奖等级；）\">");
      out.print(v.getText1());
      out.write("</textarea>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">参加院级文艺活动、文艺竞赛、体育活动、体育竞赛及其它文体活动情况</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"Text2\" id=\"Text2\" cols=\"80\" rows=\"6\" placeholder=\"格式（活动名称，主办单位，获奖等级；）\">");
