 ...
 * Generated at: 2017-04-25 01:57:17 UTC
...
public final class YouthhonourStudentForm23_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	List clubLevelOptions=yhUtil.getClubLevelOptions();
      ...
      out.write("\t\t\t                        var filename = data.name;\r\n");
      ...
      out.write("\t\t\t\tvar val1=$(\"#Val1\").val();\r\n");
      out.write("\t\t\t\tvar val2=$(\"#Val2\").val();\r\n");
      out.write("\t\t\t\tif(val1==\"\"){\r\n");
      out.write("\t\t\t\t\t$(\"#Val1\").focus();\r\n");
      out.write("\t\t\t\t\talert(\"不能为空!\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(val2==\"\"){\r\n");
      out.write("\t\t\t\t\t$(\"#Val2\").focus();\r\n");
      out.write("\t\t\t\t\talert(\"不能为空!\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
	...
	if(v.getId()!=-1){
      ...
      out.write("\r\n");
      out.write("\t\t        <input type=\"button\" class=\"button\" value=\"保存\" name=\"btn1\" onclick=\"javascript:formSubmit()\"/>&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t    ");
}
