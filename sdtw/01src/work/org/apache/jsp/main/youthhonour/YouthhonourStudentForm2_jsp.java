 ...
 * Generated at: 2017-04-25 01:46:37 UTC
...
public final class YouthhonourStudentForm2_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	String myacademyname=(String)academynamemap.get(userInfo.getDeptId()+"");
      ...
      out.write("\t\t\t\t\talert(\"请输入基层团委名称!\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\tif(val2==\"\"){\r\n");
      out.write("\t\t\t\t\t$(\"#Val2\").focus();\r\n");
      out.write("\t\t\t\t\talert(\"请输入支部人数!\");\r\n");
      out.write("\t\t\t\t\treturn;\r\n");
      out.write("\t\t\t\t}\r\n");
	...
	String strhelpwords = "申请表。";
      ...
      out.write("\t</tr>\r\n");
      out.write("    <tr>\r\n");
      out.write("    \t<td align=\"right\" class=\"form_label\">支部人数</td>\r\n");
      out.write("  \t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
	...
	if(v.getId()!=-1){//
      ...
      out.write("\"><td align=\"left\" bgcolor=\"#FFFFFF\"><a href=\"");
      out.print(HeadConst.apache_url );
