 ...
 * Generated at: 2017-04-07 06:55:02 UTC
...
public final class YouthhonourStudentForm17_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	String strhelpwords = "申请表。";
      ...
      out.write("\t\t\t\r\n");
      out.write("    \t\t\t<tr>\r\n");
      out.write("    \t\t\t\t<td align=\"right\" class=\"form_label\">发表论文、或得专利、参加科研工作及科技学术竞赛获奖情况</td>\r\n");
      out.write("  \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("    \t\t\t\t\t<textarea name=\"Text1\" id=\"Text1\" cols=\"80\" rows=\"6\" placeholder=\"论文请按照山东大学核心期刊目录注明期刊等级\">");
