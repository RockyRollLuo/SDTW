 ...
 * Generated at: 2017-04-07 08:18:59 UTC
...
public final class SubjectAction_jsp extends org.apache.jasper.runtime.HttpJspBase
...
private List getListRows(javax.servlet.http.HttpServletRequest request, Subject pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add("<a href='AcademyList1.jsp?subjectcode="+v.getSubjectName()+"'>点击进入</a>");
        row.add("<a href='SubjectFileAction.jsp?cmd=list&_academy_="+user.getDeptId()+"&_subjectcode_="+v.getSubjectName()+"'>点击进入</a>");
        row.add("<a href='SubjectFileAction.jsp?cmd=create&_subjectcode_="+v.getSubjectName()+"&_academy_="+user.getDeptId()+"'>点击上传</a>");
        rows.add(row);
    }
    return rows;
}
