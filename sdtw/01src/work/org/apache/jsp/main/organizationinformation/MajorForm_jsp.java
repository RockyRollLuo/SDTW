 ...
 * Generated at: 2017-04-10 06:00:59 UTC
...
public final class MajorForm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List AcademyNameoptions = (List)request.getAttribute("AcademyNameoptions");
      ...
      out.write("\t\t\t\t<div class=\"browsetitle001\">专业表</div>\r\n");
      out.write("\t\t\t\t<div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("专业表") );
      out.write("</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"browsetitleright\">\r\n");
      out.write("\t\t\t\t<div class=\"anniulist2\">\r\n");
      out.write("\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"MajorAction.jsp?cmd=list&page=");
      out.print(currpage);
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"Name\" id=\"Name\" size=\"45\" maxsize=\"45\" value=\"");
      out.print(v.getName());
      out.write("\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
      ...
      out.write("\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">编码</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"Code\" id=\"Code\" size=\"45\" maxsize=\"45\" value=\"");
      out.print(v.getCode());
      out.write("\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
