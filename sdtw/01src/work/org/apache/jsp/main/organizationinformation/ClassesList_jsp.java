 ...
 * Generated at: 2017-04-12 01:22:10 UTC
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo == null){
      ...
      out.print(HeadConst.apache_url );
      out.write("/servlet/attach?type=downclasses\");\r\n");
      out.write("\t            \t\t}\r\n");
      out.write("\t            \t});\r\n");
      out.write("\t            }\r\n");
      ...
      out.write("              (\r\n");
      out.write("                  {\r\n");
      out.write("                      url:'ClassesAction.jsp?cmd=upLoadFile',\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">班级</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("班级"));
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li class=\"browsetitle_lang\"><a href=\"javascript: upload();\">批量导入</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t            <li class=\"browsetitle_lang\"><a href=\"javascript:excel();\">下载模板</a></li>\r\n");
      ...
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</table>\r\n");
      out.write("\t\t<div id=\"upwindow\" class=\"easyui-window\" title=\"导入班级信息\" collapsible=\"false\" minimizable=\"false\" closed=\"true\"\r\n");
      out.write("        maximizable=\"false\" icon=\"icon-save\"  style=\"width: 350px; height: 150px; padding: 5px;\r\n");
