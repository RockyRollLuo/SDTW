 ...
 * Generated at: 2017-04-20 03:06:30 UTC
...
public final class VolunteerProjectForm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
List AcademyNameoptions = (List)request.getAttribute("AcademyNameoptions");
      ...
      out.write("\r\n");
      out.write("\t\t\t                        row.id = data.ids;//修改时以防和之前重名\r\n");
      out.write("\t\t\t\t\t                        cell.innerHTML =  '<img src=\\'../images/file1.gif\\'/> '+realname+'&nbsp;&nbsp;&nbsp;&nbsp;<img src=\\'../images/delete.gif\\' alt=\\'删除\\' title=\\'删除\\' onclick=\\'deleteUpdateFile(\"'+realname+data.ids+'\",'+data.url.substring(be+1,en)+');\\' style=\"cursor:point;\"/><tr>';\r\n");
      out.write("\t\t\t                        ");
      ...
      out.write("\t\t\t\t<div class=\"browsetitle001\">志愿竞赛</div>\r\n");
      out.write("\t\t\t\t<div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("志愿活动") );
      out.write("</div>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div class=\"browsetitleright\">\r\n");
      out.write("\t\t\t\t<div class=\"anniulist2\">\r\n");
      out.write("\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"VolunteerProjectAction.jsp?cmd=list&page=");
      out.print(currpage);
...
if(v.getAddaccount().equals(user.getId()+"")||v.getId() ==-1) {
      ...
      out.print(v.getId());
      out.write("\">\r\n");
      out.write("<input type=\"hidden\" name=\"AddFileList\" id=\"AddFileList\" />\t\r\n");
if(v.getId() ==-1){ 
      out.write("\t\r\n");
      ...
      out.write("\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"Addaccount\" size=\"45\" maxsize=\"45\" value=\"");
...
if(v.getProjectName()!=""){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t<tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">比赛名称</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td  colspan=\"5\" align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"ProjectName\" id=\"ProjectName\" size=\"25\" maxsize=\"25\" value=\"");
      out.print(v.getProjectName());
      out.write("\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td  style=\"display: none;\" align=\"right\" class=\"form_label\">添加单位</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td style=\"display: none;\" colspan=\"3\" align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.print(HtmlTool.renderSelect(AcademyNameoptions, v.getAddacademy(), "Addacademy", "",true));
      out.write("\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t<tr>\r\n");
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td style=\"display: none;\"  align=\"right\" class=\"form_label\">添加单位</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td  style=\"display: none;\" colspan=\"3\" align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.print(HtmlTool.renderSelect(AcademyNameoptions,userInfo.getDeptId()+"", "Addacademy", "",true));
      out.write("\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t<tr>\r\n");
      ...
      out.write("\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"right\" class=\"form_label\">详情介绍</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t    \t\t\t<td  colspan=\"5\" align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"Text\" id=\"Text\" cols=\"150\" rows=\"4\">");
      out.print(v.getText());
      out.write("</textarea>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
