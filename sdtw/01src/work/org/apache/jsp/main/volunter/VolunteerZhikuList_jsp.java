 ...
 * Generated at: 2017-04-20 03:26:10 UTC
...
public final class VolunteerZhikuList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo == null){
      ...
      out.write("\t\t\t        if (confirm(\"确实要拒绝通过这些学生的审核吗?\")) {\r\n");
      out.write("\t\t\t        \t//alert(className + \"Action.jsp?cmd=modifylist1&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para));\r\n");
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifyList2&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      out.write("\t\t\t        alert(\"未选择记录！\");\r\n");
      out.write("\t\t\t    }\r\n");
      ...
      out.write("\t\t\t        if (confirm(\"确实要拒绝通过这些学生的审核吗?\")) {\r\n");
      out.write("\t\t\t        \t//alert(className + \"Action.jsp?cmd=modifylist1&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para));\r\n");
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifyList3&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      out.write("\t\t\t        alert(\"未选择记录！\");\r\n");
      out.write("\t\t\t    }\r\n");
