 ...
 * Generated at: 2017-04-25 07:16:16 UTC
...
public final class VolunteerProjectParticipateList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	String projectid=ParamUtils.getParameter(request, "ProjectId", "");
      ...
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifylist&ProjectId=");
      out.print(projectid);
      ...
      out.write("\t\t\t         \r\n");
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifylist1&ProjectId=");
      out.print(projectid);
      out.write("&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      ...
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction modifyList2(className, url_para){\r\n");
      out.write("\t\t\t\tmodify1List21(className, url_para, 1);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction modify1List21(className, url_para, page)\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\t//alert( url_para);\r\n");
      out.write("\t\t\t    var chks = document.getElementsByName(\"chk1\");\r\n");
      out.write("\t\t\t    if (!url_para)\r\n");
      ...
      out.write("\t\t\t        if (confirm(\"确实要拒绝通过这些学生的审核吗?\")) {\r\n");
      out.write("\t\t\t        \t//alert(className + \"Action.jsp?cmd=modifylist1&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para));\r\n");
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifyList2&ProjectId=");
      out.print(projectid);
      out.write("&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      ...
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction modifyList3(className, url_para){\r\n");
      out.write("\t\t\t\tmodify1List31(className, url_para, 1);\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\tfunction modify1List31(className, url_para, page)\r\n");
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\t//alert( url_para);\r\n");
      out.write("\t\t\t    var chks = document.getElementsByName(\"chk1\");\r\n");
      out.write("\t\t\t    if (!url_para)\r\n");
      ...
      out.write("\t\t\t        if (confirm(\"确实要拒绝通过这些学生的审核吗?\")) {\r\n");
      out.write("\t\t\t        \t//alert(className + \"Action.jsp?cmd=modifylist1&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para));\r\n");
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifyList3&ProjectId=");
      out.print(projectid);
      out.write("&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      ...
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t    if (chkeds.length > 0) {\r\n");
      out.write("\t\t\t        if (confirm(\"只能导出团委审核通过的记录,确实要导出这些记录吗?\")) {\r\n");
      ...
      out.write("\t\t\t    \t\tlocation = className + \"Action.jsp?cmd=excel&ProjectId=");
      out.print(projectid);
      out.write("&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t    \t}\r\n");
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t</script>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t           <ul>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t    \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t          <li> <a href=\"VolunteerProjectAction.jsp?cmd=list\" >返回</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t                 ");
if((userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.CXCY))&&checkfalg!=1){ 
      ...
      out.write("  \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t          \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t          <li><a href=\"javascript:modifyList2('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para);\">通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t          \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t             <li><a href=\"javascript:modifyList3('");
      out.print(request.getAttribute("classname"));
      out.write("', url_para);\">不通过</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t          ");
} 
