 ...
 * Generated at: 2017-04-25 07:15:47 UTC
...
List xyNameoptions=(List)request.getAttribute("xyNameoptions");
	...
	List	majorNameoptions=COptionConst.getMajorNameOptions(userInfo,"", cdt1);
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">志愿者信息</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("志愿者信息"));
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
 ...
 if(userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.ZYFW)){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.print(HtmlTool.renderSelect(xyNameoptions, ParamUtils.getParameter(request,"_Sacademy_",""), "_Sacademy_", ""));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
} 
 ...
 if(userInfo.hasFunPower(Power.UserAdminPower)){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.print(HtmlTool.renderSelect(majorNameoptions, ParamUtils.getParameter(request,"_Major_",""), "_Major_", ""));
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
} 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\r\n");
      out.write("<input    name=\"_SName_\" value=\"");
      out.print(ParamUtils.getParameter(request, "_SName_", "") );
      out.write("\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input type=\"hidden\" name=\"_VolunteerfFag_\" value=\"1\">\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
