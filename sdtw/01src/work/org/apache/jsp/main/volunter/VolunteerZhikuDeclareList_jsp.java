 ...
 * Generated at: 2017-04-25 08:32:38 UTC
...
public final class VolunteerZhikuDeclareList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	String _ZhikuId_ = ParamUtils.getParameter(request,"_ZhikuId_","-1");
      ...
      out.write("\t\t\t        if (confirm(\"确实要通过该活动的审核吗?\")) {\r\n");
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifylist&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t          \r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      ...
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t    if (chkeds.length > 0) {\r\n");
      out.write("\t\t\t        if (confirm(\"确定要拒绝该活动的审核吗?\")) {\r\n");
      out.write("\t\t\t        \t//alert(className + \"Action.jsp?cmd=modifylist1&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para));\r\n");
      out.write("\t\t\t            location = className + \"Action.jsp?cmd=modifylist1&idlist=\" + chkeds.join(',') + \"&page=\" + page + ((url_para.length == 0) ? \"\" : \"&\" + url_para);\r\n");
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    } else {\r\n");
      out.write("\t\t\t        alert(\"未选择记录！\");\r\n");
      out.write("\t\t\t    }\r\n");
      ...
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t    if (chkeds.length > 0) {\r\n");
      out.write("\t\t\t        if (confirm(\"只能导出审核通过记录,确实要导出这些记录吗?\")) {\r\n");
      ...
      out.write("\t\t\t    \t\tlocation = className + \"Action.jsp?cmd=excel&_ZhikuId_=");
      out.print(_ZhikuId_);
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">山大志库报名表</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle002\">");
      out.print(XtUtil.getSpell("山大志库报名表"));
      out.write("</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<input id=\"_ZhikuId_\" name=\"_ZhikuId_\" value=\"");
      out.print(_ZhikuId_);
