 ...
 * Generated at: 2017-04-20 03:26:54 UTC
...
public final class VolunteerZhikuForm_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	BaseUserCode user=userInfo.getUserCode();
      ...
      out.write("\t\t\t\t\t<ul>\r\n");
      out.write("\t\t\t\t\t\t<li><a href=\"VolunteerZhikuAction.jsp?cmd=list&page=");
      out.print(currpage);
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"NoticeName\" id=\"NoticeName\" size=\"25\" maxsize=\"25\" value=\"");
      out.print(v.getNoticeName());
      out.write("\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
...
if(v.getNoticeName()!=""){ 
      ...
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"WdatePicker({el:'Startdate'})\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"Startdate\" size=\"0\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img onclick=\"WdatePicker({el:'Startdate'})\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tsrc=\"");
      out.print(HeadConst.apache_url);
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"Enddate\" value=\"");
      out.print(Tool.stringOfDate(v.getEnddate()));
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"WdatePicker({el:'Enddate'})\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"Enddate\" size=\"0\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img onclick=\"WdatePicker({el:'Enddate'})\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tsrc=\"");
      out.print(HeadConst.apache_url);
      out.write("/main/images/datePicker.gif\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\twidth=\"16\" height=\"22\" align=\"absmiddle\">\r\n");
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t<td align=\"left\"  bgcolor=\"#ffffff\">\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<input name=\"Startdate\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"WdatePicker({el:'Startdate'})\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tid=\"Startdate\" size=\"0\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<img onclick=\"WdatePicker({el:'Startdate'})\"\r\n");
      ...
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea name=\"NoticeInfo\" id=\"NoticeInfo\" cols=\"160\" rows=\"5\">");
      out.print(v.getNoticeInfo());
      out.write("</textarea>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t  \t\t\t\t</tr>\r\n");
      out.write("                    \t\t\t\t\t\t\t\t\t\t\t</table>\r\n");
