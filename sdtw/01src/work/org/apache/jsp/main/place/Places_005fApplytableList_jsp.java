 ...
 * Generated at: 2017-04-25 00:41:24 UTC
...
public final class Places_005fApplytableList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
UserInfo ui = Tool.getUserInfo(request); if (ui == null) out.print("blue"); else out.print(ui.getSkinId());
	...
	if(userInfo == null){
      ...
      out.write("\t\t\t        if (confirm(\"确实要通过这些场地的审核吗?\")) {\r\n");
      out.write("\t\t\t        \t\r\n");
      ...
      out.write("\t\t\t        }\r\n");
      out.write("\t\t\t    }\r\n");
      out.write("\t\t\t   alert(chkeds);\r\n");
      out.write("\t\t\t    if (chkeds.length > 0) {\r\n");
      out.write("\t\t\t        if (confirm(\"确实要拒绝通过这些场地的审核吗?\")) {\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t          <div class=\"browsetitle001\">场地申请列表</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t        \r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t          </div>\r\n");
