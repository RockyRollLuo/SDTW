 ...
 * Generated at: 2017-04-20 03:46:24 UTC
...
List sexoptions = (List)request.getAttribute("sexoptions");
	...
	List  xynameoptions=COptionConst.getAcademyNameOptions(userInfo,"",cdt);
      ...
      out.write("\t\t\t\t\t\t\treName += \"<tr id='deleteSponsor_\"+reIdtmp+\"'><td>\"+rows[rowIndex[i]][getCodeIndex('Name')]+\"</td><td>\"+rows[rowIndex[i]][getCodeIndex('CnName')]+\"</td><td>\"+rows[rowIndex[i]][getCodeIndex('DeptId')]+\"</td><td><input size='10' name='phone\"+i+\"'/></td><td><input size='10' name='zhiwu\"+i+\"' id='zhiwu\"+i+\"'/>\"+\"</td><td><img style=\\\"cursor:point;\\\" src='");
      out.print(HeadConst.apache_url);
      ...
      out.write("\t\t\t\t\t\t\t\treId += \",\"+rows[rowIndex[i]][getCodeIndex('Id')];\r\n");
      out.write("\t\t\t\t\t\t\t\treName += \"<tr id='deleteSponsor_\"+reIdtmp+\"'><td>\"+rows[rowIndex[i]][getCodeIndex('Name')]+\"</td><td>\"+rows[rowIndex[i]][getCodeIndex('CnName')]+\"<td>\"+rows[rowIndex[i]][getCodeIndex('DeptId')]+\"</td><td><input size='10' name='phone\"+i+\"'/></td><td><input size='10' name='zhiwu\"+i+\"' id='zhiwu\"+i+\"'/>\"+\"</td><td><img style=\\\"cursor:point;\\\" src='");
      out.print(HeadConst.apache_url);
      out.write("/main/images/delete.gif' onclick=javascript:deleteSponsor(\\'deleteSponsor_\"+reIdtmp+\"\\',\\'\"+reIdtmp+\"\\') alt='删除' title='删除' border=0 /></td></tr>\";\r\n");
      out.write("\t\t\t\t\t\t\t}else{\r\n");
