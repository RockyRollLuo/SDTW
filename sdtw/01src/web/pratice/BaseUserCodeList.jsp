...
List OrgNameoptions = CEditConst.getOrgCityNameOptions(userInfo);//(List)request.getAttribute("OrgNameoptions");
			...
			function selectRole(){
			   ...
			   if (chkeds.length > 0) {
					...
					for(var i =0;i<rowIndex.length;i++){
						...
						//var phone = rows[rowIndex[i]][getCodeIndex('Phone')];
						 if(Sno=='null') {
							Sno = "";
						} 
						 if(SName=='null') {
						...
						Sno = "<input id='Sno"+reIdtmp+"' name='Sno"+reIdtmp+"' value='"+Sno+"' type='hidden'/>"+Sno;
						SName = "<input id='SName"+reIdtmp+"' name='SName"+reIdtmp+"' value='"+reIdtmp+"' type='hidden'/>"+SName;
						Sex = "<input id='Sex"+reIdtmp+"' name='Sex"+reIdtmp+"' value='"+Sex+"' type='hidden'/>"+Sex;
						Academy = "<input id='Academy"+reIdtmp+"' name='Academy"+reIdtmp+"' value='"+Academy+"' type='hidden'/>"+Academy;
						Grade = "<input id='Grade"+reIdtmp+"' name='Grade"+reIdtmp+"' value='"+Grade+"' type='hidden'/>"+Grade;
						
						var IdCard = "<input id='IdCard"+reIdtmp+"' name='IdCard"+reIdtmp+"'/>";
						var Address = "<input id='Address"+reIdtmp+"' name='Address"+reIdtmp+"'/>";
						//var Duty = "<input id='Duty"+reIdtmp+"' name='Duty"+reIdtmp+"'/>";
						var Phone = "<input style='width:100%;' id='Phone"+reIdtmp+"' name='Phone"+reIdtmp+"'/>";
						var Remark = "<input id='Remark"+reIdtmp+"' name='Remark"+reIdtmp+"' value='0' type='hidden'/>本科";
						
						var dutyOptions = "<select id='Duty"+reIdtmp+"' name='Duty"+reIdtmp+"'><option value=-1></option><option value=0>队长</option><option value=1>成员</option></select>";
						...
						if(values==""){
							...
							reName += "<tr class=odd id='deleteSponsor_"+reIdtmp+"'><td style='width:10%;'>"+Sno+"</td><td style='width:10%;'>"+SName+"</td><td style='width:10%;'>"+Sex+"</td><td style='width:10%;'>"+Academy+"</td><td style='width:10%;'>"+Remark+"</td><td style='width:10%;'>"+Grade+"</td><td style='width:10%;'>"+Phone+"</td><td style='width:10%;'>"+dutyOptions+"</td><td style='width:10%;'><img style=\"cursor:point;\" src='<%=HeadConst.apache_url%>/main/images/delete.gif' onclick=javascript:deleteSponsor(\'deleteSponsor_"+reIdtmp+"\',\'"+reIdtmp+"\') alt='删除' title='删除' border=0 /></td></tr>";
						}
						else{ 
						...
						<tr>
							<td valign="top">
                               ...
                               <div class="browsetable2">
											...
											<input id="values" name="values" value="<%=values%>" type="hidden"/>
											<%=Tool.join("\n", forms)%>
