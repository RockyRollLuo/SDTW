...
<tr height="40px">
    <td>
        <a href='#' title="给系统管理员留言..." onclick="pubmsgwnd('()','','0','mymsgdiv','blog')">
...
<%-- <tr height="30">
	...
	<td><%=groupname%></td>
	<td><%=personnums%></td>
	<td><a href="addbook-grouppersonlist.jsp?teacheraccount=<%=teacheraccount%>&groupid=<%=groupid%>&groupname=<%=groupname%>">成员列表</a></td>
	<td>
	<a href="#" onclick="window.alert('系统只能为单个系统账户发送留言消息，不能按组群发。群发可以在班级列表中留言实现。');return false;">发送消息</a></td>
</tr> --%>

<tr>
	<td >用户</td>
	<td colspan="4"><a href="addbook-persondetail.jsp?personid="></a></td>
</tr>
