...
private String[] ListFields = {"CnName", "Name", "OrgId", "DeptId", "Gender"};
...
public List main(javax.servlet.http.HttpServletRequest request)
{
    ...
    {        System.out.println("AAAAAAAAAAAAA");
        ...
        String phone=ParamUtils.getParameter(request, "MobilePhone", "");
        user.setEmail(email);
...
forwardMap.put("list1", "student-info.jsp");
