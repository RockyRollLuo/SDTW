...
private String[] ListFields = { "PlaceApplycode","ApplyDate",  "ApplyTimeRange", "Applicant", "ActivityPrincipal",   "Status", "GuideUnitAgree"};
...
private List getListRows(javax.servlet.http.HttpServletRequest request, Places_Applytable pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add(xueyuanoptions.get(v.getApplicant()+""));
...
public List main(javax.servlet.http.HttpServletRequest request)
{
    ...
    if (cmd.equals("modify"))
    {
        ...
        setForm(request, form);
        return mkRtn("update", "list1", form);
    }
...
forwardMap.put("list1", "places-applyed-list.jsp");
