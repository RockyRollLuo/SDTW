...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "AcademyName", "Academyalias", "ListOrder", "AddPerson", "AddTime", "ModiPerson", "ModiTime", "Leaguecount", "AcadeMySecretary", "AcadePutySecretary", "AcaorgPerson", "Acapublicity", "AcadeMyLevel", "AcadeMyPhone", "AcadeMyPlace", "AcadeMyeMail", "YouthXyReport", "YouthXyReportTime", "YouthModifyFlag", "YouthModifyTime", "YouthSchoolYear", "YouthPeriodTime", "Flag"};
private String[] DicKeys = {"Id", "AcademyName", "Academyalias", "ListOrder", "AddPerson", "AddTime", "ModiPerson", "ModiTime", "Leaguecount", "AcadeMySecretary", "AcadePutySecretary", "AcaorgPerson", "Acapublicity", "AcadeMyLevel", "AcadeMyPhone", "AcadeMyPlace", "AcadeMyeMail", "YouthXyReport", "YouthXyReportTime", "YouthModifyFlag", "YouthModifyTime", "YouthSchoolYear", "YouthPeriodTime", "Flag"};
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"string", "学院名称", "45", "AcademyName", ""}, {"string", "别名", "45", "text", ""}, {"int", "排序", "0", "text", ""}, {"string", "添加人", "45", "text", ""}, {"string", "添加时间", "45", "text", ""}, {"string", "修改人", "45", "text", ""}, {"date", "修改时间", "0", "text", ""}, {"int", "学院名称", "0", "text", ""}, {"string", "团支部数（班级数）", "45", "text", ""}, {"string", "团委副书记", "45", "text", ""}, {"string", "组织委员", "45", "text", ""}, {"string", "宣传委员", "45", "text", ""}, {"string", "支部等级", "45", "text", ""}, {"string", "办公电话", "45", "text", ""}, {"string", "办公地点", "45", "text", ""}, {"string", "办公邮箱", "45", "text", ""}, {"string", "54青年表彰提交", "2", "YesNo", ""}, {"date", "54青年表彰学院提交时间", "0", "text", ""}, {"string", "54青年表彰修改", "2", "YesNo", ""}, {"date", "54青团表彰修改时间", "0", "text", ""}, {"string", "54青年表彰学年", "45", "text", ""}, {"string", "学院设置54青年表彰周期", "45", "text", ""}, {"string", "标识", "4", "AcademyType", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "AcademyName", "Academyalias", "ListOrder", "AddPerson", "AddTime", "ModiPerson", "ModiTime", "Leaguecount", "AcadeMySecretary", "AcadePutySecretary", "AcaorgPerson", "Acapublicity", "AcadeMyLevel", "AcadeMyPhone", "AcadeMyPlace", "AcadeMyeMail", "YouthXyReport", "YouthXyReportTime", "YouthModifyFlag", "YouthModifyTime", "YouthSchoolYear", "YouthPeriodTime", "Flag"};
private String[] ListFields = {"AcademyName", "Academyalias", "ListOrder", "AddPerson", "AddTime", "ModiPerson", "ModiTime", "Leaguecount", "AcadeMySecretary", "AcadePutySecretary", "AcaorgPerson", "Acapublicity", "AcadeMyLevel", "AcadeMyPhone", "AcadeMyPlace", "AcadeMyeMail", "YouthXyReport", "YouthXyReportTime", "YouthModifyFlag", "YouthModifyTime", "YouthSchoolYear", "YouthPeriodTime", "Flag"};
...
private List getListRows(javax.servlet.http.HttpServletRequest request, Academy pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add("" + v.getId());
        row.add((String)AcademyNamemap.get("" + v.getAcademyName()));
        ...
        row.add((String)YesNomap.get("" + v.getYouthXyReport()));
        row.add(Tool.stringOfDate(v.getYouthXyReportTime()));
        row.add((String)YesNomap.get("" + v.getYouthModifyFlag()));
        row.add(Tool.stringOfDate(v.getYouthModifyTime()));
        row.add(Tool.jsSpecialChars(v.getYouthSchoolYear()));
        row.add(Tool.jsSpecialChars(v.getYouthPeriodTime()));
        row.add((String)AcademyTypemap.get("" + v.getFlag()));
        rows.add(row);
    }
    return rows;
}
