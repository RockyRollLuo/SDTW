...
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getDeptid(), "Deptid", "")%>
                    													</td>
													  				</tr>
                    												<tr>
...
<%=HtmlTool.renderSelect(StudentRzdTypeNameoptions, "" + v.getType(), "Type", "-1")%>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">修改标志</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Checkreason" id="Checkreason" cols="40" rows="2"><%=v.getCheckreason()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
...
<input type="hidden" name="ActivityId" value="<%=v.getActivityId()%>">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">成果</td>
														    			<td align="left"  bgcolor="#ffffff">
