...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="NoticeName" id="NoticeName" size="45" maxsize="45" value="<%=v.getNoticeName()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Enddate" id="Enddate" size="0" value="<%=Tool.stringOfDateTime(v.getEnddate())%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">通知内容</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="NoticeInfo" id="NoticeInfo" cols="40" rows="2"><%=v.getNoticeInfo()%></textarea>
                    													</td>
													  				</tr>
                    											</table>
			</form>
