...
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"string", "团支部达标升级名称", "45", "text", ""}, {"string", "发布人", "45", "hidden", ""}, {"string", "简介", "500", "text", ""}, {"string", "附件", "2000", "hidden", ""}, {"date", "上传时间", "0", "hidden", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "StandardUpGradeName", "Principal", "Desc1", "Addfilelist", "Addtime"};
private String[] ListFields = {"StandardUpGradeName", "Desc1"};
