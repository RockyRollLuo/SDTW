	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">校园文化信息</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("校园文化信息") %></div>
			</div>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(ActivitykindTypeoptions, v.getActivitykindType(), "ActivitykindType", "")%>
                    													</td>
													  				</tr>
                    												<tr>
...
<%=HtmlTool.renderSelect(TotalRoundsoptions, v.getTotalRounds(), "TotalRounds", "")%>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">第一轮活动日期</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="ActivityDate1" id="ActivityDate1" size="10" maxsize="10" value="<%=v.getActivityDate1()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">第一轮活动地点</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="ActivityPlace1" id="ActivityPlace1" cols="40" rows="2"><%=v.getActivityPlace1()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">第二轮活动日期</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="ActivityDate2" id="ActivityDate2" size="10" maxsize="10" value="<%=v.getActivityDate2()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">第二轮活动地点</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="ActivityPlace2" id="ActivityPlace2" cols="40" rows="2"><%=v.getActivityPlace2()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">第三轮活动日期</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="ActivityDate3" id="ActivityDate3" size="10" maxsize="10" value="<%=v.getActivityDate3()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">第三轮活动地点</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="ActivityPlace3" id="ActivityPlace3" cols="40" rows="2"><%=v.getActivityPlace3()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">报名截止日期</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Deadline" id="Deadline" size="10" maxsize="10" value="<%=v.getDeadline()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">所需人数</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="PersonNumber" id="PersonNumber" size="10" maxsize="10" value="<%=v.getPersonNumber()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">负责人</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="ActivityPrincipal" id="ActivityPrincipal" size="50" maxsize="50" value="<%=v.getActivityPrincipal()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">联系方式</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Contact" id="Contact" size="20" maxsize="20" value="<%=v.getContact()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">参与校区</td>
														    			<td align="left"  bgcolor="#ffffff">
...
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getAcademy(), "Academy", "")%>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Addperson" id="Addperson" size="45" maxsize="45" value="<%=v.getAddperson()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="ModifyPerson" id="ModifyPerson" size="45" maxsize="45" value="<%=v.getModifyPerson()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">荣誉</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Honor" id="Honor" cols="40" rows="2"><%=v.getHonor()%></textarea>
                    													</td>
													  				</tr>
                    											</table>
			</form>
