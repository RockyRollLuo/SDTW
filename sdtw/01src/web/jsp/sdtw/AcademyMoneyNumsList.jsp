                               ...
                               <div class="browsetable2">
											...
											<table border=0 cellspacing=3 cellpadding=5 width="100%">
												<tr>
													...
													<td>
														<div align="right">经费</div>
													</td>
													<td>
														<input name="_Money_" value="<%=ParamUtils.getParameter(request, "_Money_", "")%>">
													</td>
													<td>
														<div align="right">方式</div>
													</td>
													<td>
														<input name="_Type_" value="<%=ParamUtils.getParameter(request, "_Type_", "")%>">
													</td>
												</tr>
											</table>
                               </div>
