                               ...
                               <div class="browsetable2">
											...
											<table border=0 cellspacing=3 cellpadding=5 width="100%">
												<tr>
													...
													<td>
														<input name="_SendDate_" value="<%=ParamUtils.getParameter(request, "_SendDate_", "")%>">
													</td>
													<td>
...
<%=HtmlTool.renderSelect(YesNooptions, ParamUtils.getParameter(request,"_Receipt_",""), "_Receipt_", "")%>
												...
												<tr>
													<td>
														<div align="right">短消息收藏时间</div>
													</td>
													<td>
														<input name="_CollectDate_" value="<%=ParamUtils.getParameter(request, "_CollectDate_", "")%>">
													</td>
													<td>
														<div align="right">短消息保存时间</div>
													</td>
													<td>
														<input name="_SaveDate_" value="<%=ParamUtils.getParameter(request, "_SaveDate_", "")%>">
													</td>
													<td>
														<div align="right">短消息级别</div>
													</td>
													<td>
<%=HtmlTool.renderSelect(MsgPropoptions, ParamUtils.getParameter(request,"_SmsStyle_",""), "_SmsStyle_", "")%>
													</td>
												</tr>
												<tr>
													<td>
