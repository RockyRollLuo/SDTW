...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">团校培训管理id</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="ProjectId" id="ProjectId" value="<%=v.getProjectId()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">作业</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="HomeWork" id="HomeWork" cols="40" rows="2"><%=v.getHomeWork()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">作业附件</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="WorkFileList" id="WorkFileList" cols="40" rows="2"><%=v.getWorkFileList()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
...
<input type="hidden" name="Audit" value="<%=v.getAudit()%>">
                    											</table>
			</form>
		</div>
	</body>
