...
<%
	Log log = LogFactory.getLog(ChuangkuDeclareMembers.class);
	...
	ChuangkuDeclareMembers v = (ChuangkuDeclareMembers)request.getAttribute("fromBean");
	if (v == null) {
...
List ChuangKuDutyNameoptions = (List)request.getAttribute("ChuangKuDutyNameoptions");
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">山大创库创业团队人员名称</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("山大创库创业团队人员名称") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="ChuangkuDeclareMembersAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="ChuangkuDeclareId" value="<%=v.getChuangkuDeclareId()%>">
                    												<tr>
...
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getAcademy(), "Academy", "")%>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(ChuangKuDutyNameoptions, v.getDuty(), "Duty", "")%>
                    													</td>
													  				</tr>
                    											</table>
			</form>
