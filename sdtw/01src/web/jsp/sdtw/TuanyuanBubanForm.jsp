...
<%
	Log log = LogFactory.getLog(TuanyuanBuban.class);
	...
	TuanyuanBuban v = (TuanyuanBuban)request.getAttribute("fromBean");
	if (v == null) {
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">团员补办</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("团员补办") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="TuanyuanBubanAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="Applytime" value="<%=v.getApplytime()%>">
<input type="hidden" name="ReapplyNum" value="<%=v.getReapplyNum()%>">
<input type="hidden" name="AppliedTime" value="<%=v.getAppliedTime()%>">
<input type="hidden" name="Flag" value="<%=v.getFlag()%>">
                    											</table>
			</form>
		</div>
	</body>
