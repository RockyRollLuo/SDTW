	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">志愿活动报名表-学生素质拓展培养认证单-志愿活动</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("志愿活动报名表-学生素质拓展培养认证单-志愿活动") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="VolunteerParticipateAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												<tr>
                    													<td align="right" class="form_label">志愿活动id</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(VolunActivityNameoptions, "" + v.getActivityId(), "ActivityId", "-1")%>
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="HonourName" id="HonourName" size="45" maxsize="45" value="<%=v.getHonourName()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(EvaluationTypeoptions, v.getEvaluation(), "Evaluation", "")%>
                    													</td>
													  				</tr>
                    												<tr>
