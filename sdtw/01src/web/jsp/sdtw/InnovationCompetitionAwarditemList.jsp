							...
							<td valign="top">
                               ...
                               <div class="browsetable2">
											...
											<table border=0 cellspacing=3 cellpadding=5 width="100%">
												<tr>
													<td>
														<div align="right">奖项名称</div>
													</td>
													<td>
														<input name="_Itemname_" value="<%=ParamUtils.getParameter(request, "_Itemname_", "")%>">
													</td>
													<td>
														<div align="right">修改人</div>
													</td>
													<td>
														<input name="_Modiperson_" value="<%=ParamUtils.getParameter(request, "_Modiperson_", "")%>">
													</td>
													<td colspan="2">&nbsp;</td>
												</tr>
											</table>
