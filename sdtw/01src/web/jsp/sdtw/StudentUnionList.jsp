                               ...
                               <div class="browsetable2">
											...
											<table border=0 cellspacing=3 cellpadding=5 width="100%">
												<tr>
													...
													<td>
<%=HtmlTool.renderSelect(UnionTypeoptions, ParamUtils.getParameter(request,"_Uniontype_",""), "_Uniontype_", "")%>
													</td>
													<td>
														<div align="right">附件</div>
													</td>
													<td>
														<input name="_Unionprofile_" value="<%=ParamUtils.getParameter(request, "_Unionprofile_", "")%>">
													</td>
													<td colspan="2">&nbsp;</td>
												</tr>
											</table>
