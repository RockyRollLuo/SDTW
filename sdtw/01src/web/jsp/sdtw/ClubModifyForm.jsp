...
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getClubAcadeMyNew(), "ClubAcadeMyNew", "")%>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">变更类别</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(ClubModifyTypeoptions, v.getModifyType(), "ModifyType", "")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">变更原因</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="ModifyReason" id="ModifyReason" size="45" maxsize="45" value="<%=v.getModifyReason()%>">
                    													</td>
													  				</tr>
                    												<tr>
