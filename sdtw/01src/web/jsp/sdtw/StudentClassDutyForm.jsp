...
<%
	Log log = LogFactory.getLog(StudentClassDuty.class);
	...
	StudentClassDuty v = (StudentClassDuty)request.getAttribute("fromBean");
	if (v == null) {
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">班级委员具体任职情况-学生素质拓展培养认证单-社会工作</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("班级委员具体任职情况-学生素质拓展培养认证单-社会工作") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="StudentClassDutyAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<%=HtmlTool.renderSelect(StuDutyoptions, v.getDuty(), "Duty", "")%>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">班级</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(ClassesNameoptions, v.getClassname(), "Classname", "")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">担任学年</td>
														    			<td align="left"  bgcolor="#ffffff">
