...
<%
	Log log = LogFactory.getLog(TrainingCheck.class);
	...
	TrainingCheck v = (TrainingCheck)request.getAttribute("fromBean");
	if (v == null) {
		...
		<div class="browsetitle">
			...
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="TrainingCheckAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Sno" id="Sno" cols="40" rows="2"><%=v.getSno()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">姓名</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Sname" id="Sname" cols="40" rows="2"><%=v.getSname()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">团校培训报名id</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="FolderId" id="FolderId" value="<%=v.getFolderId()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">作业附件</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="CheckFile" id="CheckFile" cols="40" rows="2"><%=v.getCheckFile()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="CheckReport" id="CheckReport" cols="40" rows="2"><%=v.getCheckReport()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
