	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">学生会</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("学生会") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="StudentUnionAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												<tr>
                    													<td align="right" class="form_label">用户类型</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(UnionTypeoptions, "" + v.getUniontype(), "Uniontype", "-1")%>
                    													</td>
													  				</tr>
                    												<tr>
...
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getAcademy(), "Academy", "")%>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Unionprofile" id="Unionprofile" cols="40" rows="2"><%=v.getUnionprofile()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
