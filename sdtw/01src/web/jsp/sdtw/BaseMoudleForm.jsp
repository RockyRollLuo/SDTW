	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">模块</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("模块") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="BaseMoudleAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												<tr>
                    													<td align="right" class="form_label">上级模块</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(MoudleNameoptions, "" + v.getPid(), "Pid", "-1")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">模块名称</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Name" id="Name" cols="40" rows="2"><%=v.getName()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">编码</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Code" id="Code" cols="40" rows="2"><%=v.getCode()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">级别</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="MoudleGrade" id="MoudleGrade" value="<%=v.getMoudleGrade()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">类型</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(MoudleOrFunoptions, "" + v.getMoudleType(), "MoudleType", "-1")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">部门模块</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(YesNooptions, "" + v.getIsDept(), "IsDept", "-1")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">连接Url</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="ToUrl" id="ToUrl" cols="40" rows="2"><%=v.getToUrl()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
