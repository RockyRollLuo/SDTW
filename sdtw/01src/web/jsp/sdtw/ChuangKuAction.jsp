...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "Ck2", "Ck1", "AddTime", "Ck3"};
private String[] DicKeys = {"Id", "Ck2", "Ck1", "AddTime", "Ck3"};
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"date", "起止日期", "0", "hidden", ""}, {"string", "通知名称", "50", "text", ""}, {"string", "添加时间", "50", "hidden", ""}, {"string", "通知内容", "200", "hidden", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "Ck2", "Ck1", "AddTime", "Ck3"};
private String[] ListFields = {"Ck1"};
...
private List getListRows(javax.servlet.http.HttpServletRequest request, ChuangKu pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add("" + v.getId());
        row.add(Tool.stringOfDate(v.getCk2()));
