...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="ProjectDetail" id="ProjectDetail" cols="40" rows="2"><%=v.getProjectDetail()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
...
<%=HtmlTool.renderSelect(UserNameoptions, v.getProjectLeader(), "ProjectLeader", "")%>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="ProjectUnit" id="ProjectUnit" size="45" maxsize="45" value="<%=v.getProjectUnit()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">开始时间</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="TimeStart" id="TimeStart" size="15" maxsize="15" value="<%=v.getTimeStart()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">结束时间</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="TimeEnd" id="TimeEnd" size="15" maxsize="15" value="<%=v.getTimeEnd()%>">
                    													</td>
													  				</tr>
                    												<tr>
