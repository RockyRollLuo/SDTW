...
<%
	Log log = LogFactory.getLog(VolunteerZhikuTeammember.class);
	...
	VolunteerZhikuTeammember v = (VolunteerZhikuTeammember)request.getAttribute("fromBean");
	if (v == null) {
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">山大志库申请表团队成员表</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("山大志库申请表团队成员表") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="VolunteerZhikuTeammemberAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="ZhikuDeclareId" value="<%=v.getZhikuDeclareId()%>">
                    												<tr>
...
<%=HtmlTool.renderSelect(GradeNameoptions, v.getGrade(), "Grade", "")%>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">团队分工</td>
														    			<td align="left"  bgcolor="#ffffff">
