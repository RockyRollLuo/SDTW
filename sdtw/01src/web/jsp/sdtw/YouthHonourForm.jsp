	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				...
				<div class="browsetitle002"><%=XtUtil.getSpell("五四评比表彰申请表") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="YouthHonourAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getBelongAcademy(), "BelongAcademy", "")%>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Attachids" id="Attachids" size="45" maxsize="45" value="<%=v.getAttachids()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">va21</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val21" id="Val21" size="45" maxsize="45" value="<%=v.getVal21()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">va22</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val22" id="Val22" size="45" maxsize="45" value="<%=v.getVal22()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">text5</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text5" id="Text5" cols="40" rows="2"><%=v.getText5()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">text6</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text6" id="Text6" cols="40" rows="2"><%=v.getText6()%></textarea>
                    													</td>
													  				</tr>
                    											</table>
			</form>
