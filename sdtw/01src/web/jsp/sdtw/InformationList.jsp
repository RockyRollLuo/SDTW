                               ...
                               <div class="browsetable2">
											...
											<table border=0 cellspacing=3 cellpadding=5 width="100%">
												<tr>
													...
													<td>
														<div align="right">图片信息</div>
													</td>
													<td>
														<input name="_ImageInfo_" value="<%=ParamUtils.getParameter(request, "_ImageInfo_", "")%>">
													</td>
													<td>
														<div align="right">创建时间</div>
													</td>
													<td>
														<input name="_NewDate_" value="<%=ParamUtils.getParameter(request, "_NewDate_", "")%>">
													</td>
												</tr>
												<tr>
													<td>
													...
													<td>
<%=HtmlTool.renderSelect(UserNameoptions, ParamUtils.getParameter(request,"_UserId_",""), "_UserId_", "")%>
													</td>
													<td>
														<div align="right">是否推荐</div>
													</td>
													<td>
<%=HtmlTool.renderSelect(YesNooptions, ParamUtils.getParameter(request,"_IsRecommond_",""), "_IsRecommond_", "")%>
													</td>
													<td>
														<div align="right">是否焦点</div>
													</td>
													<td>
<%=HtmlTool.renderSelect(YesNooptions, ParamUtils.getParameter(request,"_IsFocus_",""), "_IsFocus_", "")%>
													</td>
												</tr>
											</table>
                               </div>
