	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				...
				<div class="browsetitle002"><%=XtUtil.getSpell("学院表") %></div>
			</div>
...
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getAcademyName(), "AcademyName", "")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">别名</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Academyalias" id="Academyalias" size="45" maxsize="45" value="<%=v.getAcademyalias()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">学院名称</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Leaguecount" id="Leaguecount" value="<%=v.getLeaguecount()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">团支部数（班级数）</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="AcadeMySecretary" id="AcadeMySecretary" size="45" maxsize="45" value="<%=v.getAcadeMySecretary()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">团委副书记</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="AcadePutySecretary" id="AcadePutySecretary" size="45" maxsize="45" value="<%=v.getAcadePutySecretary()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">组织委员</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="AcaorgPerson" id="AcaorgPerson" size="45" maxsize="45" value="<%=v.getAcaorgPerson()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">宣传委员</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Acapublicity" id="Acapublicity" size="45" maxsize="45" value="<%=v.getAcapublicity()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">支部等级</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="AcadeMyLevel" id="AcadeMyLevel" size="45" maxsize="45" value="<%=v.getAcadeMyLevel()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">办公电话</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="AcadeMyPhone" id="AcadeMyPhone" size="45" maxsize="45" value="<%=v.getAcadeMyPhone()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">办公地点</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="AcadeMyPlace" id="AcadeMyPlace" size="45" maxsize="45" value="<%=v.getAcadeMyPlace()%>">
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">办公邮箱</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="AcadeMyeMail" id="AcadeMyeMail" size="45" maxsize="45" value="<%=v.getAcadeMyeMail()%>">
                    													</td>
													  				</tr>
                    												<tr>
...
<%=HtmlTool.renderSelect(YesNooptions, v.getYouthXyReport(), "YouthXyReport", "")%>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">54青年表彰修改</td>
														    			<td align="left"  bgcolor="#ffffff">
