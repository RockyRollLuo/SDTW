...
<input type="hidden" name="Ck2" value="<%=v.getCk2()%>">
                    												<tr>
                    													<td align="right" class="form_label">通知名称</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Ck1" id="Ck1" size="50" maxsize="50" value="<%=v.getCk1()%>">
                    													</td>
													  				</tr>
<input type="hidden" name="AddTime" value="<%=v.getAddTime()%>">
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Ck3" id="Ck3" cols="40" rows="2"><%=v.getCk3()%></textarea>
                    													</td>
													  				</tr>
                    											</table>
			</form>
