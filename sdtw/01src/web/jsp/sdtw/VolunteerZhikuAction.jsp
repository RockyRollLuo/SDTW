...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "NoticeName", "Startdate", "Enddate", "NoticeInfo"};
private String[] DicKeys = {"Id", "NoticeName", "Startdate", "Enddate", "NoticeInfo"};
private String[][] DicValues = {{"int", "id", "0", "hidden", ""}, {"string", "通知名称", "45", "text", ""}, {"date", "开始日期", "0", "text", ""}, {"date", "结束日期", "0", "text", ""}, {"string", "通知内容", "2000", "hidden", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "NoticeName", "Startdate", "Enddate", "NoticeInfo"};
private String[] ListFields = {"NoticeName", "Startdate", "Enddate"};
