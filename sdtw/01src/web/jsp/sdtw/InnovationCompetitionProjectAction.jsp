...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "ProjectName", "ProjectId", "TimeStart", "TimeEnd", "ProjectLeader", "LeaderPhone", "ProjectUnit", "ProjectDetail", "Remark", "AddFilelist", "AddTime", "AddPerson", "ModiTime", "ModiPerson"};
private String[] DicKeys = {"Id", "ProjectName", "ProjectId", "TimeStart", "TimeEnd", "ProjectLeader", "LeaderPhone", "ProjectUnit", "ProjectDetail", "Remark", "AddFilelist", "AddTime", "AddPerson", "ModiTime", "ModiPerson"};
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"string", "项目名称", "45", "ProductionName", ""}, {"string", "项目编码", "45", "text", ""}, {"string", "启动时间", "45", "hidden", ""}, {"string", "结束时间", "45", "hidden", ""}, {"string", "项目负责人", "45", "text", ""}, {"string", "负责人电话", "45", "text", ""}, {"string", "立项单位", "45", "text", ""}, {"string", "项目详情", "500", "hidden", ""}, {"string", "备注", "500", "hidden", ""}, {"string", "添加文件列表", "200", "hidden", ""}, {"date", "项目添加时间", "0", "hidden", ""}, {"string", "项目添加人", "45", "hidden", ""}, {"date", "修改时间", "0", "hidden", ""}, {"string", "修改人", "45", "hidden", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "ProjectName", "ProjectId", "TimeStart", "TimeEnd", "ProjectLeader", "LeaderPhone", "ProjectUnit", "ProjectDetail", "Remark", "AddFilelist", "AddTime", "AddPerson", "ModiTime", "ModiPerson"};
private String[] ListFields = {"ProjectName", "ProjectId", "ProjectLeader", "LeaderPhone", "ProjectUnit"};
...
private List getListRows(javax.servlet.http.HttpServletRequest request, InnovationCompetitionProject pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add("" + v.getId());
        row.add((String)ProductionNamemap.get("" + v.getProjectName()));
