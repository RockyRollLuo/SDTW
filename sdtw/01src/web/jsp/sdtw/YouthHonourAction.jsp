...
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"int", "通知id", "0", "hidden", ""}, {"string", "学年", "45", "text", ""}, {"int", "Id", "0", "hidden", ""}, {"string", "添加账号", "45", "hidden", ""}, {"date", "添加时间", "0", "hidden", ""}, {"int", "学院审核标志", "0", "text", ""}, {"int", "团委审核标志", "0", "text", ""}, {"int", "是否可修改标志", "0", "text", ""}, {"int", "学院提交标志", "0", "text", ""}, {"int", "团委发布标志", "0", "text", ""}, {"date", "学院审核时间", "0", "hidden", ""}, {"date", "团委审核时间", "0", "hidden", ""}, {"string", "所属单位", "45", "text", ""}, {"string", "附件", "45", "text", ""}, {"string", "va1", "45", "hidden", ""}, {"string", "va2", "45", "hidden", ""}, {"string", "va3", "45", "hidden", ""}, {"string", "va4", "45", "hidden", ""}, {"string", "va5", "45", "hidden", ""}, {"string", "va6", "45", "hidden", ""}, {"string", "va7", "45", "hidden", ""}, {"string", "va8", "45", "hidden", ""}, {"string", "va9", "45", "hidden", ""}, {"string", "va10", "45", "hidden", ""}, {"string", "va11", "45", "hidden", ""}, {"string", "va12", "45", "hidden", ""}, {"string", "va13", "45", "hidden", ""}, {"string", "va14", "45", "hidden", ""}, {"string", "va15", "45", "hidden", ""}, {"string", "va16", "45", "hidden", ""}, {"string", "va17", "45", "hidden", ""}, {"string", "va21", "45", "hidden", ""}, {"string", "va18", "45", "hidden", ""}, {"string", "va19", "45", "hidden", ""}, {"string", "va20", "45", "hidden", ""}, {"string", "va22", "45", "hidden", ""}, {"string", "text1", "500", "hidden", ""}, {"string", "text2", "500", "hidden", ""}, {"string", "text3", "500", "hidden", ""}, {"string", "text4", "500", "hidden", ""}, {"string", "text5", "500", "hidden", ""}, {"string", "text6", "500", "hidden", ""}};
...
forwardMap.put("failure", "YouthHonourForm.jsp");
forwardMap.put("success", "YouthHonourList.jsp");
forwardMap.put("excel", "/upload/temp/" + userInfo.getName() + ".xls");
forwardMap.put("input", "YouthHonourForm.jsp");
...
if (forwardKey.equals("list")) {
    ...
    out.println("<script>window.location='YouthHonourAction.jsp?cmd=list&page=" + currpage + ((url.length() == 0) ? "" : "&" + url) + "';</script>");
}
else {
