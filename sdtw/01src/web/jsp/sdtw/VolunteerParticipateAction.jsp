...
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"int", "志愿活动id", "0", "VolunActivityName", ""}, {"string", "学生学号", "20", "text", ""}, {"string", "荣誉名称", "45", "text", ""}, {"int", "审核标志", "0", "text", ""}, {"string", "评价等级", "20", "EvaluationType", ""}, {"int", "服务时长", "0", "text", ""}, {"date", "申请时间", "0", "hidden", ""}, {"string", "上传文件列表", "500", "hidden", ""}};
