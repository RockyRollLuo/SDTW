...
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"int", "校级院级学生会id", "0", "text", ""}, {"int", "部门学生会id", "0", "StuDeptName", ""}, {"string", "院级或部门级学生会", "45", "text", ""}, {"string", "账号", "45", "text", ""}, {"string", "校区", "45", "OrgName", ""}, {"string", "主要部门", "45", "StuDeptName", ""}, {"string", "手机", "45", "text", ""}, {"string", "职位", "45", "StuDuty", ""}, {"string", "备注", "45", "text", ""}, {"string", "学年", "45", "text", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "Unionid", "Deptid", "UnionorDept", "SNo", "Campus", "ChargeDept", "Phone", "Duty", "Remark", "SchoolYear"};
private String[] ListFields = {"Unionid", "Deptid", "UnionorDept", "SNo", "Campus", "ChargeDept", "Phone", "Duty", "Remark", "SchoolYear"};
...
private List getListRows(javax.servlet.http.HttpServletRequest request, StudentUnionMember pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add((String)StuDeptNamemap.get("" + v.getChargeDept()));
