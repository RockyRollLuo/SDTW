		...
		<div class="browsetitle">
			...
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="VolunteerZhikuDeclareAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												<tr>
                    													<td align="right" class="form_label">志库通知的id</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(NoticeNameoptions, "" + v.getZhikuId(), "ZhikuId", "-1")%>
                    													</td>
													  				</tr>
...
<input type="hidden" name="Addfilelist" value="<%=v.getAddfilelist()%>">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">学院</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getUnit(), "Unit", "")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">项目分组</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(ZkProjectTypeoptions, v.getType(), "Type", "")%>
                    													</td>
													  				</tr>
                    												<tr>
