...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "SubjectCode", "SubjectName", "Principal", "Institution", "AddFileList", "AddAccount", "AddTime", "CheckAccount", "CheckTime", "CheckFlag", "Contact"};
private String[] DicKeys = {"Id", "SubjectCode", "SubjectName", "Principal", "Institution", "AddFileList", "AddAccount", "AddTime", "CheckAccount", "CheckTime", "CheckFlag", "Contact"};
private String[][] DicValues = {{"int", "id", "0", "hidden", ""}, {"string", "课题编码", "45", "text", ""}, {"string", "课题名称", "100", "text", ""}, {"string", "发布人", "45", "text", ""}, {"string", "发布单位", "50", "text", ""}, {"string", "附件", "45", "hidden", ""}, {"string", "添加账号", "45", "hidden", ""}, {"date", "添加时间", "0", "hidden", ""}, {"string", "审核账号", "45", "hidden", ""}, {"date", "审核时间", "0", "hidden", ""}, {"int", "审核状态", "0", "hidden", ""}, {"string", "联系方式", "45", "text", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "SubjectCode", "SubjectName", "Principal", "Institution", "AddFileList", "AddAccount", "AddTime", "CheckAccount", "CheckTime", "CheckFlag", "Contact"};
private String[] ListFields = {"SubjectCode", "SubjectName", "Principal", "Institution", "Contact"};
