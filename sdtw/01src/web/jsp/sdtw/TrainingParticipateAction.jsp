...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "Sno", "Sname", "ProjectId", "HomeWork", "WorkFileList", "CheckFileEstimate", "DateRate", "CheckReport", "AddFileList", "CheckReportEstimate", "CheckId", "Audit"};
private String[] DicKeys = {"Id", "Sno", "Sname", "ProjectId", "HomeWork", "WorkFileList", "CheckFileEstimate", "DateRate", "CheckReport", "AddFileList", "CheckReportEstimate", "CheckId", "Audit"};
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"string", "学号", "2000", "text", ""}, {"string", "姓名", "2000", "text", ""}, {"int", "团校培训管理id", "0", "text", ""}, {"string", "作业", "2000", "text", ""}, {"string", "作业附件", "2000", "text", ""}, {"string", "作业评价", "2000", "hidden", ""}, {"string", "考勤", "45", "text", ""}, {"string", "结题报告", "2000", "text", ""}, {"string", "结题附件", "2000", "text", ""}, {"string", "结题报告评价", "2000", "hidden", ""}, {"int", "checkId", "0", "hidden", ""}, {"int", "Audit", "0", "hidden", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "Sno", "Sname", "ProjectId", "HomeWork", "WorkFileList", "CheckFileEstimate", "DateRate", "CheckReport", "AddFileList", "CheckReportEstimate", "CheckId", "Audit"};
private String[] ListFields = {"Sno", "Sname", "ProjectId", "HomeWork", "WorkFileList", "DateRate", "CheckReport", "AddFileList"};
