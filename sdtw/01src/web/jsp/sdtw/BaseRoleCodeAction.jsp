...
private String[] ListFields = {"Name", "Code", "FunIds", "FunCodes", "MoudleIds", "MoudleCode", "IsEnable"};
...
private void setList(javax.servlet.http.HttpServletRequest request, boolean isAll)
{
    ...
    request.setAttribute("classname", "BaseRoleCode");
...
forwardMap.put("list", "BaseRoleCodeAction.jsp");
forwardMap.put("failure", "BaseRoleCodeForm.jsp");
forwardMap.put("success", "BaseRoleCodeList.jsp");
forwardMap.put("excel", "/upload/temp/" + userInfo.getName() + ".xls");
forwardMap.put("input", "BaseRoleCodeForm.jsp");
...
if (forwardKey.equals("list")) {
    ...
    out.println("<script>window.location='BaseRoleCodeAction.jsp?cmd=list&page=" + currpage + ((url.length() == 0) ? "" : "&" + url) + "';</script>");
}
else {
