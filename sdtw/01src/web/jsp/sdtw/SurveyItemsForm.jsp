...
<%
	Log log = LogFactory.getLog(SurveyItems.class);
	...
	SurveyItems v = (SurveyItems)request.getAttribute("fromBean");
	if (v == null) {
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">调查问卷items</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("调查问卷items") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="SurveyItemsAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												<tr>
                    													<td align="right" class="form_label">问卷吃哦de</td>
...
<font color=red>*</font>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Item_Title" id="Item_Title" size="45" maxsize="45" value="<%=v.getItem_Title()%>">
                    													</td>
													  				</tr>
                    												<tr>
...
<font color=red>*</font>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">选项</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Item_SelectList" id="Item_SelectList" cols="40" rows="2"><%=v.getItem_SelectList()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
