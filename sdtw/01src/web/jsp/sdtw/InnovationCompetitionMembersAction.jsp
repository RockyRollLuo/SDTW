...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "ProductionId", "Sno", "Name", "Tel", "Academy", "Duty", "Column_8"};
private String[] DicKeys = {"Id", "ProductionId", "Sno", "Name", "Tel", "Academy", "Duty", "Column_8"};
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"int", "创业竞赛比赛参与作品表id", "0", "InnovationProductionName", ""}, {"string", "学号", "45", "text", ""}, {"string", "姓名", "45", "text", ""}, {"string", "联系方式", "45", "text", ""}, {"string", "学院", "45", "AcademyName", ""}, {"string", "职责", "45", "text", ""}, {"string", "Column_8", "0", "text", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "ProductionId", "Sno", "Name", "Tel", "Academy", "Duty", "Column_8"};
private String[] ListFields = {"ProductionId", "Sno", "Name", "Tel", "Academy", "Duty", "Column_8"};
private String[] FormFields = {"ProductionId", "Sno", "Name", "Tel", "Academy", "Duty", "Column_8"};
...
private InnovationCompetitionMembers getByParameterDb(javax.servlet.http.HttpServletRequest request)
{
    ...
    if (cmd.equals("update")) {
        ...
        v.paramColumn_8(request, "Column_8");
    }
    else {
        v.setId(ParamUtils.getIntParameter(request, "Id", -1));
        ...
        v.setColumn_8(ParamUtils.getParameter(request, "Column_8", ""));
    }
    return v;
}
private List getListRows(javax.servlet.http.HttpServletRequest request, InnovationCompetitionMembers pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add(Tool.jsSpecialChars(v.getColumn_8()));
        rows.add(row);
    }
    return rows;
}
