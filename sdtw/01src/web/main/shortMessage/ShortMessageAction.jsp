...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "SendDate", "Subject", "MsgGrade", "SendId", "ReceiveIds", "IfSee", "Receipt", "CollectDate", "SaveDate", "SmsStyle", "AttachIds", "RemUrl", "RemindSys", "IsEnable", "RemindType"};
...
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"date", "短消息发送时间", "0", "text", ""}, {"string", "短消息标题", "500", "text", ""}, {"int", "短消息级别", "0", "MsgGrade", ""}, {"int", "发送人", "0", "UserName", ""}, {"string", "接受人", "500", "text", ""}, {"int", "是否查看", "0", "YesNo", ""}, {"int", "是否回执", "0", "YesNo", ""}, {"date", "短消息收藏时间", "0", "text", ""}, {"date", "短消息保存时间", "0", "text", ""}, {"int", "短消息级别", "0", "MsgProp", ""}, {"string", "相关附件ids", "200", "text", ""}, {"string", "跳转地址", "200", "text", ""}, {"string", "RemindSys", "20", "RemindSys", ""}, {"int", "是否可用", "0", "YesNo", ""}, {"string", "提醒方式", "20", "hidden", ""}};
...
private String[] ListFields = {"SendDate", "Subject", "MsgGrade", "SendId", "ReceiveIds", "IfSee", "Receipt", "CollectDate", "SaveDate", "SmsStyle", "AttachIds", "RemUrl", "RemindSys", "IsEnable"};
...
private String[] shoujianListFields = {"Subject","SendDate", "SendId", "MsgGrade"};
...
private String[] QueryFields = {"SendDate", "Subject", "MsgGrade", "SendId", "IfSee", "Receipt", "CollectDate", "SaveDate", "SmsStyle", "RemUrl", "RemindSys"};
...
private void setList(javax.servlet.http.HttpServletRequest request, boolean isAll)
{
    ...
    String shoujian= ParamUtils.getParameter(request, "_shoujian_","2");
...
forwardMap.put("list", "ShortMessageAction.jsp");
forwardMap.put("list1", "ShortMessageAction.jsp");
...
if (forwardKey.equals("list")) {
    ...
    out.println("<script>window.location='ShortMessageAction.jsp?cmd=list&page=" + currpage + ((url.length() == 0) ? "" : "&" + url) + "';</script>");
}
else {
    pageContext.forward((String)forwardMap.get(forwardKey) + "?_shoujian_="+shoujian+"&cmd=" + cmd + "&page=" + currpage);
}
%>
