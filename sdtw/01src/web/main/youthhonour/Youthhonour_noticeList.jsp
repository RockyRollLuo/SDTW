...
%>
  ...
  /*  if(showEdit == "1"){
    ...
    str = str + "<td bgcolor=\"#3992d0\" nowrap><div class=\"browsetable004\">申请表</div></td><td bgcolor=\"#3992d0\" nowrap><div class=\"browsetable004\">汇总表</div></td></tr>\n";
    if (rows.length == 0) {
        ...
        for (i = 0; i < rows.length; i ++) {
            ...
            str = str + "<td><a href=\"YouthhonourAllList.jsp?noticeid="+rows[i][keyindex]+"\">查看</a></td><td><a href=\"Youthhonour-summary.jsp?noticeid="+rows[i][keyindex]+"\">查看</a></td></tr>\n";
        }
    }
    str = str + '</table>';
