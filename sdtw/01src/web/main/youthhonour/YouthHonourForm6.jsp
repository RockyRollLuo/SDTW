...
%>
	...
	<body onload="init();">
		...
		<div id="tabs">
			<ul>
				<li><a href="#tabs-1">宣传工作</a></li>
				<li><a href="#tabs-2">调查研究工作</a></li>
				<li><a href="#tabs-3">新媒体工作</a></li>
				<li><a href="#tabs-4">相关支撑材料</a></li>
			</ul>
...
<input type="hidden" name="Text1" id="Text1" value="<%=v.getText1()%>"/>
<input type="hidden" name="Text2" id="Text2" value="<%=v.getText2()%>"/>
...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>	
                    											...
                    											<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
													  				...
													  				<tr><td align="left"  bgcolor="#ffffff" colspan="2">请注明发稿量，省级媒体以上的新闻报道请注明文章链接地址</td></tr>
                    												<tr>
                    													<td align="right" class="form_label">全年发稿量</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val2" id="Val2" size="45" maxsize="45" value="<%=v.getVal2()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">国家发稿量</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val3" id="Val3" size="45" maxsize="45" value="<%=v.getVal3()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">省级媒体</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val4" id="Val4" size="45" maxsize="45" value="<%=v.getVal4()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">山大视点</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val5" id="Val5" size="45" maxsize="45" value="<%=v.getVal5()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">青春山大</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val6" id="Val6" size="45" maxsize="45" value="<%=v.getVal6()%>"/>
                    													</td>
													  				</tr>
													  				<tr>
                    													<td align="right" class="form_label">学生在线</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr><td align="left"  bgcolor="#ffffff" colspan="2">请注明立项数量，是否结题，课程名称</td></tr>
                    												<tr>
                    													<td align="right" class="form_label">团中央立项</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val8" id="Val8" size="45" maxsize="45" value="<%=v.getVal8()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">团省委立项</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val9" id="Val9" size="45" maxsize="45" value="<%=v.getVal9()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">校团委立项</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val10" id="Val10" size="45" maxsize="45" value="<%=v.getVal10()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">学院立项</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val11" id="Val11" size="45" maxsize="45" value="<%=v.getVal11()%>"/>
                    													</td>
													  				</tr>
													  				<tr>
                    													<td align="right" class="form_label">学生组织立项</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val12" id="Val12" size="45" maxsize="45" value="<%=v.getVal12()%>"/>
                    													</td>
													  				</tr>
													  				<tr>
                    													<td align="right" class="form_label">其他</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
													  				<tr>
													  					<td bgcolor="#ffffff" colspan="2">1.新媒体平台请提供截图 2.省级以上媒体报道请提供印刷版或截图</td>
													  				</tr>
													  				<tr>
