...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
                    													<td align="right" class="form_label">所在志愿服务组织</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val10" id="Val10" size="45" maxsize="45" value="<%=v.getVal10()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">何时起参加志愿服务</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val11" id="Val11" size="45" maxsize="45" value="<%=v.getVal11()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">参加志愿服务总时数（小时）</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">参与志愿服务活动获奖情况</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text1" id="Text1" cols="80" rows="6"><%=v.getText1()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">主要志愿服务工作事迹</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text2" id="Text2" cols="80" rows="6" placeholder="可添加附件"><%=v.getText2()%></textarea>
                    													</td>
													  				</tr>
