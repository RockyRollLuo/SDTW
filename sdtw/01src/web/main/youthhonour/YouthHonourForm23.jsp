...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
                    													<td align="right" class="form_label">所在社团</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val6" id="Val6" size="45" maxsize="45" value="<%=v.getVal6()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">社团职务</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">所在社团属于</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<%=HtmlTool.renderSelect(clubLevelOptions, v.getVal9(), "Val9", "")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">去年共参加全校性社团活动次数</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val10" id="Val10" size="45" maxsize="45" value="<%=v.getVal10()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">社团工作部证明人姓名</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val11" id="Val11" size="45" maxsize="45" value="<%=v.getVal11()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">社团工作部证明人联系电话</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val12" id="Val12" size="45" maxsize="45" value="<%=v.getVal12()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">去年共参加学院和社团内部活动次数</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val13" id="Val13" size="45" maxsize="45" value="<%=v.getVal13()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">学院社团负责人姓名</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val14" id="Val14" size="45" maxsize="45" value="<%=v.getVal14()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">学院社团负责人联系电话</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">曾获社团奖励情况</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text1" id="Text1" cols="80" rows="6" placeholder="获奖名称，获奖等级，颁发单位，获奖时间；"><%=v.getText1()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">社团工作情况简介</td>
														    			<td align="left"  bgcolor="#ffffff">
