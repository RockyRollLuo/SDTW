...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr>
                    													<td align="right" class="form_label" width="50%">学院审核结果</td>
                    												...
                    												<tr>
                    													<td align="right" class="form_label">所属团支部</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val1" id="Val1" size="45" maxsize="45" value="<%=v.getVal1()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">主要负责人</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">总结报告</td>
														    			<td align="left"  bgcolor="#ffffff">
