...
%>
	...
	<body onload="init();">
		...
		<div id="tabs">
			<ul>
				<li><a href="#tabs-1">基层委员基本情况</a></li>
				<li><a href="#tabs-2">参加、组织骨干培训（数量）</a></li>
				<li><a href="#tabs-3">选树典型请款（数量）</a></li>
				<li><a href="#tabs-4">参与校级组织骨干情况（数量）</a></li>
...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>	
                    											...
                    											<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr>
                    													<td align="right" class="form_label">校学生会</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val17" id="Val17" size="45" maxsize="45" value="<%=v.getVal17()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">校研究生会</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
													  				<tr>
													  					<td bgcolor="#ffffff" colspan="2">1.获奖集体和个人的证书、照片等证明材料 2.参与校级组织的学生信息一览表</td>
													  				</tr>
													  				<tr>
