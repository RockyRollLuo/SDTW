...
<%--<input type="hidden" name="Noticeid" value="<%=v.getNoticeid()%>"/> 
    ...
    <tr>
    	<td align="right" class="form_label">支部人数</td>
  		<td align="left"  bgcolor="#ffffff">
