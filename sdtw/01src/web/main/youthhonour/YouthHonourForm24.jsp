...
<input type="hidden" name="Val3" id="Val3" value="<%=v.getVal3()%>"/>
<input type="hidden" name="Val4" id="Val4" value="<%=v.getVal4()%>"/>
<input type="hidden" name="Val5" id="Val5" value="<%=v.getVal5()%>"/>
<input type="hidden" name="Val6" id="Val6" value="<%=v.getVal6()%>"/>
...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
                    													<td align="right" class="form_label">担任指导教师时间</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val4" id="Val4" size="45" maxsize="45" value="<%=v.getVal4()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">所指导的社团名称</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val5" id="Val5" size="45" maxsize="45" value="<%=v.getVal5()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">所指导的社团属于</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<%=HtmlTool.renderSelect(clubLevelOptions, v.getVal6(), "Val6", "")%>
                    													</td>
													  				</tr>
													  				
													  				<tr>
                    													<td align="right" class="form_label">社团基本情况简介</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">社团品牌活动名称</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val7" id="Val7" size="45" maxsize="45" value="<%=v.getVal7()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">去年共举办品牌活动期数</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val8" id="Val8" size="45" maxsize="45" value="<%=v.getVal8()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">品牌活动特色及影响</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text2" id="Text2" cols="80" rows="6"><%=v.getText2()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">指导教师指导社团工作描述</td>
														    			<td align="left"  bgcolor="#ffffff">
