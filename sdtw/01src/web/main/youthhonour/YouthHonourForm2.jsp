...
<%
	...
	Map modifyMap=yhUtil.getStuModifyMap();
...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
                    													<td align="right" class="form_label">支部名称</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val1" id="Val1" size="45" maxsize="45" value="<%=v.getVal1()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">所属基层团委</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val2" id="Val2" size="45" maxsize="45" value="<%=v.getVal2()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">班级人数</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">开展工作情况及成绩</td>
														    			<td align="left"  bgcolor="#ffffff">
