...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
                    													<td align="right" class="form_label">参加校级及以上文艺活动、文艺竞赛、体育活动、体育竞赛及其它文体活动情况</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text1" id="Text1" cols="80" rows="6" placeholder="格式（活动名称，主办单位，获奖等级；）"><%=v.getText1()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">参加院级文艺活动、文艺竞赛、体育活动、体育竞赛及其它文体活动情况</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text2" id="Text2" cols="80" rows="6" placeholder="格式（活动名称，主办单位，获奖等级；）"><%=v.getText2()%></textarea>
                    													</td>
													  				</tr>
