...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
                    													<td align="right" class="form_label">青年集体名称</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val1" id="Val1" size="45" maxsize="45" value="<%=v.getVal1()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">单位地址</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">联系人电话</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val4" id="Val4" size="45" maxsize="45" value="<%=v.getVal4()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">职工总人数</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val5" id="Val5" size="45" maxsize="45" value="<%=v.getVal5()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">35岁以下人数</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">成员平均年龄</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<tr>
                    													<td align="right" class="form_label">负责人情况</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text1" id="Text1" cols="80" rows="6" placeholder="格式（姓名，年龄，性别，学历，职务；）"><%=v.getText1()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">基础工作简要介绍</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text2" id="Text2" cols="80" rows="6"><%=v.getText2()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">近两年获奖情况</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text3" id="Text3" cols="80" rows="6"><%=v.getText3()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">事迹介绍</td>
														    			<td align="left"  bgcolor="#ffffff">请另附1000字左右文字材料附件
                    													</td>
													  				</tr>
													  				<tr>
