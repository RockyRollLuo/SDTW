...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>	
    ...
    <tr>
  	...
  	<tr>
    	<td align="right" class="form_label">年级、学历</td>
  		<td align="left"  bgcolor="#ffffff">
  		...
  		<td align="left"  bgcolor="#ffffff">
    		<input name="Val8" id="Val8" size="45" maxsize="45" value="<%=v.getVal8()%>"/>
  			...
  			<td align="left"  bgcolor="#ffffff">
    			...
    			<tr>
    				<td align="right" class="form_label">发表论文、或得专利、参加科研工作及科技学术竞赛获奖情况</td>
  			<td align="left"  bgcolor="#ffffff">
    					<textarea name="Text1" id="Text1" cols="80" rows="6" placeholder="论文请按照山东大学核心期刊目录注明期刊等级"><%=v.getText1()%></textarea>
    				</td>
			</tr>
