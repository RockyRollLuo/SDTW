...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
    ...
    <tr>
    	<td align="right" class="form_label">文化程度</td>
  		<td align="left"  bgcolor="#ffffff">
    		<input name="Val6" id="Val6" size="45" maxsize="45" value="<%=v.getVal6()%>"/>
    	</td>
	</tr>
    <tr>
    <td align="right" class="form_label">在本岗位工作时间</td>
  		<td align="left"  bgcolor="#ffffff">
    		<input name="Val7" id="Val7" size="45" maxsize="45" value="<%=v.getVal7()%>"/>
    	</td>
	</tr>
    <tr>
    	<td align="right" class="form_label">职称</td>
  		<td align="left"  bgcolor="#ffffff">
    		<input name="Val8" id="Val8" size="45" maxsize="45" value="<%=v.getVal8()%>"/>
  			...
  			<td align="left"  bgcolor="#ffffff">
    			...
    			<tr>
    				<td align="right" class="form_label">近三年获奖情况</td>
  			<td align="left"  bgcolor="#ffffff">
    					<textarea name="Text2" id="Text2" cols="80" rows="6"><%=v.getText2()%></textarea>
    				</td>
			</tr>
    			<tr>
    				<td align="right" class="form_label">简要事迹</td>
  			<td align="left"  bgcolor="#ffffff">
    					<textarea name="Text3" id="Text3" cols="80" rows="6" placeholder="限500字"><%=v.getText3()%></textarea>
    				</td>
			</tr>
