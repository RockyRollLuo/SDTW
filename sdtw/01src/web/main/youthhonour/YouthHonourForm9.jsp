	...
	<body onload="init();">
		...
		<div id="tabs">
			<ul>
				...
				<li><a href="#tabs-1">基本情况</a></li>
				<li><a href="#tabs-2">各类立项数量统计</a></li>
				<li><a href="#tabs-3">获省级以上（含省级）奖励统计</a></li>
				<li><a href="#tabs-4">工作总结</a></li>
			</ul>
...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>	
                    											...
                    											<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr>
                    													<td align="right" class="form_label">优秀团队</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val6" id="Val6" size="45" maxsize="45" value="<%=v.getVal6()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">优秀指导教师</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val7" id="Val7" size="45" maxsize="45" value="<%=v.getVal7()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">先进个人</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
													  				<tr>
													  					<td bgcolor="#ffffff" colspan="2">提交年度学院社会实践工作总结，总结要突出特色工作、重点工作</td>
													  				</tr>
													  				<tr>
