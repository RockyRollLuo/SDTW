...
%>
	...
	<body onload="init();">
		...
		<div id="tabs">
			<ul>
				<li><a href="#tabs-1">创新创业活动情况</a></li>
				<li><a href="#tabs-2">创新创业教育情况</a></li>
				<li><a href="#tabs-3">创新创业相关激励政策、物质保障</a></li>
				<li><a href="#tabs-4">创新创业学生组织情况</a></li>
...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>	
                    											...
                    											<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
                    													<td align="right" class="form_label">“创青春”大学生创业计划竞赛申报团队</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val2" id="Val2" size="45" maxsize="45" value="<%=v.getVal2()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">“挑战杯”全国大学生课外学术科技作品竞赛获奖数量</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val3" id="Val3" size="45" maxsize="45" value="<%=v.getVal3()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">“挑战杯”山东省大学生课外学术科技作品竞赛获奖数量</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val4" id="Val4" size="45" maxsize="45" value="<%=v.getVal4()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">“挑战站”山东大学学生课外学术科技作品竞赛获奖数量</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val5" id="Val5" size="45" maxsize="45" value="<%=v.getVal5()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">学院特色竞赛国家级（名称、获奖数量）</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val6" id="Val6" size="45" maxsize="45" value="<%=v.getVal6()%>"/>
                    													</td>
													  				</tr>
													  				<tr>
                    													<td align="right" class="form_label">学院特色竞赛省级（名称、获奖数量）</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val7" id="Val7" size="45" maxsize="45" value="<%=v.getVal7()%>"/>
                    													</td>
													  				</tr>
													  				<tr>
                    													<td align="right" class="form_label">校级科技创新立项数量</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr>
                    													<td align="right" class="form_label">创新创业类讲座（名称、数量）</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val9" id="Val9" size="45" maxsize="45" value="<%=v.getVal9()%>"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">学院参与指导学生创新创业教师数量</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr>
                    													<td align="right" class="form_label">学院具体做法</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text2" id="Text2" cols="80" rows="6" placeholder="针对学生、教师的政策及物质支持"><%=v.getText2()%></textarea>
                    													</td>
													  				</tr>
													  				</table>
													  				</div>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Text3" id="Text3" cols="80" rows="6" placeholder="数量、名称、规模"><%=v.getText3()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">参与山东大学学生会学生创新创业实践中心学生骨干数量</td>
														    			<td align="left"  bgcolor="#ffffff">
                    												...
                    												<table width="100%" style="background: #e3e5e8 ;" border="0" align="center" cellpadding="4" cellspacing="1" >
													  				<tr>
													  					<td bgcolor="#ffffff" colspan="2">1.“创青春”外其他竞赛请附证书及照片 2.相关学院特色竞赛及做法请附简单说明以便交流</td>
													  				</tr>
													  				<tr>
