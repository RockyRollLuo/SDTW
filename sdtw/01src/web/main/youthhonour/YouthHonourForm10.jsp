...
<input type="hidden" name="Text6" id="Text6" value="<%=v.getText6()%>"/>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												...
                    												<tr>
                    													<td align="right" class="form_label">省级选树典型数（集体或个人）</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val5" id="Val5" size="45" maxsize="45" value="<%=v.getVal5()%>" placeholder="需要传证明材料"/>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">国家级选树典型数（集体或个人）</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Val6" id="Val6" size="45" maxsize="45" value="<%=v.getVal6()%>" placeholder="需要传证明材料"/>
                    													</td>
													  				</tr>
