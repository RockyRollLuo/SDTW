...
<%
	...
	String deptid=ParamUtils.getParameter(request, "_type_", "-1");
	String shuchu="学生会部门成员";
	System.out.println(deptid);
	if(deptid.equals("zhuxi")){
		shuchu="学生会主席团成员";
	}
	String id=ParamUtils.getParameter(request, "_UnionId_", "1");
%>
	<head>
...
<tr>
      <td id = "base" class="labeloff" width="60" align="center"  ><a style="color: #ffffff" href="StudentUnionAction.jsp?cmd=modify&id=<%=id%>">学生会介绍</a></td>
      <%
     if( deptid.equals("zhuxi")){
      %>
      <td id = "team" class="labelon" width="60" align="center"  ><a  style="color: black" href="StudentUnionMemberAction.jsp?cmd=list&_type_=zhuxi&_UnionId_=<%=id%>">主席团信息</a></td>
      ...
      <td id = "other" class="labelon" width="60" align="center"  ><a style="color: black" href="StudentUnionDeptAction.jsp?cmd=list&_UnionId_=<%=id%>">部门列表</a></td>
