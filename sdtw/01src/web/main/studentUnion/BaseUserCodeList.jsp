			...
			function selectRole(){
			   ...
			   if (chkeds.length > 0) {
					...
					for(var i =0;i<rowIndex.length;i++){
						...
						if(sno!='null') {
							str+="学号："+sno+"&nbsp;&nbsp;&nbsp;<input id='Sno"+sno+"' name='Sno"+sno+"' value='"+sno+"' type='hidden'/>";
						}
						if(name!='null') {
							str+="姓名："+name+"&nbsp;&nbsp;&nbsp;";
						}
						...
						str+="职务：<select id='Duty"+sno+"' name='Duty"+sno+"'><option value='-1'></option><option value='0'>班长</option><option value='1'>团支书</option><option value='2'>其他班委</option></select>"
						if(values==""){
							reId += ","+sno+"";
