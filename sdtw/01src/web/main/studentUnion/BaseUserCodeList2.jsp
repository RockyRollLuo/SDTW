			...
			function selectRole(){
			   ...
			   if (chkeds.length > 0) {
					...
					for(var i =0;i<rowIndex.length;i++){
						...
						sno = rows[rowIndex[i]][getCodeIndex('Name')];
					}
					//reId = reId.substring(1,reId.length);	
			    	window.opener.setRole(reName,reId,sno);
			    	window.close();
			    } else {
			    	reName = '';
			    	reId = '';
							...
							<td valign="top">
                               ...
                               <tr>
                                   <td>
    								...
    								<form action="<%=request.getAttribute("classname")%>Action2.jsp" name="query" id="postForm" method="post">
  									<tr>
    									<td>
