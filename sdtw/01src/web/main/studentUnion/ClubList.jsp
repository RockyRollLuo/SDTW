	...
	<head>
		...
		<script>
			...
			function showwinside(uid,cid,checkflag,title){
				var clienth = 600;
				var clientw = 1100;
				parent.showDialog('<%=HeadConst.apache_url%>/main/studentUnion/EditClubModifySponsor.jsp?uid='+uid+'&cid='+cid+'&checkflag='+checkflag,clientw,clienth,title
						,{
					'确定':function(){
                                   ...
                                   <td>
											            <div class="browsetitle title_css">
												            <div class="browsetitleleft">
													          <div class="browsetitle001">社团列表</div>
