...
<%=HtmlTool.renderSelect(UserNameoptions, v.getAddAccount(), "AddAccount", "")%>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    												<%=HtmlTool.renderSelect(xiaoquoptions, v.getArea(), "Area", "")%>
                    													</td>
													  				</tr>
													  			
                    											
                    												<tr>
                    															<td align="right" class="form_label">管理人员</td>
														    			<td align="left"  bgcolor="#ffffff">
	...
	<input name="Principal" id="Principal" size="50" maxsize="50" value="<%=v.getPrincipal()%>">
                    												...
                    												<tr>
                    													...
                    													<td align="right" class="form_label">容纳人数</td>
														    			<td align="left"  bgcolor="#ffffff">
														    			<%
														    			if(v.getId()==-1){
														    			%>
                    														<input name="PeopleNums" size="50" maxsize="50" id="PeopleNums" value="">
                    														<%}else{ %>
                    														<input name="PeopleNums" size="50" maxsize="50"id="PeopleNums" value="<%=v.getPeopleNums()%>">
...
<input type="hidden" name="AddTime" value="<%=v.getAddTime()%>">
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff" colspan="3">
                    														<textarea name="Marks" id="Marks" cols="150" rows="4"><%=v.getMarks()%></textarea>
                    													</td>
													  				</tr>
