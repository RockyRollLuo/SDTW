...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "PlaceCode", "PlaceName", "Principal", "Contact", "Area", "AddAccount", "AddTime", "PeopleNums", "Instruments", "Marks", "LastModifyTime", "LastModifyAccount","shiyongqingkuang"};
private String[] DicKeys = {"Id", "PlaceCode", "PlaceName", "Principal", "Contact", "Area", "AddAccount", "AddTime", "PeopleNums", "Instruments", "Marks", "LastModifyTime", "LastModifyAccount","shiyongqingkuang"};
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"string", "地点代码", "45", "text", ""}, {"string", "场地名称", "50", "text", ""}, {"string", "管理人员", "50", "UserName", ""}, {"string", "联系方式", "50", "text", ""}, {"string", "地点", "50", "text", ""}, {"string", "添加人", "50", "hidden", ""}, {"date", "添加时间", "0", "hidden", ""}, {"int", "容纳人数", "0", "hidden", ""}, {"string", "场地设备", "50", "text", ""}, {"string", "备注", "255", "hidden", ""}, {"date", "最后修改时间", "0", "hidden", ""}, {"string", "最后修改人", "50", "hidden", ""}, {"string", "使用情况", "50", "hidden", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "PlaceCode", "PlaceName", "Principal", "Contact", "Area", "AddAccount", "AddTime", "PeopleNums", "Instruments", "Marks", "LastModifyTime", "LastModifyAccount","shiyongqingkuang"};
private String[] ListFields = { "PlaceName", "Instruments", "PeopleNums", "Principal","Contact", "Area", "shiyongqingkuang"};
...
private List getListRows(javax.servlet.http.HttpServletRequest request, Places pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add("<a href='places-application-list.jsp?_PlaceApplyId_="+v.getId()+"'>点击查看</a>");
        rows.add(row);
    }
    return rows;
}
