		...
		<script>
			...
			function modify1List21(className, url_para, page)
			{
			    ...
			    if (chkeds.length > 0) {
			        if (confirm("确实要拒绝通过这些学生的审核吗?")) {
			        	//alert(className + "Action.jsp?cmd=modifylist1&idlist=" + chkeds.join(',') + "&page=" + page + ((url_para.length == 0) ? "" : "&" + url_para));
			            location = className + "Action.jsp?cmd=modifyList2&idlist=" + chkeds.join(',') + "&page=" + page + ((url_para.length == 0) ? "" : "&" + url_para);
			        }
			    } else {
			        alert("未选择记录！");
			    }
			...
			function modify1List31(className, url_para, page)
			{
			    ...
			    if (chkeds.length > 0) {
			        if (confirm("确实要拒绝通过这些学生的审核吗?")) {
			        	//alert(className + "Action.jsp?cmd=modifylist1&idlist=" + chkeds.join(',') + "&page=" + page + ((url_para.length == 0) ? "" : "&" + url_para));
			            location = className + "Action.jsp?cmd=modifyList3&idlist=" + chkeds.join(',') + "&page=" + page + ((url_para.length == 0) ? "" : "&" + url_para);
			        }
			    } else {
			        alert("未选择记录！");
			    }
