...
<%
	...
	int honourtype= ParamUtils.getIntParameter(request, "_honourType_", -1);
	int  addacunt= ParamUtils.getIntParameter(request, "_addacunt_", -1);

	
	String  tiaozhuanurl="VolunteerProjectAction.jsp?cmd=list";
	if(honourtype==0){
		tiaozhuanurl="VolunteerActivityAction.jsp";
	}
	if(honourtype==4){
                                   ...
                                   <td>
											            <div class="browsetitle title_css">
												            <div class="browsetitleleft">
													          <div class="browsetitle001">荣誉列表</div>
													          <div class="browsetitle002"><%=XtUtil.getSpell("荣誉列表")%></div>
												          </div>
												          <div class="browsetitleright">
												              <div class="anniulist2">
													           <ul>
														            <li> <a href="<%=tiaozhuanurl %>" >返回</a></li> 
