...
<%
	...
	String _ZhikuId_ = ParamUtils.getParameter(request,"_ZhikuId_","-1");
%>
	<head>
		...
		<script>
			...
			function download(className, url_para, page)
			{
			    ...
			    if (chkeds.length > 0) {
			        if (confirm("只能导出审核通过记录,确实要导出这些记录吗?")) {
			    	...
			    	//document.query.cmd.value = 'excel'; document.query.submit();
			    		location = className + "Action.jsp?cmd=excel&_ZhikuId_=<%=_ZhikuId_%>&page=" + page + ((url_para.length == 0) ? "" : "&" + url_para);
			    	}
			    }
			}
		</script>
						...
						<tr>
							<td valign="top">
                                   ...
                                   <td>
											            <div class="browsetitle title_css">
												            <div class="browsetitleleft">
													          <div class="browsetitle001">山大志库报名表</div>
													          <div class="browsetitle002"><%=XtUtil.getSpell("山大志库报名表")%></div>
												          </div>
                               ...
                               <div class="browsetable2">
											...
											<input id="_ZhikuId_" name="_ZhikuId_" value="<%=_ZhikuId_%>" type="hidden"/>
											<%=Tool.join("\n", forms)%>
                               </div>
										</td>
									</tr>
