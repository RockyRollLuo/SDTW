...
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"int", "荣誉分类", "0", "HonorType", ""}, {"int", "活动Id", "0", "hidden", ""}, {"string", "荣誉名称", "100", "text", ""}, {"date", "添加时间", "0", "hidden", ""}, {"string", "添加人", "45", "hidden", ""}, {"string", "荣誉人数", "0", "text", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "HonorType", "ActivityId", "HonorName", "Addtime", "Addperson", "IsEnable"};
private String[] ListFields = { "HonorName", "IsEnable"};
...
private List getListCondition(javax.servlet.http.HttpServletRequest request, Honor pv, boolean isAll)
{
    ...
    qval =ParamUtils.getIntParameter(request, "_ActivityId_", -1)+"";
    if(qval.length()>0&&!qval.equals("-1")){
    	cdt.add("activityid="+qval);
    }
    qval =ParamUtils.getIntParameter(request, "_honourType_", -1)+"";
    if(qval.length()>0&&!qval.equals("-1")){
    	cdt.add("honorType="+qval);
    }
    if (!isAll) {
...
private void setForm(javax.servlet.http.HttpServletRequest request, Honor form)
{
    ...
    request.setAttribute("classname", "Honor");
    request.setAttribute("describe", "志愿活动");
    System.out.println(ParamUtils.getIntParameter(request, "_ActivityId_", -1));
    request.setAttribute("_ActivityId_", ParamUtils.getIntParameter(request, "_ActivityId_", -1));
    System.out.println(ParamUtils.getIntParameter(request, "_honourType_", -1)+"AAAAAAAAAAAAAAAAAAAAAAAAA");
    request.setAttribute("honurType", ParamUtils.getIntParameter(request, "_honourType_", -1)+"");
}
