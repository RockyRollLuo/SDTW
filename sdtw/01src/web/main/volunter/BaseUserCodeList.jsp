...
List xyNameoptions=(List)request.getAttribute("xyNameoptions");
	...
	cdt1.add("academy ="+user.getDeptId());
                                   ...
                                   <td>
											            <div class="browsetitle title_css">
												            <div class="browsetitleleft">
													          ...
													          <div class="browsetitle002"><%=XtUtil.getSpell("志愿者信息")%></div>
												          </div>
                               ...
                               <div class="browsetable2">
											...
											<table border=0 cellspacing=3 cellpadding=5 width="100%">
												...
												<tr>
													...
													<td>
<%=HtmlTool.renderSelect(xyNameoptions, ParamUtils.getParameter(request,"_Sacademy_",""), "_Sacademy_", "")%>
													</td>
													<%} %>
...
<%=HtmlTool.renderSelect(majorNameoptions, ParamUtils.getParameter(request,"_Major_",""), "_Major_", "")%>
													...
													<td>
<%-- <%=HtmlTool.renderSelect(xyNameoptions, ParamUtils.getParameter(request,"_Sno_",""), "_Sno_", "")%> --%>
<input    name="_Sno_" value="<%=ParamUtils.getParameter(request, "_Sno_", "") %>" />
													...
													<td>
<%-- <%=HtmlTool.renderSelect(xyNameoptions, ParamUtils.getParameter(request,"_SName_",""), "_SName_", "")%> --%>
<input    name="_SName_" value="<%=ParamUtils.getParameter(request, "_SName_", "") %>" />
													</td>
												
											<input type="hidden" name="_VolunteerfFag_" value="1">	
