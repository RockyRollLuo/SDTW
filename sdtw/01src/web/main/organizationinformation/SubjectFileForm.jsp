...
<%
	Log log = LogFactory.getLog(SubjectFile.class);
	...
	SubjectFile v = (SubjectFile)request.getAttribute("fromBean");
	if (v == null) {
...
List usercnname=CEditConst.getUserCnNameOptions(userInfo);
String subjectcode=ParamUtils.getParameter(request, "_subjectcode_", "-1");
List checkoptions =CEditConst.getCancleCheckFlagOptions(userInfo);
%>
	<head>
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">团建课题各学院上传资料</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("团建课题各学院上传资料") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="SubjectAction.jsp" >返回</a></li>
						      <%if(v.getId()==-1||(v.getCheckflag()==2&&userInfo.hasFunPower(Power.UserAdminPower))){ %>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">            
                    												...
                    												<tr style="display: none;">
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="SubjectCode" id="SubjectCode" size="50" maxsize="50" value="<%=v.getSubjectCode()%>">
                    													</td>
													  				</tr>
													  					<tr>
...
<%=HtmlTool.renderSelect(AcademyNameoptions,v.getAcademy()+"" , "Academy", "",true)%>
													  				...
													  				<input type="hidden" name="Checkflag" value="0">
                    													...
                    													<td align="right" class="form_label">课题编码</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="SubjectCode" id="SubjectCode" size="50" maxsize="50" value="<%=subjectcode%>">
                    													</td>
													  				</tr>
													  				<tr>
                    													<td align="right" class="form_label">学院</td>
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(AcademyNameoptions,user.getDeptId()+"" , "Academy", "",true)%>
                    													</td>
													  				</tr>
													  				<%} %>
                    												...
                    												<tr>
														    			...
														    			<input name="Principal" id="Principal" size="50" maxsize="50" value="<%=user.getCnName()%>" readonly="readonly">
                 													</td>
													  				</tr>
													  				<%if(v.getId() ==-1){ %>
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Contact" id="Contact" size="50" maxsize="50" value="<%=user.getPhone()%>">
                    													</td>
													  				</tr>
													  				<%}else{ %>
													  					<tr>
                    													<td align="right" class="form_label">联系方式</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="Contact" id="Contact" size="50" maxsize="50" value="<%=v.getContact()%>"readonly="readonly"">
                    													</td>
													  				</tr>
													  				...
													  				<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
														    				<textarea name="CheckAccount" id="CheckAccount" cols="140" rows="4"><%=v.getCheckAccount()%></textarea>
                    													</td>
													  				</tr>
													  				<%} %>
													  					<%if(userInfo.hasFunPower(Power.UserAdminPower)&&v.getId()!=-1){ %>
													  				
													  				<tr>
                    													<td align="right" class="form_label">审核状态</td>
														    			<td align="left"  bgcolor="#ffffff">
                    													
                    														<%=HtmlTool.renderSelect(checkoptions,v.getCheckflag()+"" , "Checkflag", "",true)%>
                    													</td>
													  				</tr>
													  				<tr>
                    													<td align="right" class="form_label">审核意见</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<input name="CheckAccount" id="CheckAccount" size="50" maxsize="50" value="<%=v.getCheckAccount()%>" readonly="readonly">
                    													</td>
													  				</tr>
													  				<%} %>
...
<input type="hidden" name="AddAcount" value="<%=v.getAddAcount()%>">
                    											</table>
                    											  <!-- 上传其他附件 -->
																	...
																	%>
																					...
																					<img src='../images/file1.gif' border="0"/> <%=ca1.getUploadName() %></a>&nbsp;&nbsp;&nbsp;&nbsp;<%if(v.getId()==-1){ %><img src='../images/delete.gif' alt='删除' title='删除' border="0" onclick="javascript:deleteUpdateFile('<%=ca1.getUploadName()+ca1.getId() %>','<%=ca1.getId() %>')" style="cursor:point;"/></td></tr>
																	<%				}}//删除无效id
																					else{
