	...
	<head>
		...
		$(function(){
			...
			function inList(aid,sid){
				location = "SubjectFileAction.jsp?cmd=list&_academy_="+sid+"&_subjectcode_="+aid;
			}
												          ...
												          <div class="browsetitleright">
												              <div class="anniulist2">
													           <ul>
														           ...
														           <li><a href="SubjectAction.jsp?cmd=list&page=<%=currpage%>" >返回</a></li>
          											...
          											<td>
														...
														<table cellspacing="1" cellpadding="2" border="0"
															...
															<tbody>
																...
																list = util.getAcademyListFlag1(aid);
																...
																<tr onmouseover="addClass(this,'data_bgcolor_over');" onmouseout="removeClass(this,'data_bgcolor_over');"class="data_bgcolor_<%=d %>" style="cursor: pointer;" onclick="inList(<%=subjectcode%>,<%=v.getId()%>)">
																	...
																	<%
																	if(tiaoshu>0) {%>
																		<td class="browsetable005" align="center" style="color: red">查看 ,已上报<%=tiaoshu %>条记录</td>
																	<%}else{%>
																		<td class="browsetable005" align="center" style="co">未上传 </td>
																	<%}
																	%>
																</tr>
																	<%}
