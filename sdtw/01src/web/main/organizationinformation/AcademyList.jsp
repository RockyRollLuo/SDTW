                                   ...
                                   <td>
											            <div class="browsetitle title_css">
												            <div class="browsetitleleft">
													          <div class="browsetitle001">组织信息列表</div>
												          ...
												          <div class="browsetitleright">
												              <div class="anniulist2">
													           <ul>
														            ...
														            <li><a href="javascript:document.query.cmd.value = 'list';deleteList('<%=request.getAttribute("classname")%>', url_para);">删除</a></li>
														            <li><a href="javascript:document.query.cmd.value = 'list';addNew('<%=request.getAttribute("classname")%>', url_para);">增加</a></li>
														            <li><a href="javascript:document.query.cmd.value = 'excel';document.query.submit();">查询</a></li>
													            </ul>
												              </div>
												           </div>
											            </div>	                                   </td>
                               ...
                               <div class="browsetable2">
											...
											<%=Tool.join("\n", forms)%>
												...
												<tr>
													...
													<td colspan="4">&nbsp;</td>
													<td>
														<div align="right">系所码</div>
													</td>
													<td>
														<input name="_xisuoma_" value="<%=ParamUtils.getParameter(request, "_xisuoma_", "")%>">
													</td>
													<td colspan="4">&nbsp;</td>
												</tr>
											</table>
