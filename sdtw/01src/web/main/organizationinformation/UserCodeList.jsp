...
List DeptNameoptions = (List)request.getAttribute("DeptNameoptions");
    ...
    xyxdt.add("flag=1");
	List xyname=COptionConst.getAcademyNameOptions(userInfo,"",xyxdt);
...
<%=HtmlTool.renderSelect(OrgNameoptions, ParamUtils.getParameter(request,"_OrgId_",""), "_OrgId_", "")%>
													...
													<td>
<%=HtmlTool.renderSelect(xyname, ParamUtils.getParameter(request,"_DeptId_","-1"), "_DeptId_", "")%>
													</td>
													<td>
												...
												<tr>
													...
													<td>
<%=HtmlTool.renderSelect(genderoptions, ParamUtils.getParameter(request,"_Gender_",""), "_Gender_", "")%>
													</td>
												</tr>
