...
<%
	...
	String _ClubName_ = ParamUtils.getParameter(request,"_ClubName_","-1");
%>
	<head>
						...
						<tr>
							<td valign="top">
                               ...
                               <div class="browsetable2">
											...
											<input id="ClubName" name="ClubName" value="<%=ClubName%>" type="hidden"/>
											<input id="_ClubName_" name="_ClubName_" value="<%=_ClubName_%>" type="hidden"/>
											<%=Tool.join("\n", forms)%>
                               </div>
										</td>
									</tr>
