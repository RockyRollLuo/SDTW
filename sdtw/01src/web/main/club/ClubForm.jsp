...
cdt1.add("flag=1");
List AcademyNameoptions = COptionConst.getAcademyNameOptions(userInfo,"",cdt1);//(List)request.getAttribute("AcademyNameoptions");
				...
				<div class="anniulist2">
					<ul>
						...
						if(userInfo.hasFunPower(Power.UserAdminPower)&& SdtwConst.CHECKFLAG_SB.equals(v.getCheckFlag())){%>
							<li class="browsetitle_lang"><a href="javascript:void(0);" onclick="javascript:if(doValidate('postForm')) {$('#CheckFlag').val('<%=SdtwConst.CHECKFLAG_XYWTG %>');document.postForm.submit();}">审核不通过</a></li>
							<li class="browsetitle_lang"><a href="javascript:void(0);" onclick="javascript:if(doValidate('postForm')) {$('#CheckFlag').val('<%=SdtwConst.CHECKFLAG_XYTG %>');document.postForm.submit();}">审核通过</a></li>
						<%}
						//团委审核
						if((userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.XSST)) && SdtwConst.CHECKFLAG_XYTG.equals(v.getCheckFlag())){%>
							<li class="browsetitle_lang"><a href="javascript:void(0);" onclick="javascript:if(doValidate('postForm')) {$('#CheckFlag').val('<%=SdtwConst.CHECKFLAG_XXWTG %>');document.postForm.submit();}">审核不通过</a></li>
							<li class="browsetitle_lang"><a href="javascript:void(0);" onclick="javascript:if(doValidate('postForm')) {$('#CheckFlag').val('<%=SdtwConst.CHECKFLAG_XXTG %>');document.postForm.submit();}">审核通过</a></li>
						<%}
						%>
						<%
						if (userInfo.hasFunPower(Power.STUSER)&&"3".equals(v.getCheckFlag())) {%>
							<li><a href="javascript:void(0);" onclick="javascript:if(doValidate('postForm')) {$('#cmd').val('Stupdate');document.postForm.submit();}">保存</a></li>
						<%}
						%>
...
<%=HtmlTool.renderSelect(UserNameoptions, v.getAddPersonName(), "AddPersonName", "")%>
                    											...
                    											<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff"colspan="5">
                    														<textarea name="CommentAcademy" id="CommentAcademy" rows="5"style="width: 100%"><%=v.getCommentAcademy()%></textarea>
                    													</td>
													  				</tr>
                    											</table>
                    											</div>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff"colspan="5">
                    														<textarea name="Commenttw" id="Commenttw" rows="5"style="width: 100%"><%=v.getCommenttw()%></textarea>
                    													</td>
													  				</tr>
                    											</table>
                    											</div>
                    											...
                    											<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    											<tr>
                    													<td align="right" class="form_label">注销原因</td>
														    			<td align="left"  bgcolor="#ffffff"colspan="5">
                    														<textarea name="CancleReason" id="CancleReason" rows="5"style="width: 100%"><%=v.getCancleReason()%></textarea>
                    													</td>
													  				</tr>
													  				</table>
													  				</div>
                    												...
                    												<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr>
                    													<td align="right" class="form_label">注销原因学院</td>
														    			<td align="left"  bgcolor="#ffffff"colspan="5">
                    														<textarea name="CancleCommentXy" id="CancleCommentXy" rows="5"style="width: 100%"><%=v.getCancleCommentXy()%></textarea>
                    													</td>
													  				</tr>
													  				</table>
													  				</div>
													  				...
													  				if(userInfo.hasFunPower(Power.ADMINPOWER)||userInfo.hasFunPower(Power.XSST)){%>
                    													...
                    													<table width="100%" border="0" align="center" cellpadding="4" cellspacing="1" >
                    												<tr>
                    													<td align="right" class="form_label">注销原因团委</td>
														    			<td align="left"  bgcolor="#ffffff"colspan="5">
                    														<input name="CancleCommentTw" id="CancleCommentTw"  value="<%=v.getCancleCommentTw()%>">
                    													</td>
													  				</tr>
													  				</table>
													  				</div>	
                    											...
                    											<%}
                    											%>
													  				<div id="tabs-7" style="border: 0px; padding: 0px;" >
												         			<!-- 负责人-->
												         			<iframe class="commentFrame" name="commentFrame1" id="commentFrame1" src="ClubMembersAction.jsp?MemberClubname=<%=v.getId() %>&_flag_=sponsor" frameborder='0' marginheight="0" marginwidth="0" width="100%" scrolling="auto" height="500px" ></iframe>
												         			</div>
												         			<div id="tabs-8" style="border: 0px; padding: 0px;" >
												         			<!--指导教师 -->
												         			<iframe  class="commentFrame" name="commentFrame2" id="commentFrame2" src="ClubTeacherAction.jsp?ClubName=<%=v.getId() %>" frameborder='0' marginheight="0" marginwidth="0" width="100%" scrolling="auto" height="500px"></iframe>
												         			</div>
