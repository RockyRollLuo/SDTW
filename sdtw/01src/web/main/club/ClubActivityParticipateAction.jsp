...
private List getListRows(javax.servlet.http.HttpServletRequest request, ClubActivityParticipate pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        row.add(("<a title='查看学生信息' href='javascript:void(0);' onclick=showwinside("+v.getSname()+","+v.getClubname()+",'1','查看学生信息');>"+UserCnNameMap.get(v.getSname())+"</a>"));
        ...
        row.add("<a href='"+HeadConst.apache_url+"/servlet/attach?type=otherattach&id="+attach.getId()+"'>"+attach.getUploadName()+"</a>");
        rows.add(row);
    }
    return rows;
}
