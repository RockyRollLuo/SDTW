...
<%
	Log log = LogFactory.getLog(ClubType.class);
	...
	ClubType v = (ClubType)request.getAttribute("fromBean");
	if (v == null) {
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">社团类别</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("社团类别") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="ClubTypeAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
                    														<%-- <input name="IsEnable" id="IsEnable" value="<%=v.getIsEnable()%>"> --%>
