...
<%
	...
	cdt.add("flag=1");
	List AcademyNameOptions = COptionConst.getAcademyAliasNameOptions(userInfo,"",cdt);
						...
						<tr>
							<td valign="top">
                               ...
                               <div class="browsetable2">
											...
											<td>原指导单位</td>
											<td>
											<%=HtmlTool.renderSelect(AcademyNameOptions,ParamUtils.getParameter(request,"_ClubAcademy_","")+"","_ClubAcademy_","-1") %>
											</td>
											<td>新指导单位</td>
											<td>
											<%=HtmlTool.renderSelect(AcademyNameOptions,ParamUtils.getParameter(request,"_ClubAcadeMyNew_","")+"","_ClubAcadeMyNew_","-1") %>
											</td>
											</tr>
											</table>
											<%} %>
