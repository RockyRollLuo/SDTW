...
<tr>
   ...
   <%=HtmlTool.renderSelect(UserCnNameOptions,""+members.getMemberName(),"MemberName","") %>
    ...
    <td  class="form_label">&nbsp;<font color="red">*&nbsp;</font>出生年月：</td>
     <td align="left" bgcolor="#FFFFFF">
     <input readonly="readonly" class= "date" name ="MemberBrith" id= "MemberBrith" onfocus="WdatePicker({el:'MemberBrith',dateFmt:'yyyy-MM-dd'})"  size= "0" value="<%=members.getMemberBrith()%>"/>
     </td>
    ...
    <td  class="form_label">&nbsp;<font color="red">*&nbsp;</font>籍贯：</td>
     <td align="left" colspan="3" bgcolor="#FFFFFF"><input type="text" name="MemberBirthplace" id="MemberBirthplace" value="<%=members.getMemberBirthplace()%>"></td>
</tr>
<tr>
...
<tr>
	...
	<input type="text" name="MemberPhone" id="MemberPhone"   value="<%=members.getMemberPhone()%>"> </td>
	<td bgcolor="#FFFFFF">&nbsp;<font color="red">*&nbsp;</font>E-mail：</td>
	<td align="left" colspan="3" bgcolor="#FFFFFF">
	<input type="text" name="MemberEmail" id="MemberEmail"   value="<%=members.getMemberEmail()%>"></td>
</tr>
<tr>
	<td bgcolor="#FFFFFF">&nbsp;<font color="red">*&nbsp;</font>QQ：
	<input type="text" name="Memberqq" id="Memberqq"  value="<%=members.getMemberqq()%>"></td>
    <td bgcolor="#FFFFFF">&nbsp;<font color="red">*&nbsp;</font>微信：</td>
    <td align="left" colspan="3" bgcolor="#FFFFFF">
    <input type="text" name="Memberwx" id="Memberwx"  value="<%=members.getMemberwx()%>"></td>
</tr>
<tr>
	<td class="form_label" >&nbsp;<font color="red">*&nbsp;</font>个人简介：</td>
	<td align="left" colspan="5" bgcolor="#FFFFFF"><textarea name="MProfile" id="MProfile"  style="width: 80%;" cols="130" rows="4"><%=members.getMProfile() %></textarea>	</td>
</tr>
<tr>
	<td class="form_label" >&nbsp;<font color="red">*&nbsp;</font>社团工作经历：</td>
	<td align="left" colspan="5" bgcolor="#FFFFFF"><textarea name="MExperience" id="MExperience" style="width: 80%;" cols="130" rows="4"><%=members.getMExperience() %></textarea></td>
</tr>
<%
String bt1 = "确定添加";
String bt2 = "取消添加";
