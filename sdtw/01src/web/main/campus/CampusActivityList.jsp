...
%>
	<head>
		...
		<script>
			...
			function checkbaoming(idlist){
				var msg = "";
				$.ajax({
                    type: "get",
                    url: "CampusActivityAction.jsp",
                    data: {idlist:idlist,cmd:'checkbaoming'},
                    dataType: "json",
                    cache: false,
                    async:false,
						...
						<tr>
							<td valign="top">
                               ...
                               <div class="browsetable2">
											...
											<tr>
											<td>活动名称</td>
											<td><input id="_ActivityName_" name="_ActivityName_" value="<%=ParamUtils.getParameter(request,"_ActivityName_","")%>"/></td>
											</tr>
											</table>
                               </div>
										</td>
