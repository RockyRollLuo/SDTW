...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "ProjectName", "HostName", "StartTime", "HostId", "EndTime", "AddTime", "AddPerson", "ModifyTime", "AddUseraccount", "ModifyUseraccount", "OtherUniversity", "ModifyPerson", "AddFileList", "ProjectExplain"};
private String[] DicKeys = {"Id", "ProjectName", "HostName", "StartTime", "HostId", "EndTime", "AddTime", "AddPerson", "ModifyTime", "AddUseraccount", "ModifyUseraccount", "OtherUniversity", "ModifyPerson", "AddFileList", "ProjectExplain"};
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"string", "学习项目名称", "2000", "text", ""}, {"string", "负责人", "2000", "text", ""}, {"date", "开始时间", "0", "hidden", ""}, {"string", "负责人", "2000", "text", ""}, {"date", "结束时间", "0", "hidden", ""}, {"date", "添加时间", "0", "hidden", ""}, {"string", "添加人", "2000", "hidden", ""}, {"date", "修改时间", "0", "hidden", ""}, {"string", "添加人账号", "2000", "hidden", ""}, {"string", "修改人账号", "2000", "hidden", ""}, {"int", "是否外校", "0", "text", ""}, {"string", "修改人", "2000", "hidden", ""}, {"string", "附件", "2000", "hidden", ""}, {"string", "项目说明", "2000", "text", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "ProjectName", "HostName", "StartTime", "HostId", "EndTime", "AddTime", "AddPerson", "ModifyTime", "AddUseraccount", "ModifyUseraccount", "OtherUniversity", "ModifyPerson", "AddFileList", "ProjectExplain"};
private String[] ListFields = {"ProjectName","HostId", "OtherUniversity", "StartTime","EndTime"};
private String[] FormFields = {"ProjectName", "HostName", "StartTime", "HostId", "EndTime", "AddTime", "AddPerson", "ModifyTime", "AddUseraccount", "ModifyUseraccount", "OtherUniversity", "ModifyPerson", "AddFileList", "ProjectExplain"};
...
private List getListRows(javax.servlet.http.HttpServletRequest request, TrainingArrangement pv, List cdt)
{
    ...
    for (Iterator it = vs.iterator(); it.hasNext();) {
        ...
        //校内
        // if (v.getOtherUniversity()==0){
        	// row.add((String)UserCnNameMap.get(v.getHostId()+""));
        // }
        //校外
       // if (v.getOtherUniversity()==1){
        	row.add(v.getHostName());
       // }
...
public List main(javax.servlet.http.HttpServletRequest request)
{
    ...
    if (cmd.equals("save"))
    {
    	String end = Tool.stringOfDate(form.getEndTime())+" 23:59:59";
    	form.setEndTime(Tool.stringToDateTime(end));
        form.insert();
        return mkRtn("list", "list", form);
    }
    if (cmd.equals("update"))
...
else if(tmp.equals("checkdelete")){
	String idlist = ParamUtils.getParameter(request, "idlist", "-1");
    List cdt = new ArrayList();
    cdt.add("ProjectId in (" + idlist + ")");
