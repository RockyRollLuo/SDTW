...
function submitthis() {
	...
	var CheckReportEstimate = $('#CheckReportEstimate').val();
	$.ajax({
			type : "post",
			async : false,
			...
			data : {
				...
				Audit : val,
				idlist : '<%=idlist%>',
				CheckReportEstimate : CheckReportEstimate
			},
			dataType : "json",
			cache : false,
...
<div style="margin:10px auto 0 auto;width:100%;color:#36486C;background-color: #FFFFFF">
     ...
     <tr>
     <td class="form_label" >结题评价</td>
     <td  align="left">
		 <div align="left">
		<textarea rows="4" cols="100" id="CheckReportEstimate" name="CheckReportEstimate" style="width: 100%"></textarea>
	     </div>
	 </td>
     </tr>
     <tr>
     ...
     <td  align="left" id="pass">
		 <div align="left">
			<input name="Audit" value="4" type="radio"/>通过
			<input  name="Audit" value="5" type="radio"/>不通过
	     </div>
	 </td>
    </tr>
     <%-- <tr id="ClientAttach">
