...
private String[] ListFields = { "HonorName"};
...
private void setForm(javax.servlet.http.HttpServletRequest request, Honor form)
{
    ...
    System.out.println(ParamUtils.getIntParameter(request, "honourType", -1)+"AAAAAAAAAAAAAAAAAAAAAAAAA");
    request.setAttribute("honurType", ParamUtils.getIntParameter(request, "honourType", -1)+"");
}
