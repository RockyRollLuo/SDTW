...
<%
	Log log = LogFactory.getLog(ChuangKu.class);
	...
	ChuangKu v = (ChuangKu)request.getAttribute("fromBean");
	if (v == null) {
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">山大创库通知</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("山大创库通知") %></div>
			</div>
...
<input type="hidden" name="Id" value="<%=v.getId()%>">
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff" colspan="5">
                    														<input name="Ck1" id="Ck1" size="40" maxsize="40" value="<%=v.getCk1()%>">
                    													</td>
													  				</tr>
													  				<tr>
                    													...
                    													<td align="left"  bgcolor="#ffffff">
                    												         <%if(v.getId()==-1) {%>
                    																<input name="Ck2" value="<%=Tool.stringOfDate(v.getCk2()).equals("0001-01-01")?"":Tool.stringOfDate(v.getCk2())%>"
																					onclick="WdatePicker({el:'Ck2'})"
																					id="Ck2" size="0"
																					>
																					<%}else{
																						%>
																					...
																					>
																				<% }%>	
																						<img onclick="WdatePicker({el:'Ck2'})"
                    													...
                    													<td align="right" class="form_label">结束日期</td>
                    															...
                    															<td align="left"  bgcolor="#ffffff">
                    																...
                    																<input name="AddTime" value="<%=v.getAddTime()%>"
																					onclick="WdatePicker({el:'AddTime'})"
																					id="AddTime" size="0"
																					>
																						<img onclick="WdatePicker({el:'AddTime'})"
																						src="<%=HeadConst.apache_url%>/main/images/datePicker.gif"
																						width="16" height="22" align="absmiddle">
                    													</td>
...
<input type="hidden" name="AddTime" value="<%=v.getAddTime()%>">
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff" colspan="5">
                    														<ueditor:editor autoFloat="false" instanceName="Ck3" basePath="/main/js/ueditor" height="400" width="100%" toolbars="toolbar_base" value="<%=v.getCk3()%>"></ueditor:editor>
                    													</td>
													  				</tr>
                    											</table>
			</form>
