...
private static final String[] allFormNames = {"cmd", "page", "idlist", "Id", "ChuangkuDeclareId", "Sno", "Name", "Tel", "Academy"};
private String[] DicKeys = {"Id", "ChuangkuDeclareId", "Sno", "Name", "Tel", "Academy"};
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"int", "参加山大创库作品表id", "0", "hidden", ""}, {"string", "学号", "45", "text", ""}, {"string", "姓名", "45", "text", ""}, {"string", "联系方式", "45", "text", ""}, {"string", "学院", "45", "AcademyName", ""}};
private String KeyField = "Id";
private String[] AllFields = {"Id", "ChuangkuDeclareId", "Sno", "Name", "Tel", "Academy"};
private String[] ListFields = {"Sno", "Name", "Tel", "Academy"};
private String[] FormFields = {"Sno", "Name", "Tel", "Academy"};
