...
//webFXTreeConfig.loadErrorTextTemplate = "加载 \"%1%\" 错误";
//webFXTreeConfig.emptyErrorTextTemplate = "错误 \"%1%\" 没有这个结点";
...
function WebFXLoadTree(sText, sXmlSrc, sAction, sData, sType, sChecked, sBehavior, sIcon, sOpenIcon) {
	// call super
	this.WebFXTree = WebFXTree;
	this.WebFXTree(sText, sAction, sData, sType, sChecked, sBehavior, sIcon, sOpenIcon);
...
function WebFXLoadTreeItem(sText, sXmlSrc, sAction, sData, sType, sChecked, eParent, sIcon, sOpenIcon) {
	// call super
	this.WebFXTreeItem = WebFXTreeItem;
	this.WebFXTreeItem(sText, sAction, sData, sType, sChecked, eParent, sIcon, sOpenIcon);
...
function _xmlTreeToJsTree(oNode) {
	...
	var type = parseInt(oNode.getAttribute("type"));
	var checked = parseInt(oNode.getAttribute("checked"));
	// create jsNode
	var jsNode;
	if (src != null && src != "") {
            src = src.replace(/[|]/g, "&")
            jsNode = new WebFXLoadTreeItem(text, src, action, data, type, checked, parent, icon, openIcon);
        }
	else
            jsNode = new WebFXTreeItem(text, action, data, type, checked, parent, icon, openIcon);
