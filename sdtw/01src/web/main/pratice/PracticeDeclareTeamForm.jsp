...
<%
	Log log = LogFactory.getLog(PracticeDeclareTeam.class);
	...
	PracticeDeclareTeam v = (PracticeDeclareTeam)request.getAttribute("fromBean");
	if (v == null) {
	...
	<body onload="init();">
		...
		<div class="browsetitle">
			<div class="browsetitleleft">
				<div class="browsetitle001">参加社会实践团队表</div>
				<div class="browsetitle002"><%=XtUtil.getSpell("参加社会实践团队表") %></div>
			</div>
			<div class="browsetitleright">
				<div class="anniulist2">
					<ul>
						<li><a href="PracticeDeclareTeamAction.jsp?cmd=list&page=<%=currpage%><%=((url.length() == 0) ? "" : "&" + url)%>" >返回</a></li>
...
<%=HtmlTool.renderSelect(AcademyNameoptions, v.getAcademy(), "Academy", "")%>
                    												...
                    												<tr>
														    			...
														    			<td align="left"  bgcolor="#ffffff">
<%=HtmlTool.renderSelect(PracticeReportTeamTypeoptions, v.getPracticeReportTeamType(), "PracticeReportTeamType", "")%>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">团队活动小结</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Report21" id="Report21" cols="40" rows="2"><%=v.getReport21()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
                    													<td align="right" class="form_label">团队主要成绩成果</td>
														    			<td align="left"  bgcolor="#ffffff">
                    														<textarea name="Report22" id="Report22" cols="40" rows="2"><%=v.getReport22()%></textarea>
                    													</td>
													  				</tr>
                    												<tr>
