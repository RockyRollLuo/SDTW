...
private String[][] DicValues = {{"int", "Id", "0", "hidden", ""}, {"string", "所参加的实践项目ID", "45", "text", ""}, {"string", "团队名称", "45", "text", ""}, {"string", "所属学院", "45", "AcademyName", ""}, {"string", "团队类别", "45", "PracticeReportTeamType", ""}, {"string", "团队活动小结", "255", "hidden", ""}, {"string", "团队主要成绩成果", "255", "hidden", ""}, {"string", "备用", "45", "text", ""}, {"string", "备用", "45", "text", ""}, {"string", "备用", "45", "text", ""}, {"string", "备用", "45", "text", ""}, {"string", "荣誉", "45", "text", ""}};
