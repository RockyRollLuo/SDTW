											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
      											<tr>
        											<td width="26"><div align="center"><img src="<%=HeadConst.apache_url%>/main/images/skin/<%=userInfo.getSkinId()%>/xxdhbjanl.gif"></div></td>
         											<td width="100"><b class="bt">[部门]</b></td>
        											<td>&nbsp;</td>
    									...
    									<td  class="cxbj">
											...
											<table border=0 cellspacing=3 cellpadding=5 width="100%">
												<tr>
													...
													<td>
														<div align="right">上级部门</div>
													</td>
													<td>
														<%=HtmlTool.renderSelect(DeptNameoptions, ParamUtils.getParameter(request,"_Pid_",""), "_Pid_", "")%>
													</td>
													<td>
												...
												<tr>
													...
													<td>
														<input name="_Tel_" value="<%=ParamUtils.getParameter(request, "_Tel_", "")%>">
													</td>
													<td>
